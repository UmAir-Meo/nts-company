/**handles:page-scroll-to-id-plugin-script,salient-social,wphb-lazy-load,jquery-easing,jquery-mousewheel,nectar_priority,nectar-transit,nectar-waypoints,imagesLoaded,hoverintent,fancyBox,touchswipe,caroufredsel,superfish,nectar-frontend,select2,wpb_composer_front_js**/
  ...
  var n,
    ...
    w = {
      init: function (e) {
        ...
        x.liveSelector && (this.selector += "," + x.liveSelector),
          (n = n ? n + "," + this.selector : this.selector),
          x.defaultSelector &&
            (("object" == typeof v(n) && 0 !== v(n).length) ||
              (n =
            ...
            v(c)
              ...
              .on("click." + b, n, function (e) {
                if (m._isDisabled.call(null)) m._removeClasses.call(null);
                  ...
                  (x.excludeSelectors && t.is(x.excludeSelectors)) ||
                    (n && -1 !== n.indexOf("#/")) ||
                    (m._reset.call(null),
      ...
      scrollTo: function (e, t) {
        if (m._isDisabled.call(null)) m._removeClasses.call(null);
          ...
          m._isInit.call(null);
          var n = { layout: x.layout, offset: x.offset, clicked: !1 };
          t = v.extend(!0, {}, n, t);
          m._reset.call(null),
            (r = t.layout),
            (u = t.offset),
    ...
    m = {
      _isDisabled: function () {
        var e = M,
          t = "inner",
          n =
            x.disablePluginBelow instanceof Array
              ? [x.disablePluginBelow[0] || 0, x.disablePluginBelow[1] || 0]
              : [x.disablePluginBelow || 0, 0];
        return (
          "innerWidth" in M ||
        ...
        if (e) {
          var n =
              -1 !== (t = t || e).indexOf("#/")
                ...
                : t.split("#")[0],
            s = (
              x.inIframe || M.location === M.parent.location
                ? M.location
                : M.parent.location
            )
              .toString()
        ...
        return v(l).each(function () {
          ...
          if (m._isValid.call(null, t, n)) {
            ...
            var s =
              ...
              i = _.test(s) ? v(c.getElementById(s)) : v("#" + s);
            if (0 < i.length) {
              x.highlightByNextTarget &&
                i !== r &&
              ...
              m._setClasses.call(null, !1, i, a),
                (f = o),
                ++o == v(l).length && m._extendClasses.call(null);
            }
          }
        });
      },
      _highlightSelector: function () {
        return x.highlightSelector && "" !== x.highlightSelector
          ? x.highlightSelector
          : n;
      },
      _findTarget: function (e) {
        var t =
          ...
          n = _.test(t) ? v(c.getElementById(t)) : v("#" + t);
          ...
          case "string":
            ...
            (t = [
              (e = [u.y ? u.y : u, u.x ? u.x : u])[0] instanceof jQuery
                ? e[0]
                : v(e[0]),
              e[1] instanceof jQuery ? e[1] : v(e[1]),
            ])[0].length
              ? ((n = t[0].height()),
      ...
      _setClasses: function (e, t, n) {
        var s = x.clickedClass,
          ...
          a = x.highlightClass;
        e && s && "" !== s
          ? (v("." + s).removeClass(s), l.addClass(s))
          : t &&
            i &&
            "" !== i &&
            n &&
            ...
            (m._currentTarget.call(null, t)
              ...
              : (!x.keepHighlightUntilNext || 1 < v("." + a).length) &&
      ...
      _extendClasses: function () {
        var e = x.targetClass,
          ...
          l = t + "-first",
          o = t + "-last";
        v("._" + b + "-t").removeClass(i + " " + a),
          v("._" + b + "-h").removeClass(l + " " + o),
          x.forceSingleHighlight
            ? x.keepHighlightUntilNext && 1 < n.length
      ...
      _removeClasses: function (e) {
        v("." + x.clickedClass).removeClass(x.clickedClass),
          v("." + x.targetClass).removeClass(
            x.targetClass +
              " " +
              x.targetClass +
              "-first " +
          ...
          v("." + x.highlightClass).removeClass(
            x.highlightClass +
              " " +
              x.highlightClass +
              "-first " +
          ...
          e &&
            (v("._" + b + "-t").removeClass("_" + b + "-t"),
            v("._" + b + "-h").removeClass("_" + b + "-h"));
      },
        ...
        if (e.data(b)) {
          ...
          if (x.highlightByNextTarget) {
            ...
            if (C) {
              ...
              "vertical" === x.layout
                ? (I = [s.top <= u / 2, O.top > u / 2, 1, 1])
                : "horizontal" === x.layout &&
                  (I = [1, 1, s.left <= h / 2, O.left > h / 2]);
            }
          }
      ...
      _scrollTo: function () {
        (d = m._scrollSpeed.call(null)),
          (o = x.pageEndSmoothScroll ? m._pageEndSmoothScroll.call(null) : o);
        var e = v("html,body"),
          t = x.autoScrollSpeed ? m._autoScrollSpeed.call(null) : d,
                  ...
                  .animate(
                    { pageYOffset: o[0], pageXOffset: o[1] },
                    {
                      ...
                      step: function (e, t) {
                        "pageXOffset" == t.prop
                          ? (a = e)
                          : "pageYOffset" == t.prop && M.scrollTo(a, e);
                      },
                    }
                  )
                  .promise()
          ...
          switch (
            ...
            case "onStart":
              if (
                ...
                n !== M.location.hash && history.pushState("", "", n);
              }
      ...
      _live: function () {
        t = setTimeout(function () {
          x.live
            ? v(m._highlightSelector()).length !== f && m._setup.call(null)
            : t && clearTimeout(t),
            m._live.call(null);
        }, 1e3);
      },
      _easing: function () {
        ...
        (v.easing.easeInQuad =
          ...
          (v.easing.easeOutQuad =
            v.easing.easeOutQuad ||
            function (e) {
              return 1 - (1 - e) * (1 - e);
            }),
          (v.easing.easeInOutQuad =
            v.easing.easeInOutQuad ||
            function (e) {
              return e < 0.5 ? 2 * e * e : 1 - Math.pow(-2 * e + 2, 2) / 2;
            }),
          (v.easing.easeInCubic =
            v.easing.easeInCubic ||
            function (e) {
              return e * e * e;
            }),
          ...
          (v.easing.easeInOutCubic =
            v.easing.easeInOutCubic ||
            function (e) {
              return e < 0.5 ? 4 * e * e * e : 1 - Math.pow(-2 * e + 2, 3) / 2;
            }),
          (v.easing.easeInQuart =
            v.easing.easeInQuart ||
            function (e) {
              return e * e * e * e;
            }),
          (v.easing.easeOutQuart =
            v.easing.easeOutQuart ||
            function (e) {
              return 1 - Math.pow(1 - e, 4);
            }),
          (v.easing.easeInOutQuart =
            v.easing.easeInOutQuart ||
            function (e) {
              return e < 0.5
                ? 8 * e * e * e * e
          ...
          (v.easing.easeInQuint =
            v.easing.easeInQuint ||
            function (e) {
              return e * e * e * e * e;
            }),
          (v.easing.easeOutQuint =
            v.easing.easeOutQuint ||
            function (e) {
              return 1 - Math.pow(1 - e, 5);
            }),
          (v.easing.easeInOutQuint =
            v.easing.easeInOutQuint ||
            function (e) {
              return e < 0.5
                ? 16 * e * e * e * e * e
          ...
          (v.easing.easeOutExpo =
            v.easing.easeOutExpo ||
            function (e) {
              return 1 === e ? 1 : 1 - Math.pow(2, -10 * e);
            }),
          (v.easing.easeInOutExpo =
            v.easing.easeInOutExpo ||
            function (e) {
              return 0 === e
                ? 0
          ...
          (v.easing.easeOutSine =
            v.easing.easeOutSine ||
            function (e) {
              return Math.sin((e * Math.PI) / 2);
            }),
          (v.easing.easeInOutSine =
            v.easing.easeInOutSine ||
            function (e) {
          ...
          (v.easing.easeOutCirc =
            v.easing.easeOutCirc ||
            function (e) {
              return Math.sqrt(1 - Math.pow(e - 1, 2));
            }),
          (v.easing.easeInOutCirc =
            v.easing.easeInOutCirc ||
            function (e) {
              return e < 0.5
          ...
          (v.easing.easeInBounce =
            v.easing.easeInBounce ||
            function (e) {
              return 1 - t(1 - e);
            }),
          (v.easing.easeOutBounce = v.easing.easeOutBounce || t),
          (v.easing.easeInOutBounce =
            v.easing.easeInOutBounce ||
            function (e) {
  ...
  m._easing.call(),
    (v.fn[p] = function (e) {
      return w[e]
        ...
        : "object" != typeof e && e
        ? void v.error("Method " + e + " does not exist")
...
jQuery(document).ready(function (i) {
  ...
  function t() {
    (this.$body = i("body")),
      ...
      (this.$wpAdminBar = i("#wpadminbar")),
      (this.usingMobileBrowser = !!navigator.userAgent.match(
        /(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/
      )),
      this.mouseEvents(),
      this.nectarLove(),
      i("body").find(".nectar-social.fixed") && this.fixedStyle();
  }
  (t.prototype.mouseEvents = function () {
    var e;
    this.$body.on(
      "click",
      "#single-below-header .nectar-social a",
      function () {
        return !1;
      }
    ),
      i("body.single-product .nectar-social").addClass("woo"),
      this.$body.on(
        "click",
        ".facebook-share:not(.inactive)",
        this.facebookShare
      ),
      this.$body.on(
        "click",
        '.nectar-social:not(".woo") .twitter-share:not(.inactive)',
        this.twitterShare
      ),
      this.$body.on(
        "click",
        ".nectar-social.woo .twitter-share",
        this.wooTwitterShare
      ),
      this.$body.on(
        "click",
        '.nectar-social:not(".woo") .linkedin-share:not(.inactive)',
        this.linkedInShare
      ),
      this.$body.on(
        "click",
        ".nectar-social.woo .linkedin-share",
        this.woolinkedInShare
      ),
      this.$body.on(
        "click",
        '.nectar-social:not(".woo") .pinterest-share:not(.inactive)',
        this.pinterestShare
      ),
      this.$body.on(
        "click",
        ".nectar-social.woo .pinterest-share",
        this.wooPinterestShare
      ),
      this.$body.on("click", ".nectar-social.fixed > a", function () {
        return !1;
      }),
      this.usingMobileBrowser
        ? this.$body.on(
            "click",
            ".nectar-social.hover .share-btn",
            function () {
              return (
                0 < i(this).parents('[id*="-meta"]').length &&
                  i(this).parents('[id*="-meta"]').addClass("social-hovered"),
                0 < i(this).parents("#single-below-header").length &&
                  i(this)
                    .parents("#single-below-header")
                    .addClass("social-hovered"),
                i(this).parent().addClass("visible"),
                !1
              );
            }
          )
          ...
          this.$body.on("mouseleave", ".nectar-social.hover", function () {
            ...
            e = setTimeout(function () {
              t.removeClass("visible"),
                0 < t.parents('[id*="-meta"]').length &&
                  t.parents('[id*="-meta"]').removeClass("social-hovered"),
                0 < t.parents("#single-below-header").length &&
                  t
                    .parents("#single-below-header")
                    .removeClass("social-hovered");
            }, 200);
          }));
  }),
    ...
    (t.prototype.twitterShare = function () {
      var t = window.location.href.replace(window.location.hash, ""),
        e,
        e =
          0 < i(".section-title h1").length
            ? encodeURIComponent(i(".section-title h1").text())
            : encodeURIComponent(i(document).find("title").text());
      return (
        window.open(
          "http://twitter.com/intent/tweet?text=" + e + " " + t,
          "twitterWindow",
          "height=380,width=660,resizable=0,toolbar=0,menubar=0,status=0,location=0,scrollbars=0"
        ),
        !1
    ...
    (t.prototype.wooTwitterShare = function () {
      var t = window.location.href.replace(window.location.hash, "");
      return (
        window.open(
          "http://twitter.com/intent/tweet?text=" +
            i("h1.product_title").text() +
            " " +
            t,
          "twitterWindow",
          "height=380,width=660,resizable=0,toolbar=0,menubar=0,status=0,location=0,scrollbars=0"
    ...
    (t.prototype.linkedInShare = function () {
      var t = window.location.href.replace(window.location.hash, ""),
        e,
        e =
          0 < i(".section-title h1").length
    ...
    (t.prototype.woolinkedInShare = function () {
      var t = window.location.href.replace(window.location.hash, "");
      return (
        window.open(
          "http://www.linkedin.com/shareArticle?mini=true&url=" +
    ...
    (t.prototype.pinterestShare = function () {
      var t = window.location.href.replace(window.location.hash, ""),
        e =
          0 < i(".single-portfolio").length &&
          "empty" != i("div[data-featured-img]").attr("data-featured-img")
            ? i("div[data-featured-img]").attr("data-featured-img")
            : i("#ajax-content-wrap img").first().attr("src"),
        o,
        o =
          0 < i(".section-title h1").length
            ? encodeURIComponent(i(".section-title h1").text())
    ...
    (t.prototype.wooPinterestShare = function () {
      var t = (
          0 < i("img.attachment-shop_single").length
            ? i("img.attachment-shop_single")
            : i(".single-product-main-image img")
        )
          .first()
          .attr("src"),
    ...
    (t.prototype.nectarLove = function () {
      this.$body.on("click", ".nectar-love", function () {
        var e = i(this),
          t = i(this).attr("id"),
          o = i(this);
        if (e.hasClass("loved") || i(this).hasClass("inactive")) return !1;
        var t = {
          action: "nectar-love",
          loves_id: t,
        ...
        return (
          i.post(window.nectarLove.ajaxurl, t, function (t) {
            e.find(".nectar-love-count").html(t),
              e.addClass("loved").attr("title", "You already love this!"),
              o.find(".icon-salient-heart-2").addClass("loved");
          }),
          i(this).addClass("inactive"),
          !1
        );
      });
    }),
    (t.prototype.fixedStyle = function () {
      function t() {
        150 < i(window).scrollTop() &&
          (i(".nectar-social.fixed").addClass("visible"),
          i(window).off("scroll", t),
          i(window).on("scroll", e));
      }
      function e() {
        i(window).scrollTop() < 150 &&
          (i(".nectar-social.fixed").removeClass("visible"),
          i(window).off("scroll", e),
          i(window).on("scroll", t));
      }
      i(".wpb_wrapper .nectar-social.fixed").each(function (t) {
        var t;
        0 !== t || ((t = i(this).clone()), i("body").append(t)),
          i(this).remove();
      }),
        i(window).width() < 1e3 &&
          0 < i(".nectar-social.fixed").length &&
          (150 < i(window).scrollTop()
            ? i(window).on("scroll", e)
            : i(window).on("scroll", t)),
        i(window).on("smartresize", function () {
          1e3 < i(window).width()
            ? i(".nectar-social.fixed").addClass("visible")
            : i(window).scrollTop() < 150
            ? (i(window).off("scroll", e),
              i(window).on("scroll", t),
              i(".nectar-social.fixed").removeClass("visible"))
            : (i(window).off("scroll", t), i(window).on("scroll", e));
        });
    });
  var e = new t();
  window.NectarSocial = t;
});
!(function () {
  "use strict";
  var t = {
    commentsFormLoading: !1,
    commentsLoading: !1,
    commentsLoadComplete: !1,
    commentsLoaded: 0,
    loadOnScroll: !1,
    loadCommentFormOnScroll: !1,
    ...
    init: function () {
      wphbGlobal
        ...
        document.getElementById("wphb-comments-wrap") &&
          this.initCommentLazyLoader();
    },
    initCommentLazyLoader: function () {
      (this.commentLoadingMethod = document.getElementById(
        ...
        "click" === this.commentLoadingMethod &&
          ((this.loadCommentsButton =
            document.getElementById("wphb-load-comments")),
        ...
        "click" === this.commentLoadingMethod &&
          ...
          (this.loadCommentFormOnScroll = !0),
          window.addEventListener("scroll", t.handleScrollingForLoadForm),
          t.handleScrollingForLoadForm()),
        "scroll" === this.commentLoadingMethod &&
          ((this.loadOnScroll = !0),
          window.addEventListener("scroll", function () {
            return t.handleScrolling();
          }),
          t.handleScrolling());
    },
    enableCommentLoad: function () {
      this.loadCommentsButton &&
        this.loadCommentsButton.removeAttribute("disabled"),
        (this.loadOnScroll = !0);
    },
    disableCommentLoad: function () {
      this.loadCommentsButton &&
        this.loadCommentsButton.setAttribute("disabled", "disabled"),
        (this.loadOnScroll = !1),
        (this.loadCommentFormOnScroll = !1);
    },
    moveLoadButton: function () {
      this.loadCommentsButton &&
        this.insertAfter(this.loadCommentsButtonWrap, this.commentList);
    },
    moveCommentsEndIndicator: function () {
      this.insertAfter(this.commentsEndIndicator, this.commentList);
    },
    moveCommentForm: function () {
      var t = document.getElementById("respond");
      t && this.insertBefore(t, this.commentList);
    },
    hideLoadButton: function () {
      this.loadCommentsButton &&
        (this.loadCommentsButton.style.display = "none");
    },
    showCommentLoadSpinner: function () {
      this.commentsLoadSpinnerWrap.style.display = "block";
    },
    hideCommentLoadSpinner: function () {
      this.commentsLoadSpinnerWrap.style.display = "none";
    },
    moveCommentLoadSpinner: function () {
      this.insertAfter(this.commentsLoadSpinnerWrap, this.commentList);
    },
    finishCommentLoad: function () {
    ...
    handleScrollingForLoadForm: function () {
      if (!t.loadCommentFormOnScroll || !t.isInViewport(t.commentsEndIndicator))
        return null;
      window.removeEventListener("scroll", t.handleScrollingForLoadForm),
        t.loadCommentsForm();
    },
    loadCommentsForm: function () {
      (this.commentsFormLoading = !0), this.loadComments();
    },
    loadComments: function () {
      if (this.commentsLoadComplete || this.commentsLoading) return !1;
      this.getCommentsTemplate();
    },
    getCommentsTemplate: function () {
      this.disableCommentLoad(), this.showCommentLoadSpinner();
      ...
      (this.commentsLoading = !0),
        ...
        (n.onload = function () {
          if (200 === n.status) {
            ...
            void 0 !== e.data
              ? (!0 === t.commentsFormLoading
                  ? t.enableCommentLoad()
                  : (t.commentsLoaded++,
                    (t.cpageNum =
                      "newest" === t.commentsPageOrder
                        ? t.cpageNum - 1
                        : t.cpageNum + 1),
                    t.cpageNum < 1 || t.cpageNum > t.totalCommentsPages
                      ? t.finishCommentLoad()
                      : t.enableCommentLoad()),
                t.putCommentContent(e.data.content),
                !0 === t.commentsFormLoading && (t.commentsFormLoading = !1))
              : t.enableCommentLoad();
          } else t.enableCommentLoad();
          (t.commentsLoading = !1), t.hideCommentLoadSpinner();
        }),
        n.send();
    },
    putCommentContent: function (n) {
      var e = this.stringToHTML(n),
        o = e.querySelector(".comment");
      if (o) {
        var m = o.parentNode;
        !0 === t.commentsFormLoading && (m.innerHTML = ""),
          this.commentsLoaded > 1 ||
          ("click" === this.commentLoadingMethod &&
            !1 === t.commentsFormLoading)
            ? (this.commentList.innerHTML += m.innerHTML)
            : (this.commentsContainer.appendChild(e),
              (this.commentList = m),
              this.moveCommentsEndIndicator(),
              this.moveCommentLoadSpinner(),
              this.moveLoadButton(),
              "scroll" === this.commentLoadingMethod && this.moveCommentForm());
      }
    },
...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeInBack: function (n, t, e, u, a, r) {
      return (
        u * (t /= a) * t * (((r = null == r ? 1.70158 : r) + 1) * t - r) + e
      );
    },
    easeOutBack: function (n, t, e, u, a, r) {
      return (
        u *
          ((t = t / a - 1) * t * (((r = null == r ? 1.70158 : r) + 1) * t + r) +
            1) +
        e
      );
    },
...
!(function (e) {
  ...
  function t(e) {
    var t = e || window.event,
      ...
      u;
    if (
      (((e = r.event.fix(t)).type = "mousewheel"),
      "detail" in t && (l = -1 * t.detail),
      "wheelDelta" in t && (l = t.wheelDelta),
      "wheelDeltaY" in t && (l = t.wheelDeltaY),
      "wheelDeltaX" in t && (o = -1 * t.wheelDeltaX),
      "axis" in t && t.axis === t.HORIZONTAL_AXIS && ((o = -1 * l), (l = 0)),
      (i = 0 === l ? o : l),
      "deltaY" in t && (i = l = -1 * t.deltaY),
      "deltaX" in t && ((o = t.deltaX), 0 === l && (i = -1 * o)),
      0 !== l || 0 !== o)
    ) {
      1 === t.deltaMode
        ? ((i *= u = r.data(this, "mousewheel-line-height")),
          (l *= u),
          (o *= u))
        : 2 === t.deltaMode &&
          ((i *= u = r.data(this, "mousewheel-page-height")),
          (l *= u),
          (o *= u));
      var s,
        h,
  ...
  var w = (r.event.special.mousewheel = {
    ...
    setup: function () {
      ...
      r.data(this, "mousewheel-line-height", w.getLineHeight(this)),
        r.data(this, "mousewheel-page-height", w.getPageHeight(this));
    },
    teardown: function () {
      if (this.removeEventListener)
        for (var e = n.length; e; ) this.removeEventListener(n[--e], t, !1);
      else this.onmousewheel = null;
      r.removeData(this, "mousewheel-line-height"),
        r.removeData(this, "mousewheel-page-height");
    },
    getLineHeight: function (e) {
      var t = r(e),
        e = t["offsetParent" in r.fn ? "offsetParent" : "parent"]();
      return (
        e.length || (e = r("body")),
...
void 0 !== headerEl &&
  ...
  jQuery(function (d) {
    ...
    function r() {
      var t = e.offset().top;
      e.css("height", parseInt(window.innerHeight) - parseInt(t) + "px");
    }
    function n() {
      var t =
        0 < d(".body-border-top").length && 1e3 < d(window).width()
          ? d(".body-border-top").height()
          : 0;
      d(".nectar_fullscreen_zoom_recent_projects").each(function () {
        0 < d(this).parents(".first-section").length
          ? d(this).css("height", d(window).height() - d(this).offset().top - t)
          : d(this).css("height", d(window).height());
      });
    }
    function o() {
      var t = d(
        ...
        i = d("#header-secondary-outer"),
        e = e.find("#logo").clone();
      e.is('[data-supplied-ml="true"]') &&
        e.find("img:not(.mobile-only-logo)").remove(),
        e.find("img.starting-logo").remove(),
        0 < i.length && i.addClass("centered-menu-bottom-bar"),
        0 < d('#header-outer[data-condense="true"]').length && t.prepend(e);
    }
    function s() {
      var r = "",
        t,
        e;
      d(".nectar-slider-wrap").each(function () {
        var t, e, i, a;
        0 < d(this).find(".swiper-container[data-tho]").length &&
          ((t = d(this).find(".swiper-container").attr("data-tho")),
          (e = d(this).find(".swiper-container").attr("data-tco")),
          (i = d(this).find(".swiper-container").attr("data-pho")),
          (a = d(this).find(".swiper-container").attr("data-pco")),
          ("auto" == t && "auto" == e) ||
            ((r +=
            ...
            (r += "}")),
          ("auto" == i && "auto" == a) ||
            ((r += "@media only screen and (max-width: 690px) {"),
            "auto" != i &&
              (r +=
                "#" +
                d(this).attr("id") +
        ...
        1 < r.length &&
          ...
          t.appendChild(e),
          d(".nectar-slider-wrap .content").css("visibility", "visible"));
    }
    (t = navigator.userAgent.match(
      ...
      ? !0
      : t) &&
      0 < d("#page-header-bg.fullscreen-header").length &&
      ((e = d("#page-header-bg")),
      r(),
      (i = window.innerWidth),
      ...
      d(window).resize(function () {
        d(window).width() != i &&
          d(window).height != a &&
          (r(), (i = window.innerWidth), (a = window.innerHeight));
      })),
      t && 0 < d(".nectar_fullscreen_zoom_recent_projects").length && n(),
      0 < d('#header-outer[data-format="centered-menu-bottom-bar"]').length &&
        o(),
      d('#page-header-bg[data-animate-in-effect="zoom-out"]').addClass(
        "loaded"
      ),
      s();
  });
!(function (d) {
  ...
  function e() {
    return (
      (s.style[h.transform] = ""),
      (s.style[h.transform] = "rotateY(90deg)"),
      "" !== s.style[h.transform]
    );
  }
  var n = -1 < navigator.userAgent.toLowerCase().indexOf("chrome");
  (h.transition = t("transition")),
    (h.transitionDelay = t("transitionDelay")),
    (h.transform = t("transform")),
  ...
  var i,
    ...
    r;
  for (r in h)
    h.hasOwnProperty(r) && void 0 === d.support[r] && (d.support[r] = h[r]);
  function a(t) {
  ...
  function o(t) {
    ...
    return (
      d.each(t, function (t) {
        (t = d.camelCase(t)),
          (t = c((t = d.transit.propertyMap[t] || d.cssProps[t] || t))),
  ...
  function u(i, t) {
    t || (d.cssNumber[i] = !0),
      (d.transit.propertyMap[i] = h.transform),
      (d.cssHooks[i] = {
        get: function (t) {
          var e;
          return d(t).css("transit:transform").get(i);
        },
        set: function (t, e) {
          var n = d(t).css("transit:transform");
          n.setFromString(i, e), d(t).css({ "transit:transform": n });
        },
      });
  }
  function c(t) {
  ...
  function y(t) {
    var e = t;
    return f((e = d.fx.speeds[t] ? d.fx.speeds[t] : t), "ms");
  }
  (s = null),
    (d.cssEase = {
      _default: "ease",
    ...
    (d.cssHooks["transit:transform"] = {
      get: function (t) {
        return d(t).data("transform") || new a();
      },
      set: function (t, e) {
        var e = e;
        e instanceof a || (e = new a(e)),
          "WebkitTransform" !== h.transform || n
            ? (t.style[h.transform] = e.toString())
            : (t.style[h.transform] = e.toString(!0)),
          d(t).data("transform", e);
      },
    }),
    ...
    (a.prototype = {
      setFromString: function (t, e) {
        var e =
          "string" == typeof e
            ...
            ? e
            : [e];
        e.unshift(t), a.prototype.set.apply(this, e);
      },
      set: function (t) {
      ...
      getter: {
        ...
        rotate3d: function () {
          ...
          return t[3] && (t[3] = f(t[3], "deg")), t;
        },
      },
      parse: function (t) {
        var i = this;
        t.replace(/([a-zA-Z0-9]+)\((.*?)\)/g, function (t, e, n) {
          i.setFromString(e, n);
        });
      },
      toString: function (t) {
        ...
        for (n in this)
          this.hasOwnProperty(n) &&
            ...
            "_" !== n[0] &&
            (t && "scale" === n
              ? e.push(n + "3d(" + this[n] + ",1)")
              : t && "translate" === n
              ? e.push(n + "3d(" + this[n] + ",0)")
              : e.push(n + "(" + this[n] + ")"));
        return e.join(" ");
      },
    }),
    (d.fn.transition = d.fn.transit =
      function (i, t, e, r) {
        ...
        "function" == typeof t && ((r = t), (t = void 0)),
          ...
          void 0 !== i.easing && ((e = i.easing), delete i.easing),
          void 0 !== i.duration && ((t = i.duration), delete i.duration),
          void 0 !== i.complete && ((r = i.complete), delete i.complete),
          void 0 !== i.queue && ((a = i.queue), delete i.queue),
          void 0 !== i.delay && ((n = i.delay), delete i.delay),
        ...
        var o = m(i, t, e, n),
          u,
          c =
            d.transit.enabled && h.transition
              ? parseInt(t, 10) + parseInt(n, 10)
              : 0;
        if (0 === c) {
          var n = function (t) {
            s.css(i), r && r.apply(s), t && t();
          };
          return g(s, a, n), s;
        }
        var f = {},
            ...
            var e = !1,
              n = function () {
                e && s.unbind(b, n),
                  0 < c &&
                    s.each(function () {
                      this.style[h.transition] = f[this] || null;
                    }),
                  "function" == typeof r && r.apply(s),
                  "function" == typeof t && t();
              };
            0 < c && b && d.transit.useTransitionEnd
              ? ((e = !0), s.bind(b, n))
              : window.setTimeout(n, c),
              s.each(function () {
                0 < c && (this.style[h.transition] = o), d(this).css(i);
              });
          },
          l;
        return (
          g(s, a, function (t) {
            this.offsetWidth, p(t);
          }),
          this
        );
      }),
  ...
  (function () {
    ...
    function n(t) {
      (this.element = t),
        ...
        (e += 1),
        f.windowContext ||
          ((f.windowContext = !0), (f.windowContext = new n(window))),
    ...
    (n.prototype.add = function (t) {
      ...
      (n.prototype.createThrottledScrollHandler = function () {
        ...
        this.adapter.on("scroll.waypoints", function () {
          (t.didScroll && !f.isTouch) ||
            ((t.didScroll = !0), f.requestAnimationFrame(e));
        });
      }),
        ...
        for (i in e) {
          ...
          for (a in this.waypoints[i]) {
            ...
            null !== l.triggerPoint &&
              ...
              (p = n.newScroll >= l.triggerPoint),
              ((h && p) || (!h && !p)) &&
                (l.queueTrigger(s), (t[l.group.id] = l.group)));
          }
        }
        ...
        (o = {
          ...
          for (s in this.waypoints[n]) {
            ...
            a.element !== a.element.window &&
              (p = a.adapter.offset()[r.offsetProp]),
              "function" == typeof l
                ? (l = l.apply(a))
                : "string" == typeof l &&
                  ((l = parseFloat(l)),
              ...
              (u = r.contextScroll - r.contextOffset),
              (a.triggerPoint = Math.floor(p + u - l)),
              (u = h < r.oldScroll),
              (l = a.triggerPoint >= r.oldScroll),
              (h = !u && !l),
              !c && (d = u && l)
                ? (a.queueTrigger(r.backward), (i[a.group.id] = a.group))
                : ((!c && h) || (c && r.oldScroll >= a.triggerPoint)) &&
                  (a.queueTrigger(r.forward), (i[a.group.id] = a.group));
          }
        }
        return (
...
!(function (e) {
  ...
  var i,
    ...
    d = function (e, t, n, o) {
      if (
        Math.sqrt((n.pX - i) * (n.pX - i) + (n.pY - u) * (n.pY - u)) <
        o.sensitivity
      )
        return (
          t.off(n.event, s),
  ...
  v.fn.hoverIntent = function (e, t, n) {
    var u = a++,
      r = v.extend({}, o);
    v.isPlainObject(e)
      ? ((r = v.extend(r, e)), v.isFunction(r.out) || (r.out = r.over))
      : (r = v.isFunction(t)
          ? v.extend(r, { over: e, out: t, selector: n })
          : v.extend(r, { over: e, out: e, selector: t }));
    var t = function (e) {
      var t = v.extend({}, e),
        n = v(this),
      ...
      var o = (i.event = "mousemove.hoverIntent.hoverIntent" + u);
      "mouseenter" === e.type
        ? i.isActive ||
          ((i.pX = t.pageX),
          (i.pY = t.pageY),
    ...
    var a = "sf-breadcrumb",
      ...
      o =
        ((e = /iPhone|iPad|iPod/i.test(navigator.userAgent)) &&
          C("html").css("cursor", "pointer").on("click", C.noop),
        e),
      i =
      ...
      l = function (e, t) {
        return e
          ...
          .addClass(t.hoverClass + " " + a)
          .filter(function () {
            return C(this).children(t.popUpSelector).hide().show().length;
          })
      ...
      u = function (e, t) {
        ...
        C.fn.hoverIntent && !t.disableHI
          ? e.hoverIntent(c, m, s)
          : e.on("mouseenter.superfish", s, c).on("mouseleave.superfish", s, m);
        var s = "MSPointerDown.superfish";
        o || (s += " touchend.superfish"),
      ...
      f = function (e) {
        ...
        0 < s.length &&
          ...
          "MSPointerDown" === e.type
            ? t.trigger("focus")
            : C.proxy(c, t.parent("li"))());
      },
      c = function () {
        var e = C(this),
          t = g(e);
        0 < C(this).parents(".megamenu").length ||
      ...
      m = function () {
        ...
        o
          ? C.proxy(s, e, t)()
          : (clearTimeout(t.sfTimer),
            (t.sfTimer = setTimeout(C.proxy(s, e, t), t.delay)));
      },
      s = function (e) {
        (e.retainPath = -1 < C.inArray(this[0], e.$path)),
          this.superfish("hide"),
          this.parents("." + e.hoverClass).length ||
            (e.onIdle.call(v(this)), e.$path.length && C.proxy(c, e.$path)());
      },
      v = function (e) {
        return e.closest("." + n);
      },
    ...
    return {
      hide: function (e) {
        if (this.length) {
          ...
          if (!s) return this;
          if (
            C(this).hasClass("menu-item-over") &&
            C(this).hasClass("megamenu")
          )
            return !0;
          var n = !0 === s.retainPath ? s.$path : "",
            a = this.find("li." + s.hoverClass)
              .add(this)
              .not(n)
          ...
          if (
            ...
            "minimal" == s.dropdownStyle
              ? ((t = C(this)), s.onHide.call(t))
              : a.stop(!0, !0).animate(s.animationOut, n, function () {
                  var e = C(this);
                  s.onHide.call(e);
                }),
            0 < C(this).parents(".megamenu").length)
            ...
            return;
          0 < C('#header-outer[data-megamenu-rt="1"]').length &&
            0 < C('#header-outer[data-transparent-header="true"]').length &&
            (0 == C("#header-outer.scrolled-down").length &&
              0 == C("#header-outer.small-nav").length &&
              0 == C("#header-outer.detached").length &&
              0 == C("#header-outer.fixed-menu").length &&
              C("#header-outer").addClass("transparent"),
            0 <
              C(
                '#header-outer[data-permanent-transparent="1"][data-transparent-header="true"]'
              ).length && C("#header-outer").addClass("transparent"));
        }
        return this;
      },
      show: function () {
        if (!(0 < C(this).parents(".megamenu").length)) {
          var e = g(this);
          if (!e) return this;
          var t,
            s = this.addClass(e.hoverClass).children(e.popUpSelector),
            n,
            a,
            r,
            o,
          ...
          return (
            0 < C('#header-outer[data-megamenu-rt="1"]').length &&
              C(this).hasClass("megamenu") &&
              "true" == C("#header-outer").attr("data-transparent-header") &&
              (C("#header-outer").addClass("no-transition"),
              C("#header-outer").removeClass("transparent")),
            e.onBeforeShow.call(s),
            C(s).parents("li").hasClass("megamenu") ||
              C(s).parents("ul").hasClass("sub-menu") ||
              !s.offset() ||
              (s.addClass("temp-hidden-display"),
              (n = C("#top .container").width()),
              (a = s).offset().left - (C(window).width() - n) / 2 + a.width() <=
              C(window).width() - 100
            ...
            0 < s.length &&
              0 < s.parents(".sub-menu").length &&
              0 < s.parents(".sf-menu").length &&
              s.offset().left + s.outerWidth() > C(window).width() &&
      ...
      destroy: function () {
        return this.each(function () {
          ...
          (s = e.find(t.popUpSelector).parent("li")),
            ...
            s.children(t.popUpSelector).attr("style", function (e, t) {
              return t.replace(/display[^;]+;?/g, "");
            }),
            t.$path.removeClass(t.hoverClass + " " + a).addClass(t.pathClass),
            e.find("." + t.hoverClass).removeClass(t.hoverClass),
            t.onDestroy.call(e),
            e.removeData("sf-options");
        });
      },
      init: function (n) {
        return this.each(function () {
          ...
          var t = C.extend({}, C.fn.superfish.defaults, n),
            s = e.find(t.popUpSelector).parent("li");
          (t.$path = l(e, t)),
            e.data("sf-options", t),
            h(e, t),
            ...
            p(e),
            u(e, t),
            s.not("." + a).superfish("hide", !0),
            t.onInit.call(this);
        });
      },
    };
  })();
  (C.fn.superfish = function (e, t) {
    return s[e]
    ...
    (C.fn.superfish.defaults = {
      ...
      onDestroy: C.noop,
      dropdownStyle:
        0 < C('body[data-dropdown-style="minimal"]').length
          ? "minimal"
          : "classic",
    }),
    C.fn.extend({ hideSuperfishUl: s.hide, showSuperfishUl: s.show });
})(jQuery);
!(function (T, I, z) {
  "use strict";
  var k = T(I),
    E = T("body"),
    i = T("#slide-out-widget-area"),
    a = T("#slide-out-widget-area-bg"),
    c = T("#header-outer"),
    h = T("#header-secondary-outer"),
    n = T("#header-outer #search-btn a"),
    o = T("#wpadminbar"),
    r = T("#ajax-loading-screen"),
    d = T(".body-border-top"),
    s = T("#page-header-bg"),
    l = T("#footer-outer"),
    p =
      0 < T(".body-border-right").length ? T(".body-border-right").width() : 0,
    u = c.is("[data-logo-height]") ? parseInt(c.attr("data-logo-height")) : 30,
    g = c.is("[data-padding]") ? parseInt(c.attr("data-padding")) : 28,
    f = c.is("[data-shrink-num]") ? c.attr("data-shrink-num") : 6,
    m = !!c.is('[data-condense="true"]'),
    t = !!c.is('[data-using-logo="1"]'),
    b = !!c.is('[data-header-resize="1"]'),
    v = !!c.is('[data-transparent-header="true"]'),
    w = E.is("[data-header-format]") ? E.attr("data-header-format") : "default",
    y = E.is("[data-hhun]") ? E.attr("data-hhun") : "",
    _ =
      E.is("[data-cae]") && "swing" !== E.attr("data-cae")
        ? E.attr("data-cae")
        : "easeOutCubic",
    C = E.is("[data-cad]") ? E.attr("data-cad") : "650",
    x = !(
    ...
    U = !1,
    G = !1,
    J = { animating: "false", perspect: "not-rolled" },
    K = { $usingFullScreenRows: !1 },
    e,
    ee;
  0 < d.length &&
    (("#ffffff" == d.css("background-color") &&
      "light" == E.attr("data-header-color")) ||
      ("rgb(255, 255, 255)" == d.css("background-color") &&
        "light" == E.attr("data-header-color")) ||
      d.css("background-color") == c.attr("data-user-set-bg")) &&
    (G = !0);
  var te = {
    usingMobileBrowser: !!navigator.userAgent.match(
      /(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/
    ),
    usingFrontEndEditor: void 0 !== I.vc_iframe,
    getWindowSize: function () {
      (te.winH = I.innerHeight),
        (te.winW = I.innerWidth),
        (te.adminBarHeight = 0 < o.length ? o.height() : 0),
        (te.secondaryHeaderHeight =
          0 < h.length && "none" != h.css("display") ? h.outerHeight() : 0),
        (te.footerOuterHeight = 0 < l.length ? l.outerHeight() : 0);
    },
    scrollTop: 0,
    clientX: 0,
    clientY: 0,
    ...
    scrollPosRAF: function () {
      (te.scrollTop = k.scrollTop()), requestAnimationFrame(te.scrollPosRAF);
    },
    bindEvents: function () {
      te.usingMobileBrowser
        ? requestAnimationFrame(te.scrollPosRAF)
        : k.on("scroll", function () {
            te.scrollTop = te.scrollPosMouse();
          }),
        z.addEventListener("mousemove", function (e) {
          (te.clientX = e.clientX), (te.clientY = e.clientY);
        }),
        k.on("resize", te.getWindowSize);
    },
    init: function () {
      (o = T("#wpadminbar")),
        this.getWindowSize(),
        ...
        this.bindEvents(),
        (this.usingFrontEndEditor = void 0 !== I.vc_iframe);
    },
  };
  function ae() {
    Wt(), Mt(), An(), Fa(), fe();
  ...
  function ne() {
    zt(), Wt(), ge(), ya(), te.usingMobileBrowser || Mt();
  }
  function ie() {
  ...
  function se(e, t) {
    (this.lastX = te.clientX),
      (this.lastY = te.clientY),
      (this.$el = e),
      (this.iconType = t),
      (this.timeout = !1),
      (this.overEl = !1),
  ...
  function re() {
    T(
      ...
      T(this).css({ height: e.height + "px", width: e.width + "px" });
    });
  }
  function oe() {
    0 <
  ...
  function le() {
    ...
    (O = []),
      (S = []),
      T(".nectar-flickity:not(.masonry)").each(function (d) {
        T(this).removeClass(function (e, t) {
          return (t.match(/(^|\s)instance-\S+/g) || []).join(" ");
        }),
          T(this).addClass("instance-" + d);
        var e = !(
            !T(this).is("[data-free-scroll]") ||
            "true" != T(this).attr("data-free-scroll")
          ),
          t = !0,
          a = !0,
          n = 0.025,
          ...
          s = !0,
          r = "center";
        T(this).is('[data-format="fixed_text_content_fullwidth"]') &&
          ((a = t = !(r = "left")),
          (n = 0.02),
          T(this).parent().is('[data-alignment="right"]') && (r = "right")),
          1 == e && (t = !1),
          (s =
            (0 < T(this).attr("data-controls").length &&
              "next_prev_arrows" == T(this).attr("data-controls")) ||
            (0 < T(this).attr("data-controls").length &&
              "next_prev_arrows_overlaid" == T(this).attr("data-controls"))
              ? !(i = !1)
              : !(i = !0)),
          0 < T(this).attr("data-controls").length &&
            "none" == T(this).attr("data-controls") &&
            (s = i = !1);
        var o = !1;
        T(this).is("[data-autoplay]") &&
          "true" == T(this).attr("data-autoplay") &&
          ((o = !0),
          T(this).is("[data-autoplay-dur]") &&
            0 < T(this).attr("data-autoplay-dur").length &&
            100 < parseInt(T(this).attr("data-autoplay-dur")) &&
            parseInt(T(this).attr("data-autoplay-dur")) < 3e4 &&
            (o = parseInt(T(this).attr("data-autoplay-dur"))));
        var c = T(this),
          l = !(0 < T("body.vc_editor").length),
          h = 0 < T("body.vc_editor").length,
          u = "",
          p =
            !T(this).is("[data-wrap]") ||
            "no-wrap" != T(this).attr("data-wrap"),
          g = !1;
        T(this).is('[data-adaptive-height="true"]') && (g = !0);
        var f = !!T(this).find("img[data-flickity-lazyload]") && 1;
        T(this).find("img[data-flickity-lazyload]") &&
          T(this).is('[data-overflow="visible"]') &&
          T(this).is('[data-wrap="no-wrap"]') &&
          (f = 2);
        var m = !!E.hasClass("rtl"),
          b,
          v,
          w,
          y,
          ...
          u =
            (0 < T(this).attr("data-controls").length &&
              "next_prev_arrows_overlaid" == T(this).attr("data-controls")) ||
            (0 < T(this).attr("data-controls").length &&
              "touch_total" == T(this).attr("data-controls"))
              ? { x0: 10, x1: 60, y1: 50, x2: 70, y2: 40, x3: 30 }
              : { x0: 20, x1: 70, y1: 30, x2: 70, y2: 25, x3: 70 };
        (O[d] = new Flickity(".nectar-flickity.instance-" + d, {
          contain: a,
          draggable: l,
          lazyLoad: f,
          imagesLoaded: !0,
          ...
          pageDots: i,
          resize: !0,
          selectedAttraction: n,
          autoPlay: o,
          rightToLeft: m,
          pauseAutoPlayOnHover: h,
          setGallerySize: !0,
          wrapAround: p,
          accessibility: !1,
          arrowShape: u,
        })),
          T(this).is('[data-controls="touch_total"]') &&
            (0 == T(this).find(".visualized-total").length &&
              (0 < T(this).parents(".full-width-content").length &&
              0 < T(this).parents(".vc_col-sm-12").length
                ? T(this).append(
            ...
            te.usingMobileBrowser ||
              ((S[d] = new se(T(this), "horizontal-movement")),
              O[d].on("dragMove", function (e, t) {
                (te.clientY = t.clientY), (te.clientX = t.clientX);
              }),
              O[d].on("pointerDown", function (e, t) {
                T(".nectar-drag-indicator").addClass("pointer-down");
              }),
              O[d].on("pointerUp", function (e, t) {
                T(".nectar-drag-indicator").removeClass("pointer-down");
              })),
            (b = T(this).find(".flickity-page-dots li").length),
            (v = T(this).find(".visualized-total span")),
            (w = 1),
            (y = T(this).find(".visualized-total").width()),
            k.on("smartresize", function () {
              setTimeout(function () {
                (b = c.find(".flickity-page-dots li").length),
                  (y = c.find(".visualized-total").width()),
                  (w =
                    (y / b) *
                    c.find(".flickity-page-dots .is-selected").index()),
                  v.css("width", 100 / b + "%"),
                  v.css({ x: w + "px" });
              }, 200);
            }),
            ...
            O[d].on("change", function (e, t) {
              (w =
                (y / b) * c.find(".flickity-page-dots .is-selected").index()),
                v.css({ x: w + "px" });
            })),
          T(this).is('[data-format="fixed_text_content_fullwidth"]') &&
            !te.usingFrontEndEditor &&
            ((_ = te.usingMobileBrowser),
            O[d].on("scroll", function () {
              var o, e, l;
              _ ||
                ((o = c.find(".cell").outerWidth() + 25),
                (e =
                  0 < T('body[data-header-format="left-header"]').length &&
                  1e3 < k.width()
                    ? 275
                    : 0),
                (l = (k.width() + e - c.parents(".main-content").width()) / 2),
                (l += parseInt(c.css("margin-left")) + 2),
                O[d].slides.forEach(function (e, t) {
                  var a = 1,
                    n = 0,
                    i = 0,
                    s = 10,
                    r = 1,
                    e = T(e.cells[0].element).offset().left,
                    t = T(
                    ...
                    s;
                  t.css({
                    "z-index": (s = e + 5 - l < 0 && -1 * o < e - l ? 5 : 10),
                  }),
                    t
          ...
          O[d].on("dragStart", function () {
            clearTimeout(C),
              clearTimeout(x),
              c.addClass("is-dragging"),
              c.addClass("is-moving"),
              c.find(".flickity-prev-next-button").addClass("hidden");
          }),
          O[d].on("dragEnd", function () {
            c.removeClass("is-dragging"),
              (C = setTimeout(function () {
                c.removeClass("is-moving"),
                  c.find(".flickity-prev-next-button").removeClass("hidden");
              }, 600)),
          ...
          c.hasClass("nectar-carousel") &&
            imagesLoaded(c, function () {
              ce(c);
            });
      }),
      0 < T(".nectar-carousel.nectar-flickity:not(.masonry)").length &&
        k.on("resize", de);
  }
  function de() {
    T(".nectar-carousel.nectar-flickity:not(.masonry)").each(function () {
      ce(T(this));
    });
  }
  function ce(e) {
    ...
    e.find(".flickity-slider > .cell").css("height", "auto"),
      e.find(".flickity-slider > .cell").each(function () {
        T(this).height() > t && (t = T(this).height());
      }),
      t < 10 && (t = "auto"),
      e.find(".flickity-slider > .cell").css("height", t + "px");
  }
  function he() {
  ...
  function ue() {
    ...
    ge(),
      0 == T('body[data-header-format="left-header"]').length &&
        ((e = !(
          0 < T('#header-outer[data-megamenu-rt="1"]').length &&
        ...
        T("#header-outer .sf-menu > li:not(.megamenu) > ul > li > ul").each(
          function () {
            T(this).offset().left + T(this).outerWidth() > k.width() &&
        ...
        0 < T('body[data-megamenu-width="full-width"]').length &&
          0 < T("ul.sub-menu").length &&
          (pe(),
          k.on("smartresize", pe),
        ...
        T("header#top nav > ul > li.megamenu > ul.sub-menu > li > a").each(
          function () {
            ("-" != T(this).text() &&
              "–" != T(this).text() &&
  ...
  function pe() {
    var e = k.width(),
      t = T("header#top > .container").width();
    T("header#top nav > ul > li.megamenu > .sub-menu").css({
      "padding-left": (e - t) / 2 + "px",
      "padding-right": (e + 2 - t) / 2 + "px",
      width: t,
      left: "-" + (e - t) / 2 + "px",
    });
  }
  function ge() {
    te.winW < 1e3 && "1" == E.attr("data-responsive")
      ? (E.addClass("mobile"), T("header#top nav").css("display", "none"))
    ...
    0 != T(".carousel").length &&
      ("undefined" != typeof SalientRecentProjectsCarousel &&
        T("ul.carousel.portfolio-items").each(function (e) {
          V[e] = new SalientRecentProjectsCarousel(T(this));
        }),
        ...
        var e = T(this),
          ...
          n =
            "true" == T(this).parents(".carousel-wrap").attr("data-full-width")
              ? 500
              : 453,
          i = "true" == T(this).attr("data-autorotate"),
          s = !0,
          r = !0,
          o,
          l,
          r =
            !(
              ...
              ? (s = !0)
              : !(s = !1),
          o = parseInt(T(this).attr("data-scroll-speed"))
            ? parseInt(T(this).attr("data-scroll-speed"))
            : 700,
          l = T(this).is("[data-easing]")
            ? T(this).attr("data-easing")
            : "linear",
          d = e;
        0 == e.find("img").length && (d = E),
          imagesLoaded(d, function () {
            e
              .carouFredSel(
                {
                  ...
                  swipe: {
                    ...
                    options: {
                      ...
                      tap: function (e, t) {
                        !T(t).attr("href") ||
                          T(t).is('[target="_blank"]') ||
                          T(t).is('[rel^="prettyPhoto"]') ||
                          T(t).is(".magnific-popup") ||
                          T(t).is(".magnific") ||
                          I.open(T(t).attr("href"), "_self");
                      },
                    },
                    onBefore: function () {
                      e.find(".work-item").trigger("mouseleave"),
                        e.find(".work-item .work-info a").trigger("mouseup");
                    },
                  },
                  scroll: {
                    items: a,
                      ...
                      ((0 < T("body.ascend").length &&
                        ...
                        e
                          ...
                          .html(
                            Math.ceil(
                              e.find("> li").length /
                                e.triggerHandler("currentVisible").length
                            )
                          );
                    },
                    onAfter: function () {
                      ((0 < T("body.ascend").length &&
                        ...
                        (e
                          ...
                          .html(e.triggerHandler("currentPage") + 1),
                        e
                          .parents(".carousel-wrap")
                          .find(".item-count .total")
                          .html(
                  ...
                  prev: {
                    button: function () {
                      return e.parents(".carousel-wrap").find(".carousel-prev");
                    },
                  },
                  next: {
                    button: function () {
                      return e.parents(".carousel-wrap").find(".carousel-next");
                    },
                  },
                  auto: { play: i },
                },
              ...
              "true" == e.parents(".carousel-wrap").attr("data-full-width") &&
                e.parents(".carousel-outer").css("overflow", "visible"),
              ((0 < T("body.ascend").length &&
                "true" !=
                  e.parents(".carousel-wrap").attr("data-full-width")) ||
                (0 < T("body.material").length &&
                  "true" !=
                    e.parents(".carousel-wrap").attr("data-full-width"))) &&
                T(
                  ...
                  e.parents(".carousel-wrap").find(".carousel-prev")
                ),
              e.addClass("finished-loading"),
              Ce();
          });
      }),
      k.off("smartresize.carouselHeightCalcs"),
      k.on("smartresize.carouselHeightCalcs", Ce));
  }
  function be() {
    var t = 0,
      a = 0,
    ...
    T(e).on("mousedown", function (e) {
      t = e.clientX;
    }),
      T(e).on("mouseup", function (e) {
        a = e.clientX;
      }),
      T(e).on("click", function () {
        if (10 < Math.abs(t - a)) return !1;
      });
  }
  function ve() {
    0 !== T(".owl-carousel").length &&
      T(".owl-carousel").each(function () {
        T(this).addClass("owl-theme");
        var e = T(this),
          t = e.attr("data-autorotate"),
          a = e.attr("data-autorotation-speed"),
          n = !!e.is('[data-loop="true"]'),
          i = !!E.hasClass("rtl");
        T(this).owlCarousel({
          responsive: {
            0: { items: T(this).attr("data-mobile-cols") },
            690: { items: T(this).attr("data-tablet-cols") },
            1e3: { items: T(this).attr("data-desktop-small-cols") },
  ...
  function we() {
    T(Z + '.owl-carousel[data-enable-animation="true"]').each(function () {
      var e = 1 == U ? "200%" : "bottom-in-view",
        t = 0;
      T(this).is("[data-animation-delay]") &&
        0 < T(this).attr("data-animation-delay").length &&
        "false" != T(this).attr("data-animation") &&
        (t = T(this).attr("data-animation-delay"));
      var a = T(this),
        n = new Waypoint({
          element: a,
          handler: function () {
            (0 < a.parents(".wpb_tab").length &&
              ...
              setTimeout(function () {
                a.find(".owl-stage > .owl-item").each(function (e) {
                  var t;
                  T(this)
                    .delay(200 * e)
  ...
  function _e() {
    (0 === T(".products-carousel").length &&
      ...
      (T(".products-carousel").each(function () {
        var e = T(this).find("ul"),
          t = "auto",
          a = "auto",
          n = 0 < T(this).parents(".full-width-content ").length ? 400 : 353,
          i = 800,
          s = "easeInOutQuart",
          r = e;
        0 == e.find("img").length && (r = E),
          T(this).append(
                ...
                swipe: {
                  ...
                  options: {
                    ...
                    tap: function (e, t) {
                      !T(t).attr("href") ||
                        T(t).is('[target="_blank"]') ||
                        T(t).hasClass("add_to_wishlist") ||
                        T(t).hasClass("add_to_cart_button") ||
                        T(t).is('[rel^="prettyPhoto"]') ||
                        I.open(T(t).attr("href"), "_self"),
                        !T(t).parent().attr("href") ||
                          T(t).parent().is('[target="_blank"]') ||
                          T(t).parent().hasClass("add_to_wishlist") ||
                          T(t).parent().hasClass("add_to_cart_button") ||
                          T(t).parent().is('[rel^="prettyPhoto"]') ||
                          I.open(T(t).parent().attr("href"), "_self");
                    },
                  },
                  onBefore: function () {
                    e.find(".product-wrap").trigger("mouseleave"),
                      e.find(".product a").trigger("mouseup");
                  },
                },
                scroll: { items: a, easing: s, duration: i },
                prev: {
                  button: function () {
                    return e.parents(".carousel-wrap").find(".carousel-prev");
                  },
      ...
      T(".nectar-woo-flickity").each(function (e) {
        ...
        var t = !!a.is('[data-controls="bottom-pagination"]'),
          n = !a.is('[data-controls="bottom-pagination"]'),
          i =
            a.is("[data-autorotate-speed]") &&
            800 < parseInt(a.attr("data-autorotate-speed"))
              ? parseInt(a.attr("data-autorotate-speed"))
              : 5e3;
        a.is('[data-autorotate="true"]') || (i = !1),
          T(this).find("ul").addClass("generate-markup"),
          (Y[e] = T(this).find("ul")),
          1 == n &&
            Y[e].on("ready.flickity", function () {
        ...
        E.hasClass("rtl") && ((s = !0), (r = "right")),
          ...
          1 == n &&
            ...
            (i = T('<div class="woo-flickity-count" />')),
            a.append(i),
            ye({
              data: {
                wooFlickity: (n = Y[e].data("flickity")),
                wooFlickityCount: i,
              },
            }),
            Y[e].on(
              "select.flickity",
              { wooFlickity: n, wooFlickityCount: i },
              ye
            ));
      }));
  }
  ...
  function xe() {
    0 !== T(".carousel.clients").length &&
      (T(".carousel.clients").each(function () {
        var e = T(this),
          t = !T(this).hasClass("disable-autorotate"),
          a,
          a = parseInt(T(this).attr("data-max"))
            ? parseInt(T(this).attr("data-max"))
            : 5;
        k.width() < 690 &&
          "1" == E.attr("data-responsive") &&
          ((a = 2), T(this).addClass("phone"));
        var n = e;
          ...
          imagesLoaded(n, function () {
            e
              .carouFredSel({
                ...
                auto: { play: t, timeoutDuration: 2700 },
              })
              .animate({ opacity: 1 }, 1300),
              e.addClass("finished-loading"),
              e.parents(".carousel-wrap").wrap('<div class="carousel-outer">'),
      ...
      k.off("smartresize.clientsCarouselHeight", ke),
      k.on("smartresize.clientsCarouselHeight", ke));
  }
  function ke() {
    var e = 0;
  ...
  function Ie() {
    var a = 1 == U ? "200%" : "95%";
    T(Z + ".clients.fade-in-animation").each(function () {
      var e = T(this),
        t = new Waypoint({
          element: e,
          handler: function () {
  ...
  (se.prototype.createMarkup = function () {
    var e, e, e;
    "horizontal-movement" === this.iconType &&
      (0 == T(".nectar-drag-indicator").length
        ? ((e = 0 < T("body > #boxed").length ? " in-boxed" : ""),
          T("body").append(
        ...
        (0 == T(".nectar-view-indicator").length
          ? ((e = 0 < T("body > #boxed").length ? " in-boxed" : ""),
            ...
            T(".nectar-view-indicator span").text(
              T(".nectar-post-grid").attr("data-indicator-text")
            ),
    ...
    (se.prototype.mouseBind = function () {
      var e = this,
        t,
        a;
      "horizontal-movement" === this.iconType
        ...
        ? (T("body").on(
            ...
            function () {
              0 < T(".nectar_team_member_overlay:not(.open)").length ||
        ...
        : "view-indicator" === this.iconType
        ? ((t = e.$el.attr("data-indicator-color")),
          (a = e.$el.attr("data-indicator-style")),
          e.$el.find(".nectar-post-grid-item").off(),
          e.$el.find(".nectar-post-grid-item").on("mouseenter", function () {
            e.$viewEl.addClass("visible"),
              e.$viewEl.attr("class", function (e, t) {
                return t.replace(/(^|\s)style-\S+/g, "");
              }),
              e.$viewEl.addClass("style-" + a),
              "see-through" !== a &&
    ...
    (se.prototype.dragRAF = function () {
      (this.lastY = $e(this.lastY, te.clientY, this.lerpDamp)),
        (this.lastX = $e(this.lastX, te.clientX, this.lerpDamp)),
        this.$dragEl.css({
          transform:
    ...
    (se.prototype.closeRAF = function () {
      (this.lastY = $e(this.lastY, te.clientY, this.lerpDamp)),
        (this.lastX = $e(this.lastX, te.clientX, this.lerpDamp)),
        this.$closeEl.css({
          transform:
  ...
  var ze = T.event,
    Ee = T.event.handle ? "handle" : "dispatch",
    He,
    Ae,
    Me,
    Oe,
  ...
  function We(e, t, a, n) {
    var n = Math.min(a / e, n / t);
    return { width: e * n, height: t * n };
  }
  function je() {
    var e, e, t, t, e;
    return (
      (e =
        (E.is('[data-header-format="left-header"]') && 1e3 <= te.winW) ||
        (E.is('[data-hhun="1"]') && 1e3 <= te.winW) ||
        0 < T(".page-template-template-no-header-footer").length ||
        0 < T(".page-template-template-no-header").length
          ? 0
          : ((e = g - g / 1.8),
            (t = c.outerHeight()),
            ((0 < h.length && E.is(".material")) ||
              (0 < h.length && !E.is(".material") && te.winW < 1e3)) &&
              (t -= te.secondaryHeaderHeight),
            c.is('[data-header-resize="1"]') &&
            !c.is(".small-nav") &&
            1e3 <= te.winW
              ? t - (parseInt(f) + 2 * e)
              : t)),
      1e3 <= te.winW &&
        ...
        (e =
          ...
          (parseInt(t.position().top) -
            parseInt(c.find("#logo").css("margin-top"))) -
          parseInt(te.secondaryHeaderHeight))),
      e
    );
  }
  function Ye(e) {
  ...
  function qe(a, e, n) {
    var i = I.scrollY || z.documentElement.scrollTop,
      a = a || 0,
      e = e || 2e3,
      n = n || "easeOutSine",
      s = 0,
      r = Math.max(0.1, Math.min(Math.abs(i - a) / e, 0.8)),
      o = {
    ...
    function l() {
      var e = (s += 1 / 60) / r,
        t = o[n](e);
      e < 1
        ? (requestAnimationFrame(l), I.scrollTo(0, i + (a - i) * t))
        : I.scrollTo(0, a);
    }
    l();
  }
  function Pe() {
    var e =
        0 < T("body[data-header-breakpoint]").length &&
  ...
  function Re(e) {
    e = e.split("+").join(" ");
    for (var t = {}, a, n = /[?&]?([^=]+)=([^&]*)/g; (a = n.exec(e)); )
      t[decodeURIComponent(a[1])] = decodeURIComponent(a[2]);
    return t;
  }
  (ze.special.smartresize = {
    setup: function () {
      T(this).on("resize", ze.special.smartresize.handler);
    },
    teardown: function () {
      T(this).off("resize", ze.special.smartresize.handler);
    },
    ...
    (T.fn.smartresize = function (e) {
      return e
        ? this.on("smartresize", e)
        : this.trigger("smartresize", ["execAsap"]);
    }),
    (Me = (Ae = z).createElement("STYLE")),
    (Oe = "addEventListener" in Ae),
    (Se = function (e, t) {
      Oe ? Ae.addEventListener(e, t) : Ae.attachEvent("on" + e, t);
    }),
    (Fe = function (e) {
      Me.styleSheet ? (Me.styleSheet.cssText = e) : (Me.innerHTML = e);
    }),
    Ae.getElementsByTagName("HEAD")[0].appendChild(Me),
    Se("mousedown", function () {
      Fe(":focus{outline:0}::-moz-focus-inner{border:0;}");
    }),
    Se("keydown", function () {
      Fe("");
    }),
      ...
      return (
        a.createTextRange
          ? ((n = a.createTextRange()).collapse(!0),
            ...
            n.select())
          : a.setSelectionRange && (a.focus(), a.setSelectionRange(e, t)),
        this
      );
    }),
    T.extend(T.expr[":"], {
      transparent: function (e, t, a) {
    ...
    (T.cssHooks.backgroundColor = {
      get: function (e) {
        ...
        return (
          e.currentStyle
            ? (t = e.currentStyle.backgroundColor)
            : I.getComputedStyle &&
              (t = z.defaultView
                .getComputedStyle(e, null)
    ...
    (function (o) {
      function i(e, t) {
        ...
        (this.$body = o("body")),
          (this.$scrollElement = o(o(e).is("body") ? I : e)),
          (this.options = o.extend({}, i.DEFAULTS, t)),
      ...
      (i.VERSION = "3.2.0"),
        ...
        (i.prototype.getScrollHeight = function () {
          return (
            ...
            Math.max(this.$body[0].scrollHeight, z.documentElement.scrollHeight)
          );
        }),
        ...
        (i.prototype.process = function () {
          ...
          ((0 < o('.page-submenu[data-sticky="true"]').length &&
            ...
            (e = o(".page-submenu").height());
          var t,
            a = this.$scrollElement.scrollTop() + this.options.offset + e,
            n = this.getScrollHeight(),
            e = this.options.offset + n - this.$scrollElement.height() - e,
            i = this.offsets,
            s = this.targets,
            r = this.activeTarget;
          if (this.activeTarget && a < this.offsets[0] && 0 < this.offsets[0])
            return (
              (this.activeTarget = null),
          ...
          if ((this.scrollHeight != n && this.refresh(), e <= a))
            return r != (t = s[s.length - 1]) && this.activate(t);
          if (r && a <= i[0]) return r != (t = s[0]) && this.activate(t);
          for (t = i.length; t--; )
            r != s[t] &&
              a >= i[t] &&
              (!i[t + 1] || a <= i[t + 1]) &&
        ...
        (i.prototype.activate = function (e) {
          ...
          var e =
              ...
              e +
              '"]',
            e = o(e).parents("li").addClass("current-menu-item");
          (e = e.parent(".dropdown-menu").length
  ...
  var Ne = Re(z.location.search),
    Se,
    Ve;
  (Se = jQuery),
    (Ve = Se(I)),
    (Se.fn.visible = function (e, t, a) {
      if (!(this.length < 1)) {
        var n = 1 < this.length ? this.eq(0) : this,
          ...
          r = Ve.height(),
          a = a || "both",
          t = !0 !== t || i.offsetWidth * i.offsetHeight;
  ...
  var Xe = function (e, t, a, n, i, s) {
      for (
        var r = 0, o = ["webkit", "moz", "ms", "o"], l = 0;
        l < o.length && !I.requestAnimationFrame;
        ++l
      )
        (I.requestAnimationFrame = I[o[l] + "RequestAnimationFrame"]),
      ...
      "" === d.options.separator && (d.options.useGrouping = !1),
        ...
        (d.d = "string" == typeof e ? z.getElementById(e) : e),
        (d.startVal = Number(t)),
        (d.endVal = Number(a)),
        ...
        (d.formatNumber = function (e) {
          var e, t, e, a;
          if (
            ((e = e.toFixed(d.decimals)),
            (t = (e = (e += "").split("."))[0]),
            (e = 1 < e.length ? d.options.decimal + e[1] : ""),
            (a = /(\d+)(\d{3})/),
            d.options.useGrouping)
          )
            for (; a.test(t); )
              t = t.replace(a, "$1" + d.options.separator + "$2");
          return d.options.prefix + t + e + d.options.suffix;
        }),
        (d.easeOutExpo = function (e, t, a, n) {
        ...
        (d.count = function (e) {
          ...
          var e = (d.timestamp = e) - d.startTime;
          (d.remaining = d.duration - e),
            d.options.useEasing
              ? d.countDown
                ? (d.frameVal =
                    d.startVal -
                    d.easingFn(e, 0, d.startVal - d.endVal, d.duration))
              ...
              : d.countDown
              ? (d.frameVal =
                  d.startVal - (d.startVal - d.endVal) * (e / d.duration))
              : (d.frameVal =
                  d.startVal + (d.endVal - d.startVal) * (e / d.duration)),
            d.countDown
  ...
  function Qe(e, t) {
    var a, n;
    0 < e.length &&
      ((a = z.head || z.getElementsByTagName("head")[0]),
      ((n = z.createElement("style")).type = "text/css"),
      n.styleSheet
  ...
  function Ze() {
    ...
    T(".wpb_gallery .wpb_gallery_slidesnectarslider_style").each(function () {
      ...
      T(".portfolio-items, .wpb_gallery_slidesparallax_image_grid").each(
        function () {
          (e = Be()),
            0 < T(this).find(".pretty_photo").length
              ? T(this)
                  .find(".pretty_photo")
                  .removeClass("pretty_photo")
                  .attr("data-fancybox", "group_" + e)
              : 0 < T(this).find('a[rel*="prettyPhoto["]').length &&
                T(this)
    ...
    var t = (T("body.admin-bar").length, [60, 100]);
    te.winW < 1e3 && (t = [0, 0]),
  ...
  function Ue() {
    T("a.pp").removeClass("pp").addClass("magnific-popup"),
        ...
        T(".main-content img").each(function () {
          ...
          T(this).parent().is("[href]") &&
            ...
            T(this)
              ...
              .attr("href")
              .match(/\.(jpg|png|gif)\b/) &&
            T(this).parent().addClass("magnific-popup").addClass("image-link");
        })),
      T(
      ...
      T("a.magnific.gallery").each(function () {
        var e =
          0 < T(this).closest(".wpb_column").length
          ...
          (e.magnificPopup({
            ...
            callbacks: {
              elementParse: function (e) {
                (T(e.el.context).is("[href]") &&
                  -1 != T(e.el.context).attr("href").indexOf("iframe=true")) ||
                (T(e.el.context).is("[href]") &&
                  -1 !=
                    T(e.el.context)
                      .attr("href")
                  ...
                  ? (e.type = "iframe")
                  : T(e.el.context).is("[href]") &&
                    -1 != T(e.el.context).attr("href").indexOf("video-popup-")
                  ? (e.type = "inline")
                  : (e.type = "image");
              },
              imageLoadComplete: function () {
              ...
              open: function () {
                var e;
                0 < T(this.content).find(".mejs-video video").length &&
                  ...
                  (T.magnificPopup.instance.next = function () {
                    ...
                    this.wrap.removeClass("mfp-image-loaded"),
                      setTimeout(function () {
                        T.magnificPopup.proto.next.call(e),
                          0 < T(e.content).find(".mejs-video video").length &&
  ...
  function Ge() {
    setTimeout(function () {
      0 < T('body[data-ls="magnific"]').length ||
      0 < T('body[data-ls="pretty_photo"]').length
        ? Ue()
        : 0 < T('body[data-ls="fancybox"]').length && Ze();
    }, 100);
  }
  function Je() {
    T(Z + " .wpb_animate_when_almost_visible").each(function () {
      var e = T(this),
        t,
        a = new Waypoint({
          element: e,
          handler: function () {
            ...
            e.hasClass("animated")
              ...
              : (e.addClass("animated"),
                ...
                a.destroy(),
                e.is(".nectar-button") &&
                  0 < T('body[data-button-style*="rounded_shadow"]').length &&
                  setTimeout(function () {
  ...
  function Ke() {
    ...
    T(".nectar-milestone").each(function () {
      ...
      ((!x && 0 < T(".nectar-milestone").length) ||
        (E.hasClass("rtl") && 0 < T(".nectar-milestone").length)) &&
        ((r = ""),
        T(Z + ".nectar-milestone.motion_blur").each(function (e) {
          T(this).removeClass(function (e, t) {
            return (t.match(/(^|\s)instance-\S+/g) || []).join(" ");
          }),
            T(this).addClass("instance-" + e);
          var t = T(this).find(".number").css("color"),
            a = parseInt(t.substring(1), 16),
            n = (16711680 & a) >> 16,
            i = (65280 & a) >> 8,
            t = (255 & a) >> 0,
            a = "rgba(" + n + "," + i + "," + t + ",0.2)",
            i = "rgba(" + n + "," + i + "," + t + ",1)",
            t = parseInt(T(this).find(".number").attr("data-number-size")),
            i,
            e,
            s;
          (r +=
            ...
            e +
            "; } "),
            (0 == K.$usingFullScreenRows &&
              0 != T(this).find(".number > span").length) ||
              ((i = T(this).find(".symbol-wrap").clone()),
              T(this).find(".symbol-wrap").remove(),
              (e = T(this).find(".number").text().split("")),
              (s = T(this).find(".number")).empty(),
              T.each(e, function (e, t) {
                s.append("<span>" + t + "</span");
              }),
  ...
  function et() {
    T(Z + ".nectar-milestone").each(function () {
      var e = 1 == U ? "250%" : "98%";
      te.usingMobileBrowser && "98%" == e && (e = "110%");
      var i = T(this),
        s = new Waypoint({
          element: i,
          handler: function () {
            ...
            (0 < i.parents(".wpb_tab").length &&
              ...
              ((e = parseInt(
                i.find(".number span:not(.symbol)").text().replace(/,/g, "")
              )),
              i.hasClass("motion_blur")
                ? i.find("span").each(function (e) {
                    var t = T(this);
                    setTimeout(function () {
                      t.addClass("in-sight");
                    }, 200 * e);
                ...
                : ((t = { easingFn: De }),
                  (a = i.find(".number span:not(.symbol)")[0]),
                  new Xe(a, 0, e, 0, 2.2, t).start()),
  ...
  function tt(e) {
    var t = e.parents("li").index() + 1,
      a = 0 < T("body.vc_editor").length ? "> .wpb_tab " : "",
      n;
    if (
      (e.hasClass("active-tab") ||
        e.hasClass("loading") ||
        (e.parents("ul").find("a").removeClass("active-tab"),
        ...
        0 < T("body.vc_editor").length
          ? ((n = e.parent().is("[data-m-id]")
              ? e.parent().attr("data-m-id")
              : ""),
            e
              .parents(".tabbed")
              .find('> div[data-model-id="' + n + '"]' + a)
              .css({
                visibility: "visible",
                position: "relative",
                left: "0",
            ...
            E.is('[data-flex-cols="true"]') || Fi())
          : e
              .parents(".tabbed")
              .find("> div:nth-of-type(" + t + ")" + a)
              .css({
                visibility: "visible",
                position: "relative",
                left: "0",
        ...
        (0 <
          e
            .parents(".tabbed")
            .find("> div:nth-of-type(" + t + ") .iframe-embed").length ||
          0 <
            e
              .parents(".tabbed")
              .find("> div:nth-of-type(" + t + ") .portfolio-items").length) &&
          setTimeout(function () {
            k.trigger("resize");
          }, 10)),
      0 != Q)
    ) {
      var a = e.parents(".tabbed").find("> div:nth-of-type(" + t + ")" + a),
        i,
        s;
      if (
        (0 < a.find(".nectar-progress-bar").length && Qt(),
        ...
        for (var r = 0; r < B.length; r++)
          0 < T(B[r].canvasContainer).parents(".wpb_tab").length &&
            "hidden" !=
              T(B[r].canvasContainer).parents(".wpb_tab").css("visibility") &&
            (0 ==
              T(B[r].canvasContainer).find(".image-added-to-stage").length &&
              B[r].imgContainer.addChild(B[r].bg),
            T(B[r].canvasContainer)
              .find(".nectar-liquid-bg")
              .addClass("image-added-to-stage"),
            B[r].resize(),
            0 ==
              T(B[r].canvasContainer).find(".nectar-liquid-bg.animated-in")
                .length && B[r].animateProps(B[r]));
      0 < a.find(".nectar-milestone").length && et(),
        0 <
          a.find('.nectar_image_with_hotspots[data-animation="true"]').length &&
          (ta(),
          setTimeout(function () {
            k.trigger("resize");
          }, 100)),
        0 < a.find(".nectar-fancy-ul").length && Ct(),
        0 < a.find(".nectar-split-heading").length && Dt(),
        0 < a.find('.wpb_column[data-border-animation="true"]').length && Zt(),
        0 < a.find(".wpb_animate_when_almost_visible").length && Je(),
        0 < a.find(".nectar-animated-title").length && la(),
        0 < a.find(".nectar-highlighted-text").length && da(),
        0 < a.find(".nectar_food_menu_item").length && Ut(),
        0 < a.find('.nectar-post-grid:not([data-animation="none"])').length &&
          oa(),
        0 < e.parents(".wpb_row").length &&
          ((0 < a.find(".vc_pie_chart").length ||
            ...
            0 <
              e
                .parents(".tabbed")
                .find("> div:nth-of-type(" + t + ")")
                .find(".wpb_gallery").length ||
            e.parents(".wpb_row").next().hasClass("parallax_section")) &&
            k.trigger("resize"),
        ...
        a.find(".svg-icon-holder").each(function (t) {
          var a = T(this);
          setTimeout(function () {
            var e = 0;
            a.is("[data-animation-delay]") &&
              ...
              "false" == a.attr("data-animation")
                ? (a.css("opacity", "1"),
                  A[a.find("svg").attr("id").slice(-1)].finish())
                : (A[a.find("svg").attr("id").slice(-1)].reset(),
    ...
    e
      ...
      .each(function () {
        ...
        void 0 !== T(this).find('[class*="vc_col-"]').first().offset() &&
          ((e = T(this).find('[class*="vc_col-"]').first().offset().left),
          T(this)
            .find('[class*="vc_col-"]')
            .each(function () {
      ...
      Q++,
      0 < e.parent().parent().find(".magic-line").length && at(e);
  }
  function at(e) {
    var t,
      a,
      n,
      t = e.parent();
    t.length ? ((a = t.position().left), (n = t.width())) : (a = n = 0),
      e
        .parent()
        .parent()
        .find(".magic-line")
  ...
  function it() {
    E.on("click", ".tabbed > ul li:not(.cta-button) a", function () {
      return tt(T(this)), !1;
    }),
        ...
        T(this)
          ...
          .each(function (e) {
            ...
            T(this).is("[data-tab-icon]") &&
              0 < T(this).attr("data-tab-icon").length &&
              (T(this).parents(".tabbed").addClass("using-icons"),
              T(this)
                .parents(".tabbed")
              ...
              0 < T(this).find(".im-icon-wrap.tab-icon").length &&
                ((t = T(this).find(".im-icon-wrap.tab-icon").detach()),
                T(this)
                  .parents(".tabbed")
                  .find(".wpb_tabs_nav li:nth-child(" + (e + 1) + ") > a")
                  .prepend(t));
          }),
          0 == T(this).find(".swiper-container").length &&
            0 == T(this).find(".testimonial_slider").length &&
            0 == T(this).find('.portfolio-items:not(".carousel")').length &&
            0 == T(this).find(".wpb_gallery .portfolio-items").length &&
            0 == T(this).find("iframe").length &&
            T(this).find("> ul li:first-child a").trigger("click"),
          (0 < T(this).find(".testimonial_slider").length ||
            0 < T(this).find('.portfolio-items:not(".carousel")').length ||
            0 < T(this).find(".wpb_gallery .portfolio-items").length ||
            0 < T(this).find("iframe").length) &&
            ((e = T(this)),
            T(this).find(".wpb_tab").show().css({ opacity: 0, height: "1px" }),
            T(this).find("> ul li a").addClass("loading"),
            setTimeout(function () {
              e.find(".wpb_tab").hide().css({ opacity: 1, height: "auto" }),
                e.find("> ul li a").removeClass("loading"),
                e.find("> ul li:first-child a").trigger("click"),
                nt();
            }, 900)),
          (e = T(this)),
          setTimeout(function () {
            e.is('[data-style="minimal_alt"]') &&
              ...
              at(e.find("> ul > li:first-child > a")));
          }, 100);
      }),
      0 < T('.tabbed[data-style="minimal_alt"]').length &&
        k.on("smartresize", function () {
          T('.tabbed[data-style="minimal_alt"]').each(function () {
            0 < T(this).find("a.active-tab").length &&
              at(T(this).find("a.active-tab"));
          });
        }),
      nt(),
      T(".nectar-scrolling-tabs").each(function (e) {
        te.usingFrontEndEditor || (D[e] = new st(T(this)));
      });
  }
  function st(e) {
    (this.$el = e),
      (this.$tabContent = e.find(".scrolling-tab-content")),
  ...
  function ot() {
    T(".toggles").each(function () {
      var e = T(this).find(".toggle.open"),
        e;
      0 < e.length &&
        ((e = e.find("> div")[0]).style.maxHeight = e.scrollHeight + "px");
    });
  }
  function lt() {
    setTimeout(function () {
      T(".accordion").each(function () {
        var e;
        0 == T(this).find('.toggle[data-inner-wrap="true"]').length
          ? T(this)
              .find("> .toggle")
              .first()
              .addClass("open")
              ...
              .show()
          : te.usingFrontEndEditor ||
            ((e = T(this).find("> .toggle").first()).addClass("open"),
      ...
      0 < T('.toggle[data-inner-wrap="true"]').length &&
        k.on("smartresize", ot);
  }
  function dt() {
    E.on("click", ".toggle h3 a", function () {
      var e;
      if (!T(this).parents(".toggles").hasClass("accordion"))
        return (
          0 == T(this).parents('.toggle[data-inner-wrap="true"]').length
            ? T(this).parents(".toggle").find("> div").slideToggle(300)
            : (e = T(this).parents(".toggle").find("> div")[0]).style.maxHeight
            ? (e.style.maxHeight = null)
            : (e.style.maxHeight = e.scrollHeight + "px"),
          T(this).parents(".toggle").toggleClass("open"),
          T(this).parents(".toggle").hasClass("open")
            ? T(this).find("i").attr("class", "icon-minus-sign")
            : T(this).find("i").attr("class", "icon-plus-sign"),
          0 < T(this).parents(".toggle").find("> div .iframe-embed").length &&
            "0" ==
              T(this)
                .parents(".toggle")
          ...
          0 < T("#nectar_fullscreen_rows").length &&
            setTimeout(function () {
              k.trigger("smartresize");
            }, 300),
          !1
        );
    }),
      E.on("click", ".accordion .toggle h3 a", function () {
        if (T(this).parents(".toggle").hasClass("open")) return !1;
        var e,
          t = T(this).parents(".toggles"),
          a = T(this).parents(".toggle"),
          n;
        return (
          0 == T(this).parents('.toggle[data-inner-wrap="true"]').length
            ? (t.find(".toggle > div").slideUp(300),
              t.find(".toggle h3 a i").attr("class", "icon-plus-sign"),
              t.find(".toggle").removeClass("open"),
              a.find("> div").slideDown(300))
            : ((n = a.find("> div")[0]),
              t.find(".toggle > div").each(function () {
  ...
  function ht() {
    T(".nectar-3d-transparent-button").each(function () {
      var e, t, a, n, i, n, s, r, i;
      "visible" == T(this).css("visibility") &&
        ((a = 0),
        (n = 1.7),
        "extra_jumbo" == (e = T(this)).attr("data-size") &&
          ((n =
            te.winW < 1e3 && 690 < te.winW
              ? ((a = 64),
                (i = 34),
          ...
          e.find("> a").css({ height: i + a + "px" }),
          e
            .find(".back-3d svg, .front-3d svg")
            .css({ width: r + 1.5 * a + "px", height: i + a + "px" })
            .attr("viewBox", "0 0 " + (r + a) + " " + (i + a)),
          e
            .find("svg text")
            .attr(
              "transform",
              "matrix(1 0 0 1 " + (r + 1.6 * a) / 2 + " " + (i + a) / n + ")"
            ),
          e
            .find(".front-3d ")
            .css("transform-origin", "50% 50% -" + (i + a) / 2 + "px"),
          e
            .find(".back-3d")
            .css("transform-origin", "50% 50% -" + (i + a) / 2 + "px")));
    });
  ...
  function ut() {
    ...
    T(
      ...
      var e = 0 < T('body.material[data-button-style^="rounded"]').length,
        t,
        a;
      if (
      ...
      (t =
        "false" != T(this).attr("data-color-override")
          ...
          : 0 < T(this).parents(".dark").length
          ? "#000000"
          : "#ffffff"),
        T(this).hasClass("see-through-3") || T(this).css("color", t),
        T(this).find("i").css("color", t);
      var n = parseInt(t.substring(1), 16),
        i = T(this).has("[data-hover-color-override]")
          ? T(this).attr("data-hover-color-override")
          : "no-override",
        s = T(this).has("[data-hover-text-color-override]")
          ? T(this).attr("data-hover-text-color-override")
          : "#fff",
        r = (16711680 & n) >> 16,
        o = (65280 & n) >> 8,
        l = (255 & n) >> 0,
        d = T(this).hasClass("see-through-3") ? "1" : "0.75";
      T(this).css(
        "border-color",
        "rgba(" + r + "," + o + "," + l + "," + d + ")"
      ),
        ...
        T(this).hasClass("see-through")
          ? ((a = T(this)),
            T(this).on("mouseenter touchstart", function () {
              a.css("border-color", "rgba(" + r + "," + o + "," + l + ",1)");
            }),
          ...
          : (T(this).find("i").css("color", s),
            "no-override" != i
              ? ((a = T(this)),
                T(this).on("mouseenter touchstart", function () {
                  a.css({ "border-color": i, "background-color": i, color: s }),
                    e &&
                      a
                        .find("i")
              ...
              : ((a = T(this)),
                T(this).on("mouseenter touchstart", function () {
                  a.css({ "border-color": i, color: s });
                }),
                T(this).on("mouseleave touchtouchend", function () {
                  (d = a.hasClass("see-through-3") ? "1" : "0.75"),
                    a.css({
                      "border-color":
                        "rgba(" + r + "," + o + "," + l + "," + d + ")",
                      color: s,
      ...
      T(
        ...
        T(this).css("visibility", "visible"),
          "false" != T(this).attr("data-color-override") &&
            ((e = T(this).attr("data-color-override")),
            T(this)
      ...
      (0 < T(".swiper-slide .solid_color_2").length ||
        0 < T(".tilt-button-inner").length) &&
        ((n = ""),
        T(".swiper-slide .solid_color_2 a").each(function (e) {
          T(this).addClass("instance-" + e),
            (i =
              "false" != T(this).attr("data-color-override")
                ? T(this).attr("data-color-override")
                ...
                : "#ffffff"),
            T(this).css("color", i),
            T(this).find("i").css("color", i);
          var t = T(this).css("background-color"),
            a = ct(t, 0.13),
            t = ct(t, -0.15);
          n +=
        ...
        T(".tilt-button-wrap a").each(function (e) {
          ...
          var t = T(this).css("background-color"),
            a;
          "false" != T(this).attr("data-color-override") &&
            ((a = T(this).attr("data-color-override")),
            T(this).css("background-color", a),
            (t = a));
          var a = ct(t, 0.13),
            t = ct(t, -0.15);
          n +=
        ...
        Qe(n, "tilt-button")),
      0 < T(".nectar-3d-transparent-button").length &&
        ((l = ""),
        T(".nectar-3d-transparent-button").each(function (e) {
          var t = T(this),
            ...
            r;
          "large" == a
            ? ((n = 46), (r = 16), (i = 1.5), (s = 1.7))
            : "medium" == a
            ? ((n = 30), (r = 16))
            : "small" == a
            ? ((n = 20), (r = 12))
            : "jumbo" == a
            ? ((n = 54), (r = 24), (i = 1.5), (s = 1.68))
            : "extra_jumbo" == a && ((n = 100), (r = 64), (s = i = 1.6)),
          ...
          var o,
            a = T(this)
              ...
              .getBoundingClientRect().width,
            r = 1.5 * r;
          t.css({ width: a + 1.5 * n + "px", height: r + n + "px" }),
            t.find("> a").css({ height: r + n + "px" }),
            t
              .find(".back-3d svg, .front-3d svg")
              .css({ width: a + 1.5 * n + "px", height: r + n + "px" })
              .attr("viewBox", "0 0 " + (a + n) + " " + (r + n)),
            t
              .find("svg text")
              .attr(
                "transform",
                "matrix(1 0 0 1 " + (a + n * i) / 2 + " " + (r + n) / s + ")"
              ),
            t
              .find(".front-3d, .back-3d")
              .css("transform-origin", "50% 50% -" + (r + n) / 2 + "px"),
            T(this)
  ...
  function gt() {
    ...
    0 !== T(".team-member").length &&
      (E.on(
        ...
        function () {
          var e, t, a, n, i, s, t, s, n;
          0 < T(".nectar_team_member_overlay").length ||
            ((e = 0 < T("body > #boxed").length ? "in-boxed" : ""),
            (t = T(this).find(".nectar_team_bio").html()),
            (a = (
              T(this).is('[data-style="bio_fullscreen_alt"]')
                ? T(this).find(".team-meta h5")
                : T(this).find(".team-meta p")
            ).html()),
            (n =
              0 < T(this).find(".nectar_team_bio_img[data-img-src]").length
            ...
            (i = T(this).is('[data-style="bio_fullscreen_alt"]')
              ...
              : "bio-fullscreen"),
            (s = ""),
            (s = T(this).is('[data-style="bio_fullscreen_alt"]')
              ? '<div class="title">' +
                a +
                "</div><h2>" +
                T(this).find(".team-meta h3").html() +
                "</h2>"
              : "<h2>" +
                T(this).find(".team-meta h3").html() +
                '</h2><div class="title">' +
            ...
            0 < T(".using-mobile-browser").length &&
            ...
            0 == T(".using-mobile-browser").length && mt(),
            0 < T('.team-member[data-style="bio_fullscreen"]').length &&
              te.usingMobileBrowser &&
              T(".nectar_team_member_overlay").addClass("on-mobile"));
        }
      ),
      E.on("click", ".nectar_team_member_overlay", function () {
      ...
      (0 < T('.team-member[data-style="bio_fullscreen"]').length ||
        0 < T('.team-member[data-style="bio_fullscreen_alt"]').length) &&
        (k.on("resize", ft),
        te.usingMobileBrowser || (e = new se("", "close-indicator"))));
  }
  function ft() {
    var e =
      0 < T('body[data-header-format="left-header"]').length && 1e3 < k.width()
        ? 275
        : 0;
    T(".nectar_team_member_overlay").css({ width: k.width() - e, left: e });
  }
  function mt() {
    T(".nectar_team_member_overlay .inner-wrap").mousewheel(function (e, t) {
      (this.scrollTop -= 30 * t), e.preventDefault();
    });
  }
  function bt() {
    var n = "";
    T(".wpb_column").each(function (e) {
      T(this).removeClass(function (e, t) {
        return (t.match(/(^|\s)instance-\S+/g) || []).join(" ");
      }),
        T(this).addClass("instance-" + e);
      var t =
          0 <
            T(this).find("> .vc_column-inner > .column-bg-overlay-wrap")
              .length ||
          0 < T(this).find("> .vc_column-inner > .column-bg-overlay").length
            ? " > .vc_column-inner "
            : "",
        a =
          0 < T(this).find(t + " > .column-bg-overlay-wrap").length
        ...
        T(
          ...
          T(this).is(".row-bg")
            ...
            : T(this).is(".column-image-bg") &&
              ...
              (n = "col")),
            (B[e] = new NectarLiquid(t, a, n));
        });
  }
  function wt() {
    var r, o;
    0 < T(".morphing-outline").length &&
      ((r = ""),
      (o = 0 < T("body.vc_editor").length ? "" : ">"),
      T(".morphing-outline").each(function (e) {
        T(this).removeClass(function (e, t) {
          return (t.match(/(^|\s)instance-\S+/g) || []).join(" ");
        }),
          T(this)
        ...
        var t = T(this).find(".inner").width(),
          a = T(this).find(".inner").height(),
          n = parseInt(T(this).attr("data-border-thickness")),
          i =
            0 < T('body[data-button-style*="rounded"]').length ? ":hover" : "",
          s =
            0 < T('body[data-button-style*="rounded"]').length ? "" : ":hover";
        (r +=
      ...
      Qe(r, "morphing-outlines"));
  }
  function yt() {
    0 < T(".morphing-outline").length &&
      (setTimeout(wt, 100), setTimeout(Wt, 125), k.on("smartresize", wt));
  }
  function _t() {
    var r = 1 == U ? "200%" : "bottom-in-view";
    0 == A.length
      ? (T(".svg-icon-holder:not(.animated-in)")
          .has("svg")
          .each(function (e) {
            var a = T(this);
            x && a.attr("data-animation", "false"),
              a
                .find("svg")
                .css({
            ...
            function i() {
              ...
              1 == A[t].isReady
                ? setTimeout(function () {
                    a.css("opacity", "1"), A[t].reset().play();
                  }, e)
                : setTimeout(i, 50);
            }
            function s() {
            ...
            "false" == a.attr("data-animation") &&
              ((t = 1), a.css("opacity", "1")),
              a.hasClass("bound") ||
                (A[e] = new Vivus(a.find("svg").attr("id"), {
                  type: "delayed",
      ...
      T("#nectar_fullscreen_rows .svg-icon-holder.animated-in")
        ...
        .each(function (e) {
          ...
          clearTimeout(N[e]),
            "false" == a.attr("data-animation")
              ? (a.css("opacity", "1"), A[n].finish())
              : 0 < T(this).parents(".active").length ||
                0 < T(this).parents("#footer-outer").length ||
  ...
  function Ct() {
    T(Z + ".nectar-fancy-ul").each(function () {
  ...
  function xt() {
    T('.nectar-fancy-ul:not([data-list-icon="dot"])').each(function () {
      var e = T(this).attr("data-list-icon"),
        t = T(this).attr("data-color");
      T(this)
        .find("li")
        .each(function () {
          T(this).find("> i").remove(),
            T(this).prepend(
              '<i class="icon-default-style ' + e + " " + t + '"></i> '
            );
        });
    });
  }
  function kt() {
    T(".nectar-flip-box").each(function () {
      var e = parseInt(T(this).attr("data-min-height")),
        t = T(this).find(".flip-box-front .inner").height();
      e - 80 <=
      (t =
  ...
  function It() {
    T(
      ...
      !te.usingMobileBrowser &&
        0 < T('body[data-boxed-style="1"]').length &&
        0 < T("#boxed").length &&
        Ft();
  }
  function zt() {
    var i = te.winW,
      e =
        0 < T(".body-border-right").length && 1e3 < i
          ? 2 * parseInt(T(".body-border-right").width())
          : 0,
      s =
        0 < T(".container-wrap").length
      ...
      o =
        1 == T("#boxed").length
          ? (parseInt(T(".container-wrap").width()) -
            ...
            4
          : ((d =
              0 < T('body[data-ext-responsive="true"]').length && 1e3 <= i
                ? 180
                : 0),
            (r =
              s - e <= parseInt(T(".main-content").css("max-width"))
                ? parseInt(T(".main-content").css("max-width"))
                : s - e),
            (c = parseInt(T(".main-content").css("max-width"))),
            0 < T('body.single-post[data-ext-responsive="true"]').length &&
              0 < T(".container-wrap.no-sidebar").length &&
              ((c = T(".post-area").width()), (d = 0)),
            Math.ceil((r + d - c) / 2));
    T(".carousel-outer")
      ...
      T(
        ...
        var e =
            0 < T('#header-outer[data-format="left-header"]').length && 1e3 <= i
              ? parseInt(T('#header-outer[data-format="left-header"]').width())
              : 0,
          t =
            0 < T(".body-border-right").length && 1e3 < i
        ...
        o =
          1 == T("#boxed").length
            ? ((l =
              ...
              0 < T('body.single-post[data-ext-responsive="true"]').length &&
              0 < T(".container-wrap.no-sidebar").length &&
              0 < T(this).parents(".post-area").length
                ? ((c = T(".post-area").width()),
                  (d = 0),
                  (r = s - t),
                  Math.ceil((r + d - c) / 2))
                : 0 < T(this).parents(".page-submenu").length
                ? (parseInt(T(".container-wrap").width()) - l) / 2
                : (parseInt(T(".container-wrap").width()) - l) / 2 + 4)
            : (0 < T('body.single-post[data-ext-responsive="true"]').length &&
              0 < T(".container-wrap.no-sidebar").length &&
              0 < T(this).parents(".post-area").length
                ? ((c = T(".post-area").width()), (d = 0), (r = s - t))
                : ((a =
                    0 == T("#nectar_fullscreen_rows").length
                      ? parseInt(T(".main-content").css("max-width"))
                      : parseInt(
                          T(this).parents(".container").css("max-width")
                        )),
                  s - t <= a && (r = a),
                  (c = a),
                  (d =
              ...
              Math.ceil((r + d - c) / 2));
        var a = 0;
        T(this).hasClass("carousel-wrap") && (a = 1),
          T(this).hasClass("portfolio-items") && (a = 5);
        var e = 1 == T("#boxed").length ? l + parseInt(2 * o) : s - t + a,
          e,
          n;
        0 == T("#boxed").length &&
          T(this).hasClass("portfolio-items") &&
          T(this).is('[data-gutter*="px"]') &&
          0 < T(this).attr("data-gutter").length &&
          ...
          T(this).parent().hasClass("default-style")
            ? ((l =
                0 == T("#nectar_fullscreen_rows").length
                  ...
                  : parseInt(T(this).parents(".container").width())),
              0 != T("#boxed").length
                ? (e = 1 == T("#boxed").length ? l + parseInt(2 * o) : s + a)
                : ((e =
                    1 == T("#boxed").length
                      ? l + parseInt(2 * o)
                      : s - t - 0.025 * (s - t) + a),
                  (r = s - t <= l ? l : s - t - 0.025 * (s - t)),
                  (o = Math.ceil((r - l) / 2))))
            : T(this).parent().hasClass("spaced") &&
              ((l =
                0 == T("#nectar_fullscreen_rows").length
                  ? parseInt(T(".main-content").width())
                  : parseInt(T(this).parents(".container").width())),
              0 != T("#boxed").length
                ? (e =
                    1 == T("#boxed").length
                      ? l + parseInt(2 * o) - 0.02 * s
                      : s + a)
                : ((e =
                    1 == T("#boxed").length
                      ? l + parseInt(2 * o)
                      : s - t - Math.ceil(0.02 * (s - t)) + a),
                  (o = Math.ceil(
                    ((s - t <= l ? l : s - t - 0.02 * (s - t)) - l) / 2 + 2
                  )))),
          0 < !T(this).parents(".span_9").length &&
          !T(this).parent().hasClass("span_3") &&
          "sidebar-inner" != T(this).parent().attr("id") &&
          "portfolio-extra" != T(this).parent().attr("id") &&
          0 < !T(this).find('.carousel-wrap[data-full-width="true"]').length &&
          0 < !T(this).find(".nectar-carousel-flickity-fixed-content").length &&
          0 <
            !T(this).find(
              '.portfolio-items:not(".carousel")[data-col-num="elastic"]'
            ).length
            ? 0 < T(".single-product").length &&
              0 < T(this).parents("#tab-description").length &&
  ...
  function Ht() {
    (te.usingMobileBrowser &&
      0 < T('body[data-remove-m-parallax="1"]').length) ||
      (Mt(),
      T(
        ...
        0 == T(this).find('[data-parallax-speed="fixed"]').length &&
          (0 == T(this).find(".row-bg").length
            ? T("#" + e).parallaxScroll("50%", 0.25)
            : T("#" + e + ".parallax_section").parallaxScroll(
                "50%",
                Et(T(this).find(".row-bg").attr("data-parallax-speed"))
              )),
    ...
    T(".full-width-section.wpb_row, .full-width-content.wpb_row").each(
      function () {
        if (
          ...
          if (
            0 < T(this).parents("#portfolio-extra").length &&
            0 == T("#full_width_portfolio").length
          )
            return !1;
          var e;
  ...
  function Mt() {
    (te.usingMobileBrowser &&
      ...
      T(
        ...
        var e, t, a, n, i, s, r, e, e, n;
        (0 == T(this).find(".row-bg").length &&
          0 < T(this).find(".page-header-bg-image").length) ||
          (0 == T(this).find(".row-bg").length &&
          0 < T(this).find(".image-bg").length
            ? ((e = !1),
              0 == T(".wpb_row").length &&
                0 <
                  T(this).parents('.nectar-slider-wrap[data-full-width="true"]')
                    .length &&
                0 < T(this).parents(".parallax_slider_outer").length &&
                "1" == T(this).parents(".parallax_slider_outer").index() &&
                (e = !0),
              0 < T("#portfolio-extra").length &&
                0 < T(this).parents(".wpb_row").length &&
                0 < T(this).parents(".parallax_slider_outer").length &&
                "0" == T(this).parents(".wpb_row").index() &&
                (e = !0),
              (0 < T(this).parents(".top-level").length &&
                !te.usingFrontEndEditor) ||
              (e && !te.usingFrontEndEditor)
                ...
                : T(this)
                    ...
                    .css({
                      height:
                        Math.ceil(0.25 * k.height()) + T(this).outerHeight(!0),
                    }))
            : 0 == T(this).find(".row-bg").length &&
              0 < T(this).find(".video-wrap").length
            ? ((e = !1),
              0 == T(".wpb_row").length &&
                0 <
                  T(this).parents('.nectar-slider-wrap[data-full-width="true"]')
              ...
              (n = 720),
              (r =
                (t = T(this).find(".video-wrap video")).parent().width() / a),
              (e = t.parent().height() / n),
              t.width((e = e < r ? r : e) * a),
              t.height(e * n))
            : (T(this).is(".nectar-recent-posts-single_featured") &&
              ...
              ((n =
                0 < T(this).find('.row-bg[data-parallax-speed="fast"]').length
                  ? 60
                  : 0),
              T(this)
                .find(".row-bg")
  ...
  function Ot() {
    ...
    var e = (
        0 == T("#portfolio-extra").length
          ? T(".main-content > .row > *")
          : T(".main-content > .row #portfolio-extra > *")
      ).length,
      e = (
        0 == T("#portfolio-extra").length
          ? 0 < T(".main-content > .row > .wpb_row").length
            ? T(".main-content > .row > .wpb_row")
            : T(".main-content > .row > *")
          : T(".main-content > .row #portfolio-extra > *")
      ).length;
    T(
      ...
      if (
        ...
        if (0 < T(this).parents(".wpb_row").length) {
          if (
            0 < T(this).parents("#portfolio-extra").length &&
            0 == T("#full_width_portfolio").length
          )
            return !1;
          ("0" == T(this).parents(".wpb_row").index() && 0 != s.length) ||
            ("0" == T(this).parents(".wpb_row").index() &&
              0 == s.length &&
              0 == T(".page-header-no-bg").length &&
              0 == T(".project-title").length &&
              ...
              (0 == T(".single").length
                ...
                : T(this).addClass("first-section"))),
            T(this).parents(".wpb_row").index() == e - 1 &&
              0 == T("#respond").length &&
          ...
          0 == T(this).find(".portfolio-filters-inline").length &&
            ...
            (("0" == T(this).index() && 0 != s.length) ||
              ...
              ((1 == T('body[data-header-resize="0"]').length &&
                0 == T(".single").length) ||
              (0 < T("body.material").length && 0 == T(".single").length)
                ? 0 <
                    !T(
                      "body.blog .blog-fullwidth-wrap > .masonry:not(.meta-overlaid)"
                    ).length && T(".container-wrap").css("padding-top", "0px")
                : T(this).addClass("first-section")),
            T(this).index() == e - 1 &&
              0 == T("#respond").length &&
      ...
      T(
        ...
        T(this).index() == e - 1 &&
          ...
          (0 < parseInt(T(".container-wrap").css("padding-bottom")) &&
            T(this).css("margin-bottom", "-40px"),
          T("#call-to-action .triangle").remove());
      }),
      T(".portfolio-filters").each(function () {
        ("0" == T(this).index() && 0 != s.length) || "0" == T(this).index()
  ...
  function St() {
    0 == T("#boxed").length &&
      T(
        ...
        var e = k.width(),
          t = T(this).attr("data-top-percent")
            ? T(this).attr("data-top-percent")
            : "skip",
          a = T(this).attr("data-bottom-percent")
            ? T(this).attr("data-bottom-percent")
            : "skip";
        "skip" != t && T(this).css("padding-top", e * (parseInt(t) / 100)),
          "skip" != a && T(this).css("padding-bottom", e * (parseInt(a) / 100));
      });
  }
  function Ft() {
    0 < T("#boxed").length &&
      T(
        ...
        var e = T(this).attr("data-top-percent")
            ? T(this).attr("data-top-percent")
            : "skip",
          t = T(this).attr("data-bottom-percent")
            ? T(this).attr("data-bottom-percent")
            : "skip";
        "skip" != e && T(this).css("padding-top", e),
          "skip" != t && T(this).css("padding-bottom", t);
      });
  }
  function $t() {
    te.usingMobileBrowser && St(), k.on("resize", St);
  }
  function Wt() {
    var i = 0 < T("body.vc_editor").length ? ".vc_element > " : "";
    T(
      ".main-content > .row > " +
        i +
      ...
      var a, t, n;
      1 < T(this).find("> .span_12 > " + i + " .col").length &&
        ((t = a = 0),
        T(this)
          .find("> .span_12 > " + i + "  .col")
          .each(function () {
            n =
              0 < T(this).find("> .vc_column-inner > .wpb_wrapper").length
                ? ".vc_column-inner"
                : ".column-inner-wrap > .column-inner";
            var e = E.is('[data-flex-cols="true"]')
                ? parseInt(
                    T(this).find("> .vc_column-inner").css("padding-top")
                  )
                : parseInt(T(this).css("padding-top")),
              t =
                2 < i.length && 0 < T(this).find("> .vc_column-inner").length
                  ? parseInt(
                      T(this).find("> .vc_column-inner").css("padding-top")
                    )
                  : 0;
          ...
          .each(function () {
            (n =
              0 < T(this).find("> .vc_column-inner > .wpb_wrapper").length
                ? ".vc_column-inner"
                : ".column-inner-wrap > .column-inner"),
              0 < T(this).find("> " + n + " > .wpb_wrapper > *").length
                ? ((i.length < 2 &&
                    !T(this)
                      .parent()
                      .parent()
      ...
      0 == T('body[data-flex-cols="true"]').length &&
        (T(
          ...
          0 <
            T(this).find(
              ">.span_12 > " + i + ' .wpb_column[data-animation*="reveal"]'
            ).length &&
            ((t = 0),
            T(this)
              .find("> .span_12 > " + i + " .col")
            ...
            T(this)
              ...
              .each(function () {
                ...
                T(this).find(
                  ...
                  ? T(this).find("> .column-inner-wrap").css("height", t)
                  : (T(this).css("min-height", t),
                    T(this).is('[data-animation*="reveal"]') &&
                      T(this).find(".column-inner").css("min-height", t));
              }));
        }),
        T(
  ...
  function jt() {
    T(".wpb_row:has(.nectar-parallax-scene)").each(function (e) {
      ...
      P[e] = T(this)
        ...
        .parallax({ scalarX: t, scalarY: t });
      var a = T(this).find(".nectar-parallax-scene li");
      T.each(a, function () {
        var e, t;
        0 < T(this).find("div").length &&
          (t = T(this)
            .find("div")
  ...
  function Pt() {
    ...
    T(
      ...
      var e = T(this).parents(".row-bg-wrap").attr("data-bg-animation"),
        t,
        a;
      (s = "zoom-out-reveal" != e && -1 == e.indexOf("reveal-from-") ? n : i),
        (!T(this).hasClass("using-image") &&
          0 == T(this).parents(".nectar-scrolling-text").length &&
          "zoom-out-reveal" != e &&
          -1 == e.indexOf("reveal-from-")) ||
          ((t = T(this)),
          (a = new Waypoint({
            element: t.parents(".row-bg-wrap"),
            handler: function () {
              (0 < t.parents(".wpb_tab").length &&
                "hidden" == t.parents(".wpb_tab").css("visibility")) ||
                t.hasClass("animated-in") ||
                (t.parents(".inner-wrap").addClass("animated-in"),
                ("zoom-out-reveal" == e ||
                  -1 < e.indexOf("reveal-from-") ||
                  0 < t.parents(".nectar-scrolling-text").length) &&
                  t.parents(".row-bg-wrap").addClass("animated-in")),
                a.destroy();
            },
            offset: s,
          })));
    ...
    T(
      ...
      s =
        "zoom-out-reveal" != e && -1 == e.indexOf("reveal-from-")
          ? n
          : "ro-reveal-from-bottom" == e && 0 == U
          ? "95%"
          : "ro-reveal-from-top" == e && 0 == U
          ? "65%"
          : i;
      var t = T(this),
        a = new Waypoint({
          ...
          handler: function () {
            (0 < t.parents(".wpb_tab").length &&
              ...
              (t.parents(".inner-wrap").addClass("animated-in"),
              ("zoom-out-reveal" == e || -1 < e.indexOf("reveal-from-")) &&
                (t.parents(".column-image-bg-wrap").addClass("animated-in"),
                t
                  .parents(".column-image-bg-wrap")
      ...
      T(Z + ".column-bg-overlay-wrap[data-bg-animation]").each(function () {
        s = i;
        var e = T(this),
          t = T(this).attr("data-bg-animation"),
          a;
        ("zoom-out-reveal" == t || 0 < t.indexOf("reveal-from-")) &&
  ...
  function Rt() {
    var e = 1 == U ? "200%" : "88%",
      n = 1 == U ? "200%" : "70%",
      t = 1 == U ? "200%" : "70%";
    T(Z + ".img-with-animation").each(function () {
      var a = T(this),
        n = a.is("[data-animation]") ? a.attr("data-animation") : "fade-in";
      (("ro-reveal-from-right" == n && "88%" == e) ||
        ("ro-reveal-from-left" == n && "88%" == e)) &&
        (e = "75%");
      var i = new Waypoint({
        element: a,
        handler: function () {
          ...
          (0 < a.parents(".wpb_tab").length &&
            "hidden" == a.parents(".wpb_tab").css("visibility")) ||
            a.hasClass("animated-in") ||
            ((!x || 0 < T('body[data-responsive="0"]').length) &&
              ((e = a.is("[data-delay]") ? a.attr("data-delay") : 0),
              (t =
                0 < a.parents(".hover-wrap").length
                  ? a.parents(".hover-wrap")
                  : a),
              "fade-in-from-left" == n || "fade-in-from-right" == n
                ? t.delay(e).transition({ opacity: 1, x: "0px" }, C, _)
                : "fade-in-from-bottom" == n
                ? t.delay(e).transition({ opacity: 1, y: "0px" }, C, _)
                : "fade-in" == n
                ? t.delay(e).transition({ opacity: 1 }, C, _)
                : "grow-in" == n
                ? setTimeout(function () {
                    t.transition({ scale: 1, opacity: 1 }, C, _);
                  }, e)
                : "flip-in" == n
                ? setTimeout(function () {
                    t.transition({ rotateY: 0, opacity: 1 }, C, _);
                  }, e)
                : "flip-in-vertical" == n
                ? setTimeout(function () {
                    t.transition({ rotateX: 0, opacity: 1 }, C, _);
                  }, e)
                : ("ro-reveal-from-left" != n &&
                    "ro-reveal-from-right" != n &&
                    "ro-reveal-from-bottom" != n &&
                    "ro-reveal-from-top" != n) ||
                  a.parents(".img-with-aniamtion-wrap").addClass("animated-in"),
              a.addClass("animated-in"))),
            i.destroy();
        },
        offset: e,
      ...
      T(Z + ".nectar_cascading_images").each(function () {
        var e = T(this),
              ...
              (0 < e.parents(".wpb_tab").length &&
                ...
                ((!x || 0 < T('body[data-responsive="0"]').length) &&
                  (e.find(".cascading-image").each(function (e) {
                    var t = T(this);
                    "flip-in" == t.attr("data-animation") ||
                    "flip-in-vertical" == t.attr("data-animation")
                      ? setTimeout(function () {
                          t.find(".inner-wrap").css({
                            opacity: 1,
                            transform: "rotate(0deg) translateZ(0px)",
                          });
                        }, e * a)
                      : "grow-in-reveal" == t.attr("data-animation")
                      ? setTimeout(function () {
                          t
                            .find(".inner-wrap")
                            .css({
      ...
      T(
        ...
        var a = T(this);
        (a.is('[data-animation="flip-in-vertical"]') ||
          a.is('[data-animation="slight-twist"]')) &&
          0 == T('.page-submenu[data-sticky="true"]').length &&
          0 == a.parents(".nectar-scrolling-tabs").length &&
          a.parents(".col.span_12").addClass("flip-in-vertical-wrap");
        var n = new Waypoint({
          element: a,
          handler: function () {
            var e;
              ...
              ((!x || 0 < T('body[data-responsive="0"]').length) &&
                ...
                "fade-in-from-right" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ opacity: 1, x: "0px" }, C, _);
                    }, e))
                  : "fade-in-from-bottom" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ opacity: 1, y: "0px" }, C, _);
                    }, e))
                  : "fade-in" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ opacity: 1 }, C, _);
                    }, e))
                  : "grow-in" == a.attr("data-animation") ||
                    "zoom-out" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ scale: 1, opacity: 1 }, C, _);
                    }, e))
                  : "flip-in" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ rotateY: 0, opacity: 1 }, C, _);
                    }, e))
                  : "flip-in-vertical" == a.attr("data-animation")
                  ? (R[t] = setTimeout(function () {
                      a.transition({ rotateX: 0, y: 0, opacity: 1 }, C, _);
                    }, e))
                  : "slight-twist" == a.attr("data-animation") &&
                    (R[t] = setTimeout(function () {
                      anime({
                        targets: a[0],
                        rotateY: [20, 0],
                ...
                a.hasClass("boxed") &&
                  ...
                  setTimeout(function () {
                    a.removeClass("no-pointer-events");
                  }, parseInt(C) + parseInt(e) + 30)),
                a.find(
      ...
      T(Z + '.wpb_column.has-animation[data-animation*="reveal"]').each(
        function () {
          var a = T(this),
            n = new Waypoint({
              element: a,
              handler: function () {
                ...
                (0 < a.parents(".wpb_tab").length &&
                  ...
                  ((e = a.attr("data-delay")),
                  (!x || 0 < T('body[data-responsive="0"]').length) &&
                    ((t = 0 < a.find("> .vc_column-inner").length),
                    "reveal-from-bottom" == a.attr("data-animation") ||
                    "reveal-from-top" == a.attr("data-animation")
                      ? setTimeout(function () {
                          a.hasClass("animated-in") &&
                            (1 == t
                              ? a
                              ...
                              : a
                                  .find(".column-inner-wrap, .column-inner")
                                  .transition({ y: 0 }, C, _, function () {
                                    a.find(
                                      ".column-inner-wrap, .column-inner"
                                    ).addClass("no-transform");
                                  }));
                        }, e)
                      : ("reveal-from-right" != a.attr("data-animation") &&
                          "reveal-from-left" != a.attr("data-animation")) ||
                        setTimeout(function () {
                          a.hasClass("animated-in") &&
                            (1 == t
                              ? a
  ...
  function Nt() {
    T(".nectar_cascading_images").each(function () {
      0 < T(this).parents(".vc_row-o-equal-height").length &&
        0 < T(this).parents(".wpb_column").length &&
        ...
        T(this)
          ...
          .each(function () {
            var e = 0,
              t = 0,
              a;
            0 == T(this).parent().find(".img-wrap").length
              ? ((a = T(this)
                  .parents(".cascading-image")
                  .siblings('.cascading-image[data-has-img="true"]')
                  .first()).css({ position: "relative", visiblity: "hidden" }),
                (e = a.find(".img-wrap").height()),
                (t = a.find(".img-wrap").width()),
                0 == a.index()
                  ? a.css({ visiblity: "visible" })
                  : a.css({ position: "absolute", visiblity: "visible" }))
              : ((e = T(this).parent().find(".img-wrap").height()),
                (t = T(this).parent().find(".img-wrap").width())),
              T(this).css({ height: e, width: t });
          });
    });
  }
  function Vt() {
    var a;
    0 < T(".nectar_cascading_images").length &&
      ((a = []),
      T(".nectar_cascading_images").each(function (t) {
        imagesLoaded(T(this), function (e) {
          Nt(),
            T(e.elements[0]).is('[data-parallax="yes"]') &&
              !te.usingMobileBrowser &&
              0 == T("#nectar_fullscreen_rows").length &&
              (a[t] = new Xt(
                T(e.elements[0]),
                T(e.elements[0]).attr("data-parallax-intensity")
              ));
        });
      }),
      k.on("resize", Nt));
  ...
  function Xt(e, t) {
    ...
    this.calculatePos(),
      this.trackView(),
      this.animate(),
      (0 < T(".portfolio-filters").length ||
        0 < T(".portfolio-filters-inline").length) &&
        setInterval(this.calculatePos.bind(this), 700),
      k.on("resize", this.calculatePos.bind(this));
  }
  function Dt() {
    var t = 1 == U ? "200%" : "bottom-in-view";
    T(Z + ".nectar-split-heading").each(function () {
      var e = T(this),
        a = e.is("[data-animation-delay]")
          ? parseInt(e.attr("data-animation-delay"))
          : 0,
        n = new Waypoint({
          element: e,
          handler: function () {
            ...
            (0 < e.parents(".wpb_tab").length &&
              ...
              ((!x || 0 < T('body[data-responsive="0"]').length) &&
                setTimeout(function () {
                  e.is('[data-animation-type="line-reveal-by-space"]')
                    ? ((t = parseInt(C) < 900 ? C : "900"),
                      e.find("> * > span").each(function (e) {
                        T(this).find("> .inner").transition({ y: "0px" }, C, _);
                      }))
                    : e.is('[data-animation-type="letter-fade-reveal"]')
                    ? ((t = parseInt(C) < 1e3 ? C : "1000"),
                      e.find("> * > span span").each(function (e) {
                        T(this)
                          .delay(8 * e)
                          .transition({ y: "0px", opacity: "1" }, t, _);
                      }))
                    : e.find(".heading-line").each(function (e) {
                        T(this)
                          .find("> div")
                          .delay(70 * e)
                          .transition({ y: "0px" }, C, _);
                      }),
                    e.addClass("animated-in");
                }, a)),
              n.destroy();
  ...
  function Qt() {
    var a = 1 == U ? "200%" : "bottom-in-view",
      e =
        0 < T('#nectar_fullscreen_rows[data-mobile-disable="on"]').length &&
        te.usingMobileBrowser
          ? ".nectar-progress-bar"
          : Z + ".nectar-progress-bar";
    te.usingMobileBrowser && "bottom-in-view" == a && (a = "70%"),
      T(e)
        .parent()
        .each(function () {
          var e = T(this),
                ...
                (0 < e.parents(".wpb_tab").length &&
                  ...
                  ("100%" == a &&
                    e
                      ...
                      .css("opacity", "1"),
                  e.find(".nectar-progress-bar").each(function (e) {
                    var t = T(this).find("span").attr("data-width"),
                      n = parseInt(T(this).find("span strong i").text()),
                      i = T(this);
                    i
                      .find("span")
                      .delay(90 * e)
                      ...
                      setTimeout(function () {
                        var e = { useEasing: !1 },
                          t = i.find("span strong i")[0],
                          a;
                        new Xe(t, 0, n, 0, 1, e).start(),
                          i
                            .find("span strong")
                            .transition({ opacity: 1 }, 550, "easeInCirc");
                      }, 90 * e),
                      "100" == t && i.find("span strong").addClass("full");
                  }),
                  e.addClass("completed")),
                  t.destroy();
              },
  ...
  function Zt() {
    var e = 1 == U ? "200%" : "75%";
    T(Z + '.wpb_column[data-border-animation="true"]').each(function () {
      var t = T(this),
        a = new Waypoint({
          element: t,
          handler: function () {
            ...
            (0 < t.parents(".wpb_tab").length &&
              ...
              ((e =
                0 < t.attr("data-border-animation-delay").length
                  ? parseInt(t.attr("data-border-animation-delay"))
                  : 0),
              setTimeout(function () {
                t.find(".border-wrap").addClass("animation"),
                  t.find(".border-wrap").addClass("completed");
              }, e)),
              a.destroy();
          },
          offset: e,
          ...
          t = new Waypoint({
            ...
            handler: function () {
              (0 < e.parents(".wpb_tab").length &&
                "hidden" == e.parents(".wpb_tab").css("visibility")) ||
                e.hasClass("completed") ||
                e.find(".nectar_food_menu_item").each(function (e) {
                  var t = T(this);
                  setTimeout(function () {
  ...
  function Gt() {
    ...
    T(
      ...
      var t = T(this).hasClass("divider-small-border") ? 1300 : 1500,
        e = T(this),
        a = new Waypoint({
          element: e,
          handler: function () {
      ...
      function () {
        T(this)
          ...
          .each(function (e) {
            var t = T(this);
            setTimeout(function () {
              t.find(".nectar_hotspot").addClass("pulse");
            }, 300 * e);
          });
      }
    );
    ...
    T(
      ...
      (a[t] = ""),
        ...
        T(this).on("mouseleave", function () {
          var e = T(this);
          e.parent().css({ "z-index": "auto" }),
            (a[t] = setTimeout(function () {
              e.parent().css({ height: "30px", width: "30px" });
            }, 300));
        });
    });
  }
          ...
          690 < te.winW
            ? (0 <
              ...
              T(this)
                ...
                .css("width", "auto"),
              (e = T(this).find(".nttip").offset()).left >
              ...
              e.left < 0
                ...
                : e.left + T(this).find(".nttip").outerWidth(!0) > te.winW
                ? T(this)
                    .find(".nttip")
                    .addClass("force-left")
                    .css("width", "250px")
                : e.top + T(this).find(".nttip").height() + 35 > k.height() &&
                  0 < T("#nectar_fullscreen_rows").length &&
  ...
  function ea() {
    0 != T(".nectar_image_with_hotspots").length &&
      ...
      E.on("click", ".nttip.open", function () {
        if (te.winW < 690)
          return (
            T(this)
              .parents(".nectar_image_with_hotspots")
  ...
  function ta() {
    var a = 1 == U ? "200%" : "50%";
    T(Z + '.nectar_image_with_hotspots[data-animation="true"]').each(
      function () {
        var e = T(this),
          t = new Waypoint({
            element: e,
            handler: function () {
              (0 < e.parents(".wpb_tab").length &&
                ...
                e.hasClass("completed") ||
                (e.addClass("completed"),
                e.find(".nectar_hotspot_wrap").each(function (e) {
                  var t = T(this),
                    a = 0 < t.parents(".col.has-animation").length ? 1 : 0;
                  setTimeout(function () {
                    t.addClass("animated-in");
                  }, 175 * (e + a));
                })),
  ...
  function aa() {
    var e = [].slice.call(z.querySelectorAll("[data-nectar-img-src]")),
      t,
      n;
    "IntersectionObserver" in I
      ? ((t = { rootMargin: "500px" }),
        na(),
        k.off("resize.nectarLazySizing", na),
        k.on("resize.nectarLazySizing", na),
        (n = new IntersectionObserver(function (e) {
          e.forEach(function (e) {
            var t, a, e;
            e.isIntersecting &&
              ((a = (t = e.target).getAttribute("data-nectar-img-src")),
      ...
      : e.forEach(function (e) {
          var t;
          e.classList.contains("nectar-lazy")
            ? ((e.style.height = ""),
              (e.style.width = ""),
              (e.src = e.getAttribute("data-nectar-img-src")),
              (t = e.getAttribute("data-nectar-img-srcset")) &&
                (e.setAttribute("srcset", t),
                e.removeAttribute("data-nectar-img-srcset")))
            : (e.style.backgroundImage =
                "url('" + e.getAttribute("data-nectar-img-src") + "')"),
            e.classList.add("loaded"),
            e.removeAttribute("data-nectar-img-src");
        });
  }
  function na() {
    T("img.nectar-lazy:not(.loaded)").each(function () {
      T(this).css({ height: "", width: "" });
      var e = parseInt(T(this).attr("height")),
        t = parseInt(T(this).attr("width")),
        a = (
          0 < T(this).parents(".nectar_cascading_images").length
            ? T(this).parents(".bg-layer")
            : T(this)
        ).width();
      0 <
        T(this).parents('.img-with-aniamtion-wrap[data-shadow*="depth"]')
          .length && (a = T(this).parents(".img-with-aniamtion-wrap").width());
      var a = We(
        t,
        e,
        (a =
          0 < T(this).parents(".nectar-post-grid-item-bg-wrap-inner").length
            ? T(this).parents(".nectar-post-grid-item-bg-wrap-inner").width()
            : a),
        2e3
      );
      T(this).css({ height: a.height + "px", width: a.width + "px" });
    });
  }
  function ia() {
    (F = []),
  ...
  function oa() {
    var a = 1 == U ? "200%" : "75%";
    T(Z + ".nectar-post-grid-wrap").each(function () {
      var e = T(this),
        t = new Waypoint({
          element: e,
          handler: function () {
            (0 < e.parents(".wpb_tab").length &&
              "hidden" == e.parents(".wpb_tab").css("visibility")) ||
              e.hasClass("completed") ||
              (e.find(".nectar-post-grid-filters").addClass("animated-in"),
              e.find(".nectar-post-grid-item").each(function (e) {
                var t = T(this);
                setTimeout(function () {
                  t.addClass("animated-in");
                }, 90 * e);
  ...
  function la() {
    var a = 1 == U ? "200%" : "bottom-in-view";
    T(Z + ".nectar-animated-title").each(function () {
      var e = T(this),
        t = new Waypoint({
          element: e,
          handler: function () {
  ...
  function da() {
    var r = 1 == U ? "200%" : "bottom-in-view",
      o = "";
    te.usingMobileBrowser && "bottom-in-view" == r && (r = "85%"),
      T(Z + ".nectar-highlighted-text").each(function (e) {
        var t = 0,
          a,
          n;
        T(this).is("[data-animation-delay]") &&
          ...
          "false" != T(this).attr("data-animation") &&
          (t = T(this).attr("data-animation-delay")),
          T(this).is('[data-using-custom-color="true"]') &&
            ((a = T(this).attr("data-color")),
            (n =
              !!(
                T(this).is("[data-color-gradient]") &&
                0 < T(this).attr("data-color-gradient").length
              ) && T(this).attr("data-color-gradient")),
            T(this).addClass("instance-" + e),
            !1 !== n && 0 < n.length
              ? ((o +=
                  ...
                  n +
                  "); }"),
                T(this).is('[data-style="regular_underline"]') &&
                  ((o +=
              ...
              : ((o +=
                ...
                T(this).is('[data-style="regular_underline"]') &&
                  ...
                  (o +=
                    ...
                    a +
                    "; }")))),
          x && T(this).find("em").addClass("animated");
        var i = T(this),
          s = new Waypoint({
            element: i,
            handler: function () {
    ...
    (q = []),
      "undefined" != typeof NectarTestimonialSlider &&
        T(".testimonial_slider").each(function (e) {
          var t = T(this),
            a = T(this).is("[data-style]")
              ? T(this).attr("data-style")
              : "none";
          (q[e] = new NectarTestimonialSlider(t, a, Ca, Wt)),
            T(this).is(
              '.disable-height-animation:not([data-style*="multiple_visible"])'
            ) &&
              (q[e].testimonialSliderHeight(),
              setTimeout(q[e].testimonialSliderHeight.bind(q[e]), 500)),
            T(this).is(
              '.testimonial_slider[data-style="multiple_visible_minimal"]'
            ) &&
              (q[e].testimonialSliderHeightMinimalMult(),
              setTimeout(
                q[e].testimonialSliderHeightMinimalMult.bind(q[e]),
                500
              ));
        });
  }
  function ua() {
    k.off("smartresize.nectarTestimonials"),
      k.off("resize.nectarTestimonialsMin"),
      0 < q.length && k.on("smartresize.nectarTestimonials", pa),
      0 <
        T('.testimonial_slider[data-style="multiple_visible_minimal"]')
          .length && k.on("resize.nectarTestimonialsMin", ga);
  }
  function pa() {
    for (var e = 0; e < q.length; e++)
      q[e].testimonialSliderHeight(), q[e].testimonialHeightResize();
  }
  function ga() {
    for (var e = 0; e < q.length; e++)
      q[e].testimonialSliderHeightMinimalMult();
  ...
  function fa() {
    var a = 1 == U ? "250%" : "75%";
    T(Z + '.nectar-icon-list[data-animate="true"]').each(function () {
      var e = T(this),
        t = new Waypoint({
          element: e,
          handler: function () {
  ...
  function ma(e) {
    var e,
      e =
        0 < e.parents('.wpb_column[data-bg-color*="#"]').length &&
        0 < e.parents('.wpb_column[data-bg-opacity="1"]').length
          ? e.parents(".wpb_column").attr("data-bg-color")
          : ((0 < e.parents(".wpb_row").length &&
              0 <
                e.parents(".wpb_row").find(".row-bg.using-bg-color").length) ||
            (0 < e.parents(".wpb_row").length &&
              0 <
                e.parents(".wpb_row").find(".row-bg.using-bg-color-excluded")
                  .length)
              ? e.parents(".wpb_row").find(".row-bg")
              : 0 < T("#nectar_fullscreen_rows").length
              ? T("#nectar_fullscreen_rows > .wpb_row .full-page-inner-wrap")
              : T(".container-wrap")
  ...
  function ba() {
    ...
    T(
      ...
      T(this).hasClass("nectar-icon-list")
        ? T(this).find(".list-icon-holder").css("background-color", t)
        : (T(this).removeClass(function (e, t) {
            return (t.match(/(^|\s)instance-\S+/g) || []).join(" ");
          }),
          T(this).addClass("instance-" + e),
  ...
  function va() {
    T(".col.span_3, .vc_span3, .vc_col-sm-3").each(function () {
      ...
      T(this).is('[data-t-w-inherits="small_desktop"]') ||
        ((e = T(this)),
        (((t = T(this).next("div")).hasClass("span_3") &&
          !e.hasClass("one-fourths")) ||
          (t.hasClass("vc_span3") && !e.hasClass("one-fourths")) ||
          (t.hasClass("vc_col-sm-3") && !e.hasClass("one-fourths"))) &&
          (e.addClass("one-fourths clear-both"),
          t.addClass("one-fourths right-edge")));
    }),
  ...
  function wa() {
    T("iframe").each(function () {
      ...
      void 0 === T(this).attr("src") ||
        ...
        ((0 <= (e = T(this).attr("src").toLowerCase()).indexOf("youtube") ||
          0 <= e.indexOf("vimeo") ||
          0 <= e.indexOf("twitch.tv") ||
          0 <= e.indexOf("kickstarter") ||
          0 <= e.indexOf("embed-ssl.ted") ||
          0 <= e.indexOf("dailymotion")) &&
          ...
          (T(this).width() < T(this).parent().width()
            ...
            : T(this).attr("data-aspectRatio", "0.56")
          )
            .removeAttr("height")
            .removeAttr("width"),
          0 < T(this).parents(".post-area.masonry.classic").length &&
            T(this)
  ...
  function ya() {
    T("iframe[data-aspectRatio]").each(function () {
      var e = T(this),
        t = e.parent().width();
      (0 < T(this).parents(".swiper-slide").length &&
        !T(this).is(":visible")) ||
  ...
  function Ca() {
    ...
    T(".nectar-video-wrap").each(function () {
      ...
      if (0 != T(this).find("video").length) {
        if (0 < T(this).parents("#page-header-bg").length) {
          if (0 < T(".container-wrap.auto-height").length) return !1;
          (e = T(this).parents("#page-header-bg").outerHeight()),
            (t = T(this).parents("#page-header-bg").outerWidth());
        } else
          t = T(this).hasClass("column-video")
            ? E.is('[data-flex-cols="true"]')
              ? ((e = T(this).parents(".vc_column-inner").outerHeight()),
                T(this).parents(".vc_column-inner").outerWidth())
              : ((e = T(this).parents(".wpb_column").outerHeight()),
                T(this).parents(".wpb_column").outerWidth())
            : ((e = T(this).parents(".wpb_row").outerHeight()),
              0 < T(this).parents(".full-width-section").length
                ? te.winW
                : T(this).parents(".wpb_row").outerWidth());
        T(this).width(t),
          0 < T(this).parents("#page-header-bg").length && T(this).height(e);
        var a = t / i,
          n = (e - e) / s,
          n = n < a ? a : n;
        n * i < (r = (1280 / 720) * (e + 40)) && (n = r / i),
          T(this)
            .find("video, .mejs-overlay, .mejs-poster")
            .width(Math.ceil(n * i + 0)),
          T(this)
            .find("video, .mejs-overlay, .mejs-poster")
            .height(Math.ceil(n * s + 0)),
          T(this).scrollLeft((T(this).find("video").width() - t) / 2),
          T(this).scrollTop((T(this).find("video").height() - e) / 2),
          T(this)
            .find(".mejs-overlay, .mejs-poster")
            .scrollTop((T(this).find("video").height() - e) / 2),
          "center bottom" == T(this).attr("data-bg-alignment") ||
          "bottom" == T(this).attr("data-bg-alignment")
            ? T(this).scrollTop(T(this).find("video").height() - (e + 6))
  ...
  function xa() {
    function i(t, e, a) {
      ...
      new YT.Player(n[0], {
        ...
        events: {
          onReady: function (e) {
            e.target.mute().setLoop(!0), s(t);
          },
        },
      }),
        s(t),
        jQuery(I).on("resize", function () {
          s(t);
        }),
        setTimeout(function () {
          s(t);
    ...
    (0 == T(".nectar-video-wrap").length &&
      ...
      (setTimeout(function () {
        Ca(),
          ...
          T(".nectar-video-wrap").each(function () {
            var e, t, a;
            0 != T(this).find("video").length &&
              ((e = 0 < T(this).parents("#page-header-bg").length),
              (t = T(this)),
              (a = setInterval(function () {
                3 < t.find("video").get(0).readyState &&
                  (te.usingMobileBrowser ||
                    (t.transition({ opacity: "1" }, 400),
                    t.find("video").transition({ opacity: "1" }, 400),
                    t
                      .parent()
              ...
              te.usingMobileBrowser &&
                (0 < t.parents(".full-width-section").length &&
                0 == t.parents("#nectar_fullscreen_rows").length
                  ? t.css("left", "50%")
                  : t.css("left", "0px"),
                1 == e && on(),
                (t.find("video")[0].onplay = function () {
                  t.transition({ opacity: "1" }, 400),
                    t.find("video").transition({ opacity: "1" }, 400),
                    t
                      .parent()
      ...
      T(".vc_row").each(function () {
        var e,
          t,
          a = jQuery(this);
        0 < a.find(".nectar-youtube-bg").length
          ? (t = n((e = a.find(".nectar-youtube-bg span").text()))) &&
            (a.find(".vc_video-bg").remove(),
            i(a.find(".nectar-youtube-bg"), t))
          : a.find(".nectar-youtube-bg").remove(),
          a.find(".nectar-youtube-bg span").remove(),
          te.usingMobileBrowser ||
            a
              .find(".nectar-video-wrap, .nectar-youtube-bg")
              .css({ opacity: "1", width: "100%", height: "100%" }),
          a.find(".video-color-overlay").transition({ opacity: "0.7" }, 400);
      }));
  }
  function ka() {
    E.hasClass("single-post") &&
      0 < T(".content-inner[data-has-gallery]").length &&
      (0 < T(".wp-block-gallery").length
        ? T(".content-inner")
  ...
  function Ta() {
    var e =
      0 < T("#top #mobile-menu").length
        ? "#top #mobile-menu "
        : ".off-canvas-menu-container.mobile-only ";
    T(e + ".megamenu > ul > li > a").each(function () {
      var e;
      ("-" != T(this).text() &&
        "–" != T(this).text() &&
        !T(this).parent().hasClass("hide-title")) ||
        ((e = T(this).parent().find("> ul > li").clone()),
  ...
  function Ia() {
    ...
    0 <
      ...
      (Ha(),
      0 < o.length &&
        ((e = o.detach()), T(".ocm-effect-wrap-inner").append(e))),
      Aa(),
      za(),
      k.on("resize", Ma);
  }
  function za() {
    var e, t, a, n, i;
    (0 < T('body.material[data-header-search="true"]').length ||
      0 < T("body.material .ocm-effect-wrap").length) &&
      ((t = !1),
      (a = 0),
      (n = te.winW),
      (i = te.winH),
      ...
      k.on("resize", function () {
        te.usingMobileBrowser
          ? ((k.width() != n && k.height != i) || 1 === a) &&
            ((n = te.winW), (i = te.winH), (t = !(a = 0)))
          : (t = !0),
          t &&
            (clearTimeout(e),
            T(
  ...
  function Ea() {
    ...
    T("#slide-out-widget-area > .widget").each(function () {
      ...
      (t =
        i.height() - 25 - T(".bottom-meta-wrap").outerHeight(!0) - e >
        T(
  ...
  function Ha() {
    T("#slide-out-widget-area.slide-out-from-right").css({
      "padding-top": 0.1 * k.height(),
      "padding-bottom": 0.1 * k.height(),
    }),
      Fa();
  }
  function Aa() {
    ...
    0 < T("body.material").length &&
      ...
      (0 == T('body[data-slide-out-widget-area-style*="fullscreen"]').length &&
        0 == T("#mobile-menu").length &&
        ((e = T(
          "header#top nav ul .slide-out-widget-area-toggle a > span > i"
        ).clone()).addClass("hover-effect"),
        T("header#top nav ul .slide-out-widget-area-toggle a > span").append(e),
        (e = T(
      ...
      0 < T("body.material #boxed").length &&
        0 <
          T(
      ...
      0 < T("body.material").length &&
        ...
        i.insertAfter(".ocm-effect-wrap"));
  }
  function Ma() {
    0 < T(".ocm-effect-wrap.material-ocm-open").length &&
      (T(".ocm-effect-wrap").css({ height: k.height() }),
      T(".ocm-effect-wrap-inner").css({ "padding-top": te.adminBarHeight }));
  }
  function Oa() {
    var e;
    "separate-dropdown-parent-link" ==
      (0 < T("#slide-out-widget-area[data-dropdown-func]").length
        ? i.attr("data-dropdown-func")
        : "default") &&
      T(
  ...
  function Fa() {
    te.winW < 1e3 ||
    0 < T("body > #boxed").length ||
    0 < T(".ocm-effect-wrap-inner > #boxed").length
      ? (T(
      ...
      i.hasClass("fullscreen-split") ||
        (T('#slide-out-widget-area[class*="fullscreen"] .inner').height() >=
        k.height() - 100
          ? T(
        ...
        T('#slide-out-widget-area[class*="fullscreen"] .inner').transition(
          {
            y:
              "-" +
              T('#slide-out-widget-area[class*="fullscreen"] .inner').height() /
  ...
  function $a() {
    return (
      Ea(),
      te.usingMobileBrowser && 0 < T("#slide-out-widget-area.open").length
        ? (ja(), !1)
        : (te.usingMobileBrowser &&
            T(".slide-out-widget-area-toggle a").attr("aria-expanded", "true"),
          i.css({ transform: "translate3d(0,0,0)" }).addClass("open"),
          0 <
            T("header#top .container .span_9 > .slide-out-widget-area-toggle")
              .length &&
            ((e = T(".slide-out-hover-icon-effect")),
            (t = te.secondaryHeaderHeight),
            0 < T("body.mobile").length
              ? e.css({
                  top:
                    ...
                    ).offset().top - te.scrollTop,
                  right:
                    parseInt(
                      T("#header-outer header > .container").css(
                        "padding-right"
                      )
                    ) + 1,
                })
              : G
              ? ((n =
                  0 < T('#header-outer[data-has-menu="false"]').length ? 2 : 1),
                e.css({
                  top:
                    te.adminBarHeight +
                    t +
              ...
              : 0 <
                T('#header-outer[data-format="centered-menu-bottom-bar"]')
                  .length
              ? ((a =
                  "block" ==
                ...
                e.css({
                  top: parseInt(a.top) - te.scrollTop,
                  right:
                    parseInt(
              ...
              : ((a = (
                ...
                0 < T("#header-secondary-outer.hide-up").length && (t = 0),
                e.css({
                  top: te.adminBarHeight + t + parseInt(a.top),
                  right:
                    parseInt(
                      T("#header-outer header >.container").css("padding-right")
                    ) + 2,
          ...
          0 == T('#header-outer[data-permanent-transparent="1"]').length &&
            ...
            !te.usingFrontEndEditor &&
            1e3 < te.winW &&
            ((0 == te.scrollTop && 0 < T("#header-outer.transparent").length) ||
              (0 == T("body.mobile").length &&
                G &&
                (c
            ...
            0 == T('#header-outer[data-remove-fixed="1"]').length &&
              ...
              G &&
              (1 == b
                ? (k.off("scroll", xn), k.off("scroll", Cn))
                : (k.off("scroll", kn), k.off("scroll", Tn)))),
          !te.usingMobileBrowser && void k.on("mousemove.rightOffsetCheck", Wa))
    );
    var e, t, a, n;
  }
  function Wa(e) {
    var t = k.width(),
      a = i.outerWidth();
    e.clientX < t - parseInt(a) - p &&
      i.hasClass("mouse-accessed") &&
      (i.removeClass("mouse-accessed"),
      k.off("mousemove.rightOffsetCheck", Wa),
      i.css({ transform: "translate3d(101%,0,0)" }).removeClass("open"),
      c.removeClass("style-slide-out-from-right"),
      T(".slide-out-hover-icon-effect .lines-button")
        ...
        0 == T('#header-outer[data-remove-fixed="1"]').length &&
          ...
          (1 == b
            ? (k.off("scroll.headerResizeEffect"),
              0 == te.scrollTop
                ? (k.on("scroll.headerResizeEffect", Cn),
                  0 <
                    T(
                    ...
                    0 < d.length &&
                    1 == G &&
                    0 < T("#header-outer.pseudo-data-transparent").length &&
                    T(
                ...
                : k.on("scroll.headerResizeEffect", xn))
            : (k.off("scroll.headerResizeEffectOpaque"),
              k.on("scroll.headerResizeEffectOpaque", kn)))));
  }
  function ja() {
    te.usingMobileBrowser &&
  ...
  function Ya() {
    var e;
    0 == T("#ajax-content-wrap > .slide-out-widget-area-toggle").length &&
      ((e =
        0 < T('.slide-out-widget-area-toggle[data-custom-color="true"]').length
      ...
      (0 < T('#header-outer[data-has-menu="true"]').length ||
        0 < T('body[data-header-search="true"]').length ||
        0 < T(".slide-out-widget-area-toggle a.using-label").length ||
        0 <
          T('.slide-out-widget-area-toggle[data-custom-color="true"]')
            .length) &&
        T(".slide-out-widget-area-toggle").addClass("small")),
      te.usingMobileBrowser
        ? E.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a", $a)
        : (E.on(
            "mouseenter",
  ...
  function Ba() {
    var e = 0 < d.length && 0 == T("body.mobile").length ? d.height() : 0,
      t,
      e;
    0 == T("body.material").length
      ? (T("#slide-out-widget-area .inner").css({
          height: "auto",
          "min-height": i.height() - 25 - T(".bottom-meta-wrap").height(),
        }),
        0 <
          T(
          ...
          T("#slide-out-widget-area .inner > div:first-of-type").css({
            "margin-top": "50px",
          }),
        0 == T("#boxed").length &&
          (T(
          ...
          (t = Pe()),
          0 ==
            T('#header-outer[data-format="centered-logo-between-menu"]')
              .length || t
            ? 0 == T('#header-outer[data-transparency-option="1"]').length ||
              (0 < T('#header-outer[data-transparency-option="1"]').length &&
                0 == T('#header-outer[data-full-width="true"]').length) ||
              0 < T("body.mobile").length
              ? c
                  .stop(!0)
        ...
        i
          .stop(!0)
          .transition({ x: "-" + e + "px" }, 700, "easeInOutCubic")
          .addClass("open"),
        0 == T("#boxed").length &&
          0 < T('#header-outer[data-full-width="true"]').length &&
          !E.hasClass("mobile") &&
          ...
          0 ==
            ...
            T("header#top #logo")
              .stop(!0)
              .transition({ x: 300 + e + "px" }, 700, "easeInOutCubic"),
          T("header#top .slide-out-widget-area-toggle .lines-button").addClass(
            "close"
          ),
          T("body #header-outer nav > ul > li > a").css({
            "margin-bottom": "0",
          })),
        c.addClass("style-slide-out-from-right"),
        a
        ...
        0 == T('#header-outer[data-format="centered-logo-between-menu"]').length
          ? ((e = (
              0 < T("#logo img:visible").length
                ? T("#logo img:visible")
                : T("#logo")
            ).width()),
            T("header#top nav > .sf-menu").offset().left - e - 300 < 20 &&
              c.addClass("hidden-menu"))
          : c.addClass("hidden-menu-items"),
        0 == T('#header-outer[data-remove-fixed="1"]').length &&
          1e3 < te.winW &&
          (1 == G && 1 == b
            ? (c
              ...
              "true" != c.attr("data-transparent-header") &&
                c
      ...
      : 0 < T("body.material").length &&
        (0 < r.length &&
          0 < T(".ocm-effect-wrap #ajax-loading-screen").length &&
          r.insertBefore(".ocm-effect-wrap"),
        40 < te.scrollTop &&
          T('body[data-hhun="1"] #header-secondary-outer').addClass("hidden"),
        setTimeout(function () {
          T(
            ".slide-out-widget-area-toggle:not(.std-menu) > div > a"
          ).removeClass("animating");
        ...
        0 <
          ...
          (T("#header-outer:not(.fixed-menu)").css(
            "top",
            te.adminBarHeight - te.scrollTop + "px"
          ),
          0 < h.length &&
        ...
        T(".ocm-effect-wrap").css({ height: te.winH }),
        setTimeout(function () {
        ...
        T(
          ...
          transition: "none",
          transform: "translateY(" + te.adminBarHeight + "px)",
        }),
        setTimeout(function () {
  ...
  function qa() {
    ...
    0 == T("body.material").length
      ? (T(
        ...
        0 == T("#boxed").length
          ? ((e =
              0 < T("#header-outer[data-current-row-bg-color]").length
                ? c.attr("data-current-row-bg-color")
                : c.attr("data-user-set-bg")),
            c
              .stop(!0)
              .transition(
                { x: "0px", "background-color": e },
                700,
                "easeInOutCubic"
              ))
          : c.stop(!0).transition({ x: "0px" }, 700, "easeInOutCubic"),
        i
          .stop(!0)
        ...
        a
          ...
          .transition({ opacity: 0 }, 700, "easeInOutCubic", function () {
            T(".slide-out-widget-area-toggle a").removeClass("animating"),
              T(this).css({ height: "1px", width: "1px" }),
              0 == T('#header-outer[data-remove-fixed="1"]').length &&
                (c.hasClass("parallax-contained") &&
                0 < te.scrollTop &&
                0 == T('#header-outer[data-permanent-transparent="1"]').length
                  ? c
                  ...
                  : ((0 == te.scrollTop &&
                      ...
                      0 < T('#page-header-bg[data-parallax="1"]').length) ||
                      (0 == te.scrollTop &&
                        0 < T('body[data-hhun="1"]').length &&
                        0 < T(".parallax_slider_outer").length)) &&
                    (0 <
                      T('#header-outer[data-transparency-option="1"]').length &&
                      c.addClass("transparent"),
                    c.addClass("parallax-contained").removeClass("detached"))),
          ...
          (1 == G && 1 == b && 1e3 < te.winW
            ? (k.off("scroll.headerResizeEffect"),
              0 == te.scrollTop
                ...
                : k.on("scroll.headerResizeEffect", xn),
              c.hasClass("pseudo-data-transparent") &&
                c
                  .attr("data-transparent-header", "false")
                  .removeClass("pseudo-data-transparent")
                  .removeClass("transparent"),
              c.css("transition", "transform"))
            : 1 == G &&
              1e3 < te.winW &&
              (k.off("scroll.headerResizeEffectOpaque"),
              k.on("scroll.headerResizeEffectOpaque", kn),
      ...
      : 0 < T("body.material").length &&
        ...
        setTimeout(function () {
          T(".slide-out-widget-area-toggle a").removeClass("animating"),
            ...
            T(".ocm-effect-wrap-inner").css({ "padding-top": "0" }),
            k.scrollTop(Math.abs(parseInt(T("#ajax-content-wrap").css("top")))),
            T("#ajax-content-wrap").css({ position: "", top: "" }),
            0 <
              T('#header-outer[data-format="centered-menu-bottom-bar"]')
                .length &&
              "none" !=
              ...
              0 == T("body.mobile").length &&
              (T("#header-outer:not(.fixed-menu)").css("top", ""),
              h.css("visibility", "")),
            T(
            ...
            T('body[data-hhun="1"] #header-secondary-outer.hidden').removeClass(
              "hidden"
            );
        }, 900),
        setTimeout(function () {
  ...
  function Pa() {
    0 < T("body.material").length &&
      T("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out");
    var e = 0,
      t = 0;
    te.scrollTop + k.height() > T(".blurred-wrap").height() &&
      0 == T("#nectar_fullscreen_rows").length &&
      (T("body,html")
        .stop()
        .animate(
          { scrollTop: T(".blurred-wrap").height() - k.height() },
          600,
          "easeInOutCubic"
        ),
      (e = 550),
      ...
      0 == T(".nectar-social.fixed").length && li(),
      T(".container-wrap").addClass("no-shadow"),
      c.stop(!0).css("transform", "translateY(0)"),
      setTimeout(function () {
      ...
      setTimeout(function () {
        T("#slide-out-widget-area .off-canvas-social-links").addClass(
          "line-shown"
        ),
          T("#slide-out-widget-area .off-canvas-social-links li").each(
            function (e) {
              T(this)
                .delay(50 * e)
      ...
      setTimeout(function () {
        var e = 0 < T("body.mobile").length ? "easeOutCubic" : "easeInOutQuint";
      ...
      Fa(),
      0 <
        T('.mobile #header-outer[data-permanent-transparent="false"]').length &&
  ...
  function La() {
    0 < T("body.material").length &&
      setTimeout(function () {
        T("header#top .slide-out-widget-area-toggle a").removeClass(
          "menu-push-out"
        );
      }, 350),
      T(
        ".slide-out-widget-area-toggle:not(.std-menu) .lines-button"
      ).removeClass("close"),
      ...
      setTimeout(function () {
        T(".off-canvas-menu-container .menu > li").transition(
          ...
          T("#slide-out-widget-area .off-canvas-social-links").removeClass(
            "line-shown"
          ),
          T("#slide-out-widget-area .bottom-text").transition(
            { opacity: 0 },
          ...
          T("#slide-out-widget-area .menuwrapper .menu li").removeClass(
            "subview subviewopen"
          ),
          T(
      ...
      setTimeout(function () {
        0 == T(".nectar-social.fixed").length && oi(),
          T(".container-wrap").removeClass("no-shadow");
      }, 500),
      a.stop(!0).transition({ opacity: 0 }, 900, "easeOutQuad", function () {
        0 <
          T('.mobile #header-outer[data-permanent-transparent="false"]')
            .length &&
          T(".container-wrap").hasClass("no-scroll") &&
          ...
          T(".slide-out-widget-area-toggle a").removeClass("animating");
        var e = 0.4;
        a.hasClass("solid") && (e = 1),
          a.hasClass("dark") && (e = 0.93),
          a.hasClass("medium") && (e = 0.6),
          a.hasClass("light") && (e = 0.4),
          T(this)
            .css({ height: "1px", width: "1px", opacity: e })
            .transition({ y: "-100%" }, 0);
      });
  }
  function Ra() {
    var e = i.hasClass("fullscreen-alt")
      ? ".fullscreen-alt"
      : ".fullscreen-split";
    0 < T("body.material").length &&
      T("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out"),
      ...
      ".fullscreen-alt" == e
        ...
        : T("#slide-out-widget-area" + e)
            .addClass("open")
            .removeClass("hidden"),
      a.addClass("open").removeClass("hidden"),
      ...
      0 < T("#header-outer.transparent").length &&
        ...
        (T(".admin-bar #slide-out-widget-area-bg" + e).css({
          "padding-top": d.outerHeight(!0) + 32 + "px",
        }),
        T("body:not(.admin-bar) #slide-out-widget-area-bg" + e).css({
          "padding-top": d.outerHeight(!0) + "px",
        })),
      c.stop(!0).css("transform", "translateY(0)"),
      0 < T("#logo .starting-logo").length &&
        1e3 < k.width() &&
        0 ==
          T('#header-outer[data-format="centered-menu-bottom-bar"].fixed-menu')
            .length &&
        0 == T('body.material #header-outer[data-condense="true"]').length &&
        !te.usingFrontEndEditor &&
        (c.stop(!0).css("transform", "translateY(0)").addClass("transparent"),
        "true" != c.attr("data-transparent-header") &&
          c
            .attr("data-transparent-header", "true")
            .addClass("pseudo-data-transparent")),
      ...
      ".fullscreen-alt" == e &&
        (setTimeout(function () {
          T(".off-canvas-menu-container .menu > li").each(function (e) {
            ...
            T("#slide-out-widget-area.fullscreen-alt .widget").each(function (
              e
            ) {
              T(this)
                .delay(100 * e)
        ...
        setTimeout(function () {
          T("#slide-out-widget-area .off-canvas-social-links").addClass(
            ...
            T("#slide-out-widget-area .off-canvas-social-links li")
              .css("opacity", "1")
              .each(function (e) {
                T(this)
                  .delay(50 * e)
    ...
    var t = 0.4;
    a.hasClass("solid") && (t = 1),
      a.hasClass("dark") && (t = 0.97),
      a.hasClass("medium") && (t = 0.6),
      a.hasClass("light") && (t = 0.4),
      a.removeClass("no-transition"),
      ".fullscreen-alt" == e &&
        (a
          .addClass("padding-removed")
          .css({ height: "100%", width: "100%", left: "0", opacity: t }),
        Fa()),
      setTimeout(function () {
  ...
  function Na() {
    ...
    0 < T("body.material").length &&
      ...
      ".fullscreen-split" == e &&
        setTimeout(function () {
          a.addClass("hidden"),
            T("#slide-out-widget-area" + e).addClass("hidden");
        }, 600),
      ".fullscreen-alt" == e &&
        (T(".blurred-wrap").removeClass("blurred"),
      ...
      setTimeout(function () {
        ".fullscreen-alt" == e &&
          ...
          a.css({ height: "1px", width: "1px", left: "-100%" })),
          0 <
            T('.mobile #header-outer[data-permanent-transparent="false"]')
              .length &&
            T(".container-wrap").hasClass("no-scroll") &&
      ...
      ".fullscreen-split" == e &&
        T("#slide-out-widget-area" + e).removeClass("open"),
      setTimeout(function () {
        0 == T(".nectar-social.fixed").length && oi();
      }, 600),
      setTimeout(function () {
        a.removeClass("padding-removed");
      }, 50),
      setTimeout(
        function () {
          ".fullscreen-alt" == e && a.stop(!0).css({ opacity: 0 }),
            0 < T('#header-outer[data-transparent-header="true"]').length &&
              T('body > div[class*="body-border"]').css("z-index", "10000");
        },
        1 == G ? 150 : 50
      ),
      setTimeout(function () {
  ...
  function Da() {
    0 != T("#header-outer #mobile-menu").length &&
      (T("#header-outer #mobile-menu li.megamenu").removeClass("megamenu"),
      T("#header-outer #mobile-menu ul li").each(function () {
        T(this).find("a").wrapInner("<span></span>"),
          0 < T(this).find("> ul").length &&
            T(this)
              .find("> a")
              .append(
      ...
      T("#header-outer #mobile-menu .sf-sub-indicator").on(
        "click",
        function () {
      ...
      k.on("smartresize", function () {
        1e3 < te.winW &&
          0 < T(".slide-out-widget-area-toggle.mobile-icon a.open").length &&
          (T(".slide-out-widget-area-toggle.mobile-icon a")
            .addClass("non-human-allowed")
            .trigger("click"),
          setTimeout(function () {
            T(".slide-out-widget-area-toggle.mobile-icon a").removeClass(
              "non-human-allowed"
            );
          }, 100));
      }));
  ...
  function Qa() {
    E.on(
      ...
      function () {
        return (
          "true" == J.animating ||
            0 < T(".slide-out-from-right-hover").length ||
            (c.removeClass("no-transition"),
            i.hasClass("slide-out-from-right")
              ? Ba()
              : i.hasClass("fullscreen")
              ? Pa()
              : i.hasClass("fullscreen-alt") || i.hasClass("fullscreen-split")
              ? Ra()
              : 0 < T("#header-outer #mobile-menu").length && Va(),
            0 == T("#header-outer #mobile-menu").length &&
              (c.removeClass("side-widget-closed").addClass("side-widget-open"),
              0 < T('#header-outer[data-transparency-option="1"]').length &&
                0 == T("#boxed").length &&
                0 < T('#header-outer[data-full-width="true"]').length &&
                !te.usingFrontEndEditor &&
                ...
                0 ==
                  T('body.material #header-outer[data-condense="true"]')
                    .length &&
                c.addClass("transparent"),
              0 < T("#header-outer.dark-slide.transparent").length &&
                0 == T("#boxed").length &&
                0 == T("body.material-ocm-open").length &&
                c
                  .removeClass("dark-slide")
                  .addClass("temp-removed-dark-slide")),
            T(".slide-out-widget-area-toggle > div > a")
              .removeClass("closed")
              .addClass("open")
              .attr("aria-expanded", "true"),
            T(".slide-out-widget-area-toggle > div > a").addClass("animating")),
          !1
        );
      }
    ),
        ...
        function (e) {
          if (
            ...
            return (
              ...
              T(".slide-out-widget-area-toggle:not(.std-menu) a").addClass(
                "animating"
              ),
              i.hasClass("slide-out-from-right")
                ? qa()
                ...
                : i.hasClass("fullscreen-alt") || i.hasClass("fullscreen-split")
                ? Na()
                : 0 < T("#header-outer #mobile-menu").length && Xa(),
              0 == T("#header-outer #mobile-menu").length &&
                (0 <
                  ...
                  c
                    ...
                    .addClass("dark-slide"),
                0 ==
                  T('#header-outer[data-permanent-transparent="1"]').length &&
                  ...
                  (0 == T(".nectar-box-roll").length
                    ? (0 < T("#header-outer.small-nav").length ||
                      ...
                      c.removeClass("transparent")
                    : (0 < T("#header-outer.small-nav").length ||
                        0 < T("#header-outer.scrolled-down").length ||
                        0 < T(".container-wrap.auto-height").length) &&
                      c.removeClass("transparent")),
                c.removeClass("hidden-menu"),
                c
  ...
  function Za() {
    0 < T("#slide-out-widget-area.slide-out-from-right-hover").length
      ? Ya()
      : (Qa(), Da()),
      ...
      0 ==
        ...
        : 0 <
          ...
          T(
            ...
            "#" != T(this).attr("href") && Ga(T(this).parent());
          }),
      0 < T("#nectar_fullscreen_rows").length &&
        0 < T('body[data-slide-out-widget-area-style*="fullscreen"]').length &&
        T(
      ...
      setTimeout(Ua, 500),
      te.usingMobileBrowser && i.addClass("mobile");
  }
  function Ua() {
  ...
  function Ga(e) {
    var t, a;
    0 < T("#slide-out-widget-area.open").length &&
      (I.location.href.split("#")[0] ==
        e.find("> a").attr("href").split("#")[0] ||
        0 < e.find('a[href^="#"]').length) &&
      (0 < e.parents(".slide-out-from-right-hover").length
        ? T(".slide-out-widget-area-toggle.slide-out-hover-icon-effect a")
  ...
  function Ja() {
    ...
    (0 < !T('#header-outer[data-format="left-header"]').length &&
      ...
      T(
        ...
        var e, t;
        return (
          T(this).parent().hasClass("open-submenu")
            ? (T(this).parent().find(".sub-menu").css({ "max-height": "0" }),
              T(this).parent().removeClass("open-submenu"))
            : ((e = T(this)).parent().find("> .sub-menu").addClass("no-trans"),
              setTimeout(function () {
                e
                  .parent()
                  .find("> .sub-menu")
                  ...
                  (t = e.parent().find("> .sub-menu").height()),
                  e.parent().find("> .sub-menu").removeClass("no-trans"),
                  e
                    .parent()
                    .find("> .sub-menu")
                    .css({
              ...
              setTimeout(function () {
                e
                  ...
                  e
                    ...
                    .css({ "max-height": "0" }),
                  e.parent().addClass("open-submenu"),
                  e.parent().find("> .sub-menu").css("max-height", t),
                  0 < e.parents("ul").length &&
                    e.parents("ul:not(.sf-menu)").each(function () {
  ...
  (st.prototype.domSetup = function () {
    var a = this,
      n = "";
    this.$el.find(".wpb_tab").each(function (e) {
      var t;
      T(this).is("[data-tab-icon]") &&
        0 < T(this).attr("data-tab-icon").length &&
        ...
        (n = a.$el
          ...
          .attr("href")),
        a.$el
          .find(".wpb_tabs_nav li:nth-child(" + (e + 1) + ")")
          .addClass("has-icon")
          .prepend(
        ...
        0 < T(this).find(".im-icon-wrap.tab-icon").length &&
          ...
          a.$el
            ...
            .addClass("has-icon")
            .prepend(
              '<a class="skip-hash svg-icon-link" href="' + n + '"></a>'
            ),
          a.$el
            .find(".wpb_tabs_nav li:nth-child(" + (e + 1) + ") .svg-icon-link")
            .append(t));
    }),
    ...
    this.$el.find(".scrolling-tab-nav .menu-item").each(function (e) {
      var t = i.find("> div:nth-child(" + (e += 1) + ")"),
        e = T(this).html(),
        e,
        e;
      t.prepend(
        ...
        t.find(".scrolling-tab-mobile-title a").contents().unwrap(),
        t &&
          ((e = (e = T(this).find("a").attr("href")).substr(1)),
          t.find("> .scrolling-tab-mobile-title").attr("id", e),
          t.removeAttr("id"));
    });
  }),
    (st.prototype.highlightObserve = function () {
      var a = this,
        e;
      (te.usingMobileBrowser && te.winW < 1e3) ||
        ("IntersectionObserver" in I &&
          ((this.observer = new IntersectionObserver(
            function (e) {
              e.forEach(function (e) {
                var t = "#" + T(e.target).attr("id"),
                  t = a.$el.find('.scrolling-tab-nav a[href="' + t + '"]');
                e.isIntersecting && 1 <= e.intersectionRatio
                  ? t.parents(".menu-item").addClass("visible")
                  : t.parents(".menu-item").removeClass("visible");
                var t = a.$el.find(
          ...
          this.$tabContent
            ...
            .each(function () {
              a.observer.observe(T(this)[0]);
            })));
    }),
    (st.prototype.lineAnimation = function () {
      var e = this.$el.find(".scrolling-tab-nav .active"),
        t,
        e;
      0 != e.length &&
        ((t = parseInt(e.position().top)),
        (e = parseInt(e.height())),
        this.$lineEl.css({
          "max-height": e + "px",
    ...
    (T.fn.parallaxScroll = function (e, t, a) {
      var n = te.winW,
        i = te.winH,
        s = 0,
        r = T(this),
      ...
      (arguments.length < 1 || null === e) && (e = "50%"),
        (arguments.length < 2 || null === t) && (t = 0.25),
      ...
      r
        ...
        setInterval(function () {
          (p = l(u)),
            (c = 0 < T("body.classic_mobile_menu_open.mobile").length);
        }, 600),
        ((0 < u.parents(".top-level").length &&
          0 < u.parents(".parallax_slider_outer").length) ||
          (0 < u.parents(".top-level").length &&
            u.is(".nectar-recent-posts-single_featured")) ||
          u.is(".wpb_row.top-level") ||
          0 == T(".wpb_row").length) &&
          (h = !0),
        ((0 == T(".wpb_row").length &&
          0 < u.parents(".parallax_slider_outer").length &&
          u.is('[data-full-width="true"]')) ||
          (0 < T("#portfolio-extra").length &&
            0 < u.parents(".parallax_slider_outer").length &&
            0 < u.parents(".wpb_row").length &&
            "0" == u.parents(".wpb_row").index())) &&
          (h = !0),
        te.usingFrontEndEditor && (h = !1);
      var g = r.is(".nectar-slider-wrap"),
        f = 0 < r.find(".page-header-bg-image").length,
        m = !1;
      function b() {
        (o = u.offset().top),
          0 == m ||
            o + p < te.scrollTop ||
            o > te.scrollTop + te.winH ||
            0 < T("body.material-ocm-open").length ||
            (g
              ? h
                ? c ||
      ...
      g
        ? (0 < r.find(".video-wrap").length ||
            0 < r.find(".image-bg").length) &&
          (m = r.find(".video-wrap, .image-bg"))
        : 0 < r.find(".row-bg.using-image").length
        ? (m = r.find(".row-bg.using-image"))
        : 0 < r.find(".page-header-bg-image").length &&
          (m = r.find(".page-header-bg-image")),
        I.addEventListener &&
          ((!te.usingFrontEndEditor && te.usingMobileBrowser) ||
            k.on("resize", function () {
              (n = te.winW), (i = te.winH);
            }),
          te.usingFrontEndEditor
            ? k.on("scroll.parallaxSections", b)
            : te.usingMobileBrowser
            ? (requestAnimationFrame(b),
              ...
              k.on("resize", function () {
                ((k.width() != n && k.height != i) || 1 == s) &&
                  ((n = te.winW), (i = te.winH), (s = 0));
              }))
            : I.addEventListener(
                "scroll",
                function () {
        ...
        k.on("resize.parallaxSections", b),
        b();
    }),
    (Xt.prototype.calculatePos = function () {
      (this.offsetTop = this.$element.offset().top),
        (this.height = this.$element.outerHeight()),
        (this.vertCenter = te.winH / 2 - this.height / 2);
    }),
    (Xt.prototype.trackView = function () {
      var t = this,
        e,
        a;
    ...
    (Xt.prototype.animate = function () {
      var a;
      this.inView &&
        (((a = this).lastY = $e(this.lastY, te.scrollTop, 0.18)),
        this.$element.find(".bg-layer").each(function (e) {
          var t = T(this).attr("data-scale");
          a.layer1Parallax && (e = e / 1.5 + 1),
            !0 === a.topLevel && 1e3 < te.winW
              ? T(this).css(
                  "transform",
                  "translateY(" +
              ...
              : T(this).css(
                  "transform",
                  "translateY(" +
                    -((a.lastY - a.offsetTop + a.vertCenter) * a.intensity) *
                      e +
                    "px) translateZ(0) scale(" +
                    t +
                    ")"
        ...
        I.requestAnimationFrame(this.animate.bind(this));
    }),
    (ra.prototype.initialMarkup = function () {
    ...
    (ra.prototype.clickEvents = function () {
      ...
      this.el
        ...
        .on("click", function () {
          var t = T(this);
          if (
            0 < t.parents(".nectar-post-grid-wrap.loading").length ||
            T(this).hasClass("active")
          )
            return !1;
          0 < T(this).parents(".nectar-post-grid-filters").length
            ? (t.parent().find("a").removeClass("active"),
              t.addClass("active"),
              (l.currentPage = 0),
              (l.activeFilter = t.index() + 1))
            : l.currentPage++;
          var a = t.parents(".nectar-post-grid-wrap").find(".nectar-post-grid"),
            n = r.pagination,
            i =
              t.hasClass("load-more") && "load-more" === n
                ? "load-more"
                : "filter",
            e = "",
            s,
            e =
              "yes" === l.sortable
                ...
                : ((s =
                  ...
                  t
                    .parents(".nectar-post-grid-wrap")
                    .find(".nectar-post-grid-filters a" + s)
                    .each(function () {
                      e += T(this).attr("data-filter") + ", ";
                    }),
            ...
            s = {
              ...
              settings: {
                ...
                aspect_ratio_image_size: r.aspect_ratio_image_size,
                card_bg_color: r.card_bg_color,
                display_categories: r.display_categories,
                display_excerpt: r.display_excerpt,
                display_date: r.display_date,
                color_overlay: r.color_overlay,
                color_overlay_opacity: r.color_overlay_opacity,
                color_overlay_hover_opacity: r.color_overlay_hover_opacity,
                grid_style: r.grid_style,
                heading_tag: r.heading_tag,
                post_title_overlay: r.post_title_overlay,
              },
            };
          return (
            t.parents(".nectar-post-grid-wrap").addClass("loading"),
            T.post(I.nectarLove.ajaxurl, s, function (e) {
              "load-more" == i ? a.append(e) : a.html(e),
                a.is('[data-animation="fade-in-from-bottom"]') &&
                  (t
                    .parents(".nectar-post-grid-wrap")
                  ...
                  setTimeout(function () {
                    t.parents(".nectar-post-grid-wrap").addClass(
                      "finished-animating"
                    );
                  }, 950)),
                "load-more" === n &&
                  ((l.activeCatTotal = parseInt(
                    l.el
                      .find(
                        ".nectar-post-grid-filters a:nth-child(" +
                          l.activeFilter +
                  ...
                  a.find(".nectar-post-grid-item").length >= l.activeCatTotal
                    ? l.el.find(".load-more-wrap").addClass("inactive")
                    : l.el.find(".load-more-wrap").removeClass("inactive")),
                t.parents(".nectar-post-grid-wrap").removeClass("loading"),
                k.trigger("resize"),
                ia();
            }),
            !1
    ...
    (T.DLMenu = function (e, t) {
      (this.$el = T(t)), this._init(e);
    }),
    (T.DLMenu.defaults = {
      animationClasses: {
    ...
    (T.DLMenu.prototype = {
      ...
      _initEvents: function () {
        ...
        this.$trigger.on("click.menu", function () {
          ...
          this.$menuitems.on("click.menu", function (e) {
            var t = T(this).parent("li"),
              a = t.children("ul.sub-menu");
            if (
              (T(
                ...
                setTimeout(function () {
                  n.addClass(s.options.animationClasses.classin),
                    ...
                    s.supportAnimations
                      ...
                      : i.call(),
                    s.options.onLevelClick(t, t.children("a:first").text());
                }),
                t
            ...
            s.options.onLinkClick(t.find("> a"), e), Ga(t);
          }),
          this.$back.on("click.menu", function () {
            var t = T(this),
              e = t.parents("ul.sub-menu:first"),
              a = e.parent(),
              n = e.clone().insertAfter(s.$menu),
              i = function () {
                s.$menu
                  .off(s.animEndEventName)
            ...
            return (
              setTimeout(function () {
                ...
                var e = t.parents(".subview:first");
                e.is("li") && e.addClass("subviewopen"),
                  e.removeClass("subview");
              }),
              a
                .parents(".off-canvas-menu-container")
                .css(
              ...
              setTimeout(function () {
                a.parents(".off-canvas-menu-container").transition(
  ...
  function en() {
    T("#slide-out-widget-area .off-canvas-menu-container .menu").wrap(
      ...
      T("#slide-out-widget-area .off-canvas-menu-container .menu").addClass(
        "menuopen"
      );
    var e = 0 < T("#slide-out-widget-area.fullscreen-alt").length ? "4" : "5";
  ...
  function an() {
    0 < T('#header-outer[data-transparent-header="true"]').length
      ? T('#page-header-bg[data-parallax="1"]').css({ top: te.adminBarHeight })
      : 0 == T('body[data-header-resize="0"]').length &&
        0 == T("body.material").length &&
        T('#page-header-bg[data-parallax="1"]').css({
          top: T("#page-header-wrap").offset().top + "px",
        }),
      0 != T("#ajax-content-wrap").length && E.hasClass("ajax-loaded")
  ...
  function sn() {
    ...
    0 < T('#page-header-bg[data-parallax="1"]').length &&
      ...
      0 < T('body[data-hhun="1"]').length &&
        0 < !T('#header-outer[data-remove-fixed="1"]').length &&
        c.addClass("parallax-contained"),
      I.addEventListener(
        "scroll",
        function () {
          1e3 < te.winW && I.requestAnimationFrame(a);
        },
        !1
      ));
    var e =
        0 < T('body[data-ajax-transitions="true"]').length &&
        0 < T('#page-header-bg[data-animate-in-effect="slide-down"]').length
          ? 350
          : 0,
      e;
    function a() {
      ...
      E.hasClass("mobile") ||
        ...
        ("left-header" != w &&
          (1e3 < te.winW
            ? T("#page-header-bg").css(
                "top",
                T("#ajax-content-wrap").offset().top
              )
            : T("#page-header-bg").css("top", "0")),
        0 == T("#page-header-bg.out-of-sight").length &&
          (n
            ? (s.css({ transform: "translateY(" + -0.55 * e + "px)" }),
              T(
              ...
              ).css({ transform: "translateY(" + -0.45 * e + "px)" }))
            : (s.css({ transform: "translateY(" + -0.4 * e + "px)" }),
              T(
              ...
              ).css({ transform: "translateY(" + e * -a + "px)" }),
              T(
                '#page-header-bg .span_6 .inner-wrap,  #page-header-bg[data-post-hs="default_minimal"] .author-section'
              ).css({ opacity: 1 - e / (i - 60) })),
          0 == T("#page-header-bg .span_6 .inner-wrap").css("opacity")
            ? T(
        ...
        1 < e / (i + T("#header-space").height() + te.adminBarHeight)
          ...
          : (T("#page-header-bg, .nectar-particles, #page-header-bg .fade-out")
            ...
            (i = parseInt(s.height())),
            T("#page-header-bg .container > .row").css("top", 0)));
    }
    0 < s.length &&
      (setTimeout(function () {
        tn();
      ...
      (e = Le(s.css("background-image"))) &&
        -1 !== e.indexOf(".") &&
        s.addClass("has-bg"),
      k.on("smartresize", tn)),
      0 < s.length && (nn(), 0 == T(".nectar-box-roll").length && ln());
  }
  function rn() {
    s.each(function () {
      var e, t;
      "rotate_in" != T(this).attr("data-text-effect") ||
        ((e = "none") !=
          (e = 0 < T(this).find(".span_6 h1").length ? "h1" : e) &&
          ((t =
            0 < T(this).find(".nectar-particles").length
              ? ".inner-wrap.shape-1"
              : ".span_6"),
          T(this)
            .find(t)
          ...
          T(this)
            ...
            .each(function () {
              ...
              T.each(t, function (e, t) {
                t.replace(/\s+/, "") &&
                  (a += '<span class="wraped"><span>' + t + "</span></span> ");
              }),
                e.replaceWith(T(a));
            })));
    });
                  ...
                  ((e =
                    "down" == e
                      ? "light" == n.attr("data-midnight")
                        ...
                        : "dark-slide"
                      : "light" ==
                        i[(t = 0 <= a - 1 ? a - 1 : a)].attr("data-midnight")
                      ? ""
                      : "dark-slide"),
                  c.removeClass("dark-slide").addClass(e));
              },
              offset: c.height(),
            })));
        }));
  ...
  function cn() {
    0 < T(".nectar-box-roll").length &&
      ...
      (ln(), (J = new NectarBoxRoll(te, hn, dn, hi, Ca)));
  }
  function hn() {
    Pt(),
      Lt(),
  ...
  function pn() {
    jQuery(z.body).on("updated_cart_totals", function () {
      0 == T(".plus").length &&
        T("div.quantity:not(.buttons_added), td.quantity:not(.buttons_added)")
      ...
      0 == T(".plus").length &&
        (T("div.quantity:not(.buttons_added), td.quantity:not(.buttons_added)")
          ...
          .append('<input type="button" value="+" class="plus" />')
          .prepend('<input type="button" value="-" class="minus" />'),
        T(z).on("click", ".plus, .minus", function () {
          ...
          (t && "" !== t && "NaN" !== t) || (t = 0),
            ...
            T(this).is(".plus")
              ? a && (a == t || a < t)
                ? e.val(a)
                : e.val(t + parseFloat(i))
              : n && (n == t || t < n)
              ? e.val(n)
              : 0 < t && e.val(t - parseFloat(i)),
            e.trigger("change");
        }));
  }
  function gn() {
    ...
    E.on("click", ".product .add_to_cart_button", function () {
      var e = 0 < T(this).parents("li").find("h2").length ? "h2" : "h3",
        e = T(this).parents("li").find(e).text();
      T("#header-outer .cart-notification span.item-name").html(e);
    }),
    ...
    var e = "#header-outer .nectar-woo-cart",
      a;
    function n() {
      !T(
        ...
        !T(
          ...
          0 <
            T(".widget_shopping_cart .widget_shopping_cart_content .cart_list")
              .length &&
          void 0 !== e.type &&
          ((0 < T("#header-outer .cart-notification .item-name").length &&
            0 ==
    ...
    function o() {
      T(
        ...
        var e, t;
        0 == T(this).find("> img").length &&
          0 == T(this).find(".product-meta").length &&
          ((e =
            0 < T(this).find("> a[href]:not(.remove)").length
              ? T(this).find("> a[href]:not(.remove)").attr("href")
              : ""),
          (t = T(this).find("> a > img").clone()),
          T(this).wrapInner('<div class="product-meta" />'),
          T(this).prepend(t),
          0 < e.length && t.wrap('<a href="' + e + '"></a>'));
      });
    }
    function l() {
      0 != T("body.woocommerce-account #customer_login").length &&
          ...
          T('#customer_login div[class*="u-column"]').hide(),
            ...
            setTimeout(function () {
              T('#customer_login div[class*="u-column"]').removeClass(
                ...
                T('#customer_login div[class*="u-column"].col-' + e).addClass(
                  "visible"
                );
            }, 30);
        }),
    ...
    function c(e) {
      var t = e,
        ...
        e = (parseInt(e) + 40) / parseInt(e);
      t.addClass("hover-bound"),
        t
          .find(".background-color-expand")
          .css({ transform: "scale(" + a + "," + e + ") translateY(0px)" });
    }
    function h() {
      0 < T(".nectar-slide-in-cart ul.cart_list li:not(.empty)").length &&
        (T(".nectar-slide-in-cart").addClass("open"),
        k.on("mousemove.rightCartOffsetCheck", u));
    }
    function u(e) {
      var t = k.width();
      e.clientX < t - 370 - p &&
        (k.off("mousemove.rightCartOffsetCheck", u),
        T(".nectar-slide-in-cart").removeClass("open"));
    }
    0 < T(e).length &&
      T(e).hoverIntent(function () {
        T("#header-outer .widget_shopping_cart")
          .addClass("open")
          .stop(!0, !0)
          .show(),
      ...
      0 == T('#header-outer[data-cart="false"]').length &&
        (E.on("added_to_cart", i),
        E.on("added_to_cart", n),
        E.on("removed_from_cart", o)),
      0 == T('#header-outer[data-cart="false"]').length && r(),
      l(),
      E.on(
        "mouseover",
      ...
      (0 < T(".material.product").length ||
        0 < T(".minimal.product").length ||
        0 < T('.nectar-fancy-box[data-style="parallax_hover"]').length ||
        0 < T('.nectar-category-grid[data-shadow-hover="yes"]').length ||
        0 < T('.nectar-post-grid[data-shadow-hover="yes"]').length) &&
        ((a = 101),
        E.on(
          "mouseenter",
        ...
        setInterval(function () {
          0 <
            ...
            0 < T(".minimal.product:hover").length ||
            (T(
  ...
  function fn() {
    var e =
      0 < T("#search-outer #search input[type=text][data-placeholder]").length
        ? T("#search-outer #search input[type=text]").attr("data-placeholder")
        : "";
    function t() {
      E.hasClass("ascend") ||
      (0 < T('body[data-header-format="left-header"]').length &&
    ...
    E.hasClass("material") &&
        ...
        function () {
          return (
            T(this).hasClass("open-search") ||
              (E.hasClass("original") &&
                0 <
                  T(".slide-out-widget-area-toggle.mobile-icon a.open")
                    .length &&
                (T(".slide-out-widget-area-toggle.mobile-icon a")
                  .addClass("non-human-allowed")
                  .trigger("click"),
      ...
      T("body:not(.material)").on(
        ...
        function () {
          0 == T(this).val().length &&
            (T(this).val(e), T(this).setCursorPosition(0));
        }
      ),
      E.on("click", "#close", function () {
        return (
          t(),
          n.removeClass("open-search"),
  ...
  function mn() {
    var n = c,
      ...
      t = h,
      s = e.find("nav >ul.buttons"),
      r = parseInt(T("body.material #header-outer").attr("data-padding")),
      e = parseInt(T("body.material #header-outer").attr("data-logo-height")),
      o =
        2 * r +
        e -
        parseInt(te.adminBarHeight) +
        parseInt(te.secondaryHeaderHeight);
    function a() {
      var e;
      Pe()
        ? c.addClass("within-custom-breakpoint")
        : c.removeClass("within-custom-breakpoint");
    }
    function l() {
      var e, t, a, e;
      te.winW < 1e3 ||
        ...
        ((d = 0 < d.length && 0 < te.secondaryHeaderHeight ? d.height() : 0),
        n.hasClass("force-condense") ||
        (!n.hasClass("fixed-menu") && te.scrollTop >= o)
          ? ((e =
              ...
              d),
            0 < T('#header-outer[data-megamenu-rt="1"]').length &&
              0 < T("#header-outer .megamenu").length &&
              0 < T('#header-outer[data-transparent-header="true"]').length &&
              c.removeClass("no-transition"),
            n
              .addClass("fixed-menu")
              .removeClass("transparent")
              .css({ top: "-" + e + "px", position: "fixed" }),
            (t = T("header#top .span_9 nav >ul").offset().top),
            (a = s.offset().top),
            (e =
              0 < i.find(".sf-menu > li > a").length
                ? (20 - parseInt(i.find(".sf-menu > li > a").height())) / 2
                : 2),
            s.css(
              "transform",
              "translateY(" + (parseInt(t) - parseInt(a) - e - 1) + "px)"
            ),
            s
          ...
          : (n.hasClass("force-condense-remove") ||
            ...
            s.find(".nectar-woo-cart").css("height", ""),
            0 == T("#header-outer.transparent").length &&
              (0 < T('#header-outer[data-megamenu-rt="1"]').length &&
                0 < T("#header-outer .megamenu").length &&
                c.removeClass("no-transition"),
              ...
              0 < T("#header-outer .megamenu").length
                ? "true" == c.attr("data-transparent-header") &&
                  0 == T(".nectar-box-roll").length &&
                  0 == T(".megamenu.sfHover").length
                  ? (c.addClass("transparent"), c.removeClass("no-transition"))
                  : "true" == c.attr("data-transparent-header") &&
                    0 == T(".nectar-box-roll").length &&
                    0 < T(".megamenu.sfHover").length &&
    ...
    0 < t.length &&
      ...
      setTimeout(function () {
        "none" != h.css("display") &&
          (te.secondaryHeaderHeight = h.outerHeight());
      }, 50),
      0 < T('#header-outer[data-condense="true"]').length &&
        (k.on("scroll.centeredNavCondense", l),
        k.trigger("scroll"),
        k.on("resize", function () {
          te.winW < 1e3 &&
            (n.addClass("force-condense-remove"),
            k.off("scroll.centeredNavCondense"));
        }),
        k.smartresize(function () {
          a(),
            1e3 <= te.winW &&
              n.hasClass("force-condense-remove") &&
              (l(),
  ...
  function vn() {
    ...
    1e3 < te.winW
      ? ((t = T(
        ...
        0 < T("#header-outer #social-in-menu").length && t--,
        (e =
        ...
        (a =
          0 < T('#header-outer[data-lhe="animated_underline"]').length
            ? parseInt(
        ...
        i < n || (E.hasClass("rtl") && n < i)
          ? T("#header-outer #top .row > .col.span_9").css("padding-right", a)
          : T("#header-outer #top .row > .col.span_9").css("padding-left", a),
      ...
      (t
        ? t &&
          0 <
            T('#header-outer[data-format="centered-logo-between-menu"]')
              .length &&
          0 < T("header#top #logo img:first[src]").length &&
          (((e = new Image()).src = T("header#top #logo img:first").attr(
            "src"
          )),
          (e.onload = function () {
            vn();
  ...
  function yn() {
    te.usingMobileBrowser &&
      ...
      E.attr("data-hhun", "0"),
      0 < T("#nectar_fullscreen_rows").length &&
        c.attr("data-permanent-transparent", "false"),
      te.usingMobileBrowser &&
        0 < T('#header-outer[data-mobile-fixed="1"]').length &&
        0 == T('#header-outer[data-transparent-header="true"]').length &&
        T("#header-space").css("height", c.outerHeight());
  }
  function _n() {
    var n = 0,
      i = 250,
    ...
    function r() {
      ...
      var e = te.scrollTop,
        ...
        t;
      if (
        ((0 < T("body.animated-scrolling").length &&
          0 < T("#header-outer.detached").length) ||
          0 < T("body.no-scroll").length) &&
        999 < te.winW
      )
        return (
          i < e && ((n = te.scrollTop), (e = te.scrollTop)),
      ...
      999 < te.winW
        ...
        : 0 < T('#header-outer[data-mobile-fixed="false"]').length &&
          0 < T("body.mobile").length
        ? c.removeClass("detached")
        : (c.hasClass("side-widget-open") ||
            T("#header-outer .slide-out-widget-area-toggle a").hasClass(
              "animating"
            ) ||
            (1 < e &&
              (0 == T('#header-outer[data-permanent-transparent="1"]').length &&
                (c.removeClass("transparent"), c.addClass("scrolling")),
              0 < h.length &&
                (i < e
                  ? (h.addClass("hide-up"),
                    c.css(
                      "transform",
                      "translateY(-" + te.secondaryHeaderHeight + "px)"
                    ))
                  : (h.removeClass("hide-up"), c.css("transform", "0px)")))),
            i < e
              ? (c.hasClass("detached") ||
                  c.addClass("detached").removeClass("parallax-contained"),
                c.removeClass("no-transition"),
                s <= t &&
                  (n < e
                    ? (c.hasClass("invisible") ||
                        (c.addClass("invisible").removeClass("at-top"),
                        0 < T(".sf-menu").length &&
                          T().superfish &&
                    ...
                    : (c.hasClass("invisible") && c.removeClass("invisible"),
                      (a = c.outerHeight()),
                      0 < h.length && (a -= te.secondaryHeaderHeight),
                      0 < d.length && 0 == T("body.mobile").length
                        ? ((ee = G ? d.height() : 0),
                          T(".page-submenu.stuck")
                            .css("transform", "translateY(" + (a - ee) + "px)")
                            .removeClass("header-not-visible"))
                        : T(".page-submenu.stuck")
                            .css("transform", "translateY(" + a + "px)")
                            .removeClass("header-not-visible"))))
              : ((t =
                  0 < T('#header-outer[data-using-secondary="1"]').length
                    ? 32
                    : 0),
                e <=
                  (t =
                  ...
                  0 < T("#header-outer .megamenu").length
                    ...
                    : 0 <
                        T('#header-outer[data-transparent-header="true"]')
                          .length && 0 == T(".nectar-box-roll").length
                    ? c
                        .addClass("transparent")
                        .css("transform", "translateY(0)")
                    : 0 < T(".nectar-box-roll").length &&
                  ...
                  0 < T('#page-header-bg[data-parallax="1"]').length &&
                    c
                      ...
                      .css("transform", "translateY(0)"))),
            te.winH + I.scrollY >= z.body.offsetHeight &&
              ...
              0 < d.length && 0 == T("body.mobile").length
                ...
                : T(".page-submenu.stuck")
                    ...
                    .removeClass("header-not-visible"))),
          (n = e),
          999 < te.winW && requestAnimationFrame(r));
    }
    r();
  }
  function Cn() {
    ...
    (a = 1 == v ? 0 : a) < e &&
      ...
      0 < T("#header-outer .megamenu").length
        ? "true" == c.attr("data-transparent-header") &&
          ...
          0 == T('#header-outer[data-permanent-transparent="1"]').length &&
          0 == T(".megamenu.sfHover").length &&
          (c.removeClass("transparent"), c.removeClass("no-transition"))
        : "true" == c.attr("data-transparent-header") &&
          0 == T("#header-outer.side-widget-open").length &&
          0 == T('#header-outer[data-permanent-transparent="1"]').length &&
          c.removeClass("transparent"),
      ...
      k.off("scroll.headerResizeEffect", Cn),
      k.on("scroll.headerResizeEffect", xn),
  ...
  function xn() {
    ...
    ((e <= (a = 1 == v ? 0 : a) && 1e3 <= t) ||
      (0 < T(".small-nav").length &&
        0 < T("#ajax-content-wrap.no-scroll").length)) &&
      ...
      0 < h.length &&
        (h.removeClass("hide-up"),
        c.removeClass("hide-up").css("transform", "translateY(0%)")),
      0 < T(".nectar-box-roll").length &&
        0 == T('#header-outer[data-permanent-transparent="1"]').length &&
        T("#ajax-content-wrap").animate(
          {
            "margin-top": Math.floor(
              u + 2 * g + te.adminBarHeight + te.secondaryHeaderHeight
            ),
          },
          { queue: !1, duration: 250, easing: "easeOutCubic" }
        ),
      k.off("scroll.headerResizeEffect", xn),
      k.on("scroll.headerResizeEffect", Cn),
      T('#header-outer[data-transparent-header="true"]').css(
        "transition",
        "transform 0.3s ease, background-color 0.30s ease, opacity 0.3s ease, box-shadow 0.30s ease, margin 0.25s ease-out"
  ...
  function kn() {
    (0 <
      ...
      !c.hasClass("within-custom-breakpoint")) ||
      (0 < te.scrollTop &&
        (0 < T("body.material").length &&
          (c.addClass("scrolled-down"),
          0 < h.length &&
            1e3 < te.winW &&
            (h.addClass("hide-up"),
            c.css(
        ...
        "true" == c.attr("data-transparent-header") &&
          0 == T('#header-outer[data-permanent-transparent="1"]').length &&
          c.removeClass("transparent").addClass("scrolled-down"),
        k.off("scroll.headerResizeEffectOpaque", kn),
        k.on("scroll.headerResizeEffectOpaque", Tn)));
  }
  function Tn() {
    (0 <
      T(
      ...
      (0 == te.scrollTop &&
        ...
        0 < T("#header-outer .megamenu").length
          ? "true" == c.attr("data-transparent-header") &&
            0 == T(".megamenu.sfHover").length
            ? (c.addClass("transparent").removeClass("scrolled-down"),
              c.removeClass("no-transition"))
            : "true" == c.attr("data-transparent-header") &&
              c.removeClass("scrolled-down")
          : "true" == c.attr("data-transparent-header") &&
            c.addClass("transparent").removeClass("scrolled-down"),
        0 < T("body.material").length &&
          (c.removeClass("scrolled-down"),
          0 < h.length &&
            ...
            (h.removeClass("hide-up"),
            c.removeClass("hide-up").css("transform", "translateY(0%)"))),
        k.off("scroll.headerResizeEffectOpaque", Tn),
        k.on("scroll.headerResizeEffectOpaque", kn)));
  }
  function In() {
    0 < T("body.material-ocm-open").length
      ...
      : (5 < te.scrollTop
          ? (c.is('[data-permanent-transparent="1"]') ||
              c.removeClass("transparent"),
            0 < te.secondaryHeaderHeight
              ? (h.addClass("hide-up"),
                c
                  .css(
                    "transform",
              ...
              : c.removeClass("hidden-secondary"))
          : (c.is('[data-transparent-header="true"]') &&
              c.addClass("transparent"),
            0 < te.secondaryHeaderHeight &&
              (h.removeClass("hide-up"), c.css("transform", "translateY(0px)")),
            c.removeClass("hidden-secondary")),
        te.winW < 1e3 && requestAnimationFrame(In));
  }
  function zn() {
    999 < te.winW ||
      (k.off("scroll.headerResizeEffect"),
      ...
      0 < T('#header-outer[data-mobile-fixed="1"]').length
        ...
        : "true" == c.attr("data-transparent-header") &&
          c.addClass("transparent"),
      k.off("smartresize.nectarNavScrollEffects"),
      k.on("smartresize.nectarNavScrollEffects", En));
  }
  function En() {
    te.winW < 1e3 ||
      (1 == b && "1" != y
        ...
        ? (k.off("scroll.headerResizeEffectOpaque"),
          k.on("scroll.headerResizeEffectOpaque", kn))
        : "1" == y &&
          (0 < T(".nectar-box-roll").length && c.addClass("at-top-before-box"),
          0 == T('#header-outer[data-remove-fixed="1"]').length && _n()),
      0 <
        T(
          '#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]'
        ).length &&
        (0 < h.length && c.css("transform", ""),
        200 < te.scrollTop &&
          !c.hasClass("fixed-menu") &&
          c.addClass("fixed-menu")),
      k.off("smartresize.nectarNavScrollEffects"),
      k.on("smartresize.nectarNavScrollEffects", zn));
  }
  function Hn() {
    0 == T('#header-outer[data-remove-fixed="1"]').length &&
      1e3 < te.winW &&
      ...
      0 == T("#nectar_fullscreen_rows").length &&
        0 == T(".nectar-box-roll").length &&
        dn(),
      te.winW < 1e3 && 0 == T(".nectar-box-roll").length
        ? (zn(), k.on("smartresize.nectarNavScrollEffects", zn))
        : (En(), k.on("smartresize.nectarNavScrollEffects", En));
  }
  function An() {
    var e, e;
    0 < T(".mobile").length
      ? (te.winH < te.winW &&
          ...
          0 != T("#header-outer.small-nav").length) ||
        T("#header-space").css("height", c.outerHeight())
      : 0 == T(".nectar-parallax-scene.first-section").length &&
        ((e = g - g / 1.8),
        (e =
          0 < T('#header-outer[data-header-resize="1"]').length &&
          0 < T(".small-nav").length
            ? c.outerHeight() + (parseInt(f) + 2 * e)
            : c.outerHeight()),
        T("#header-space").css("height", e));
  }
  function Mn() {
    var e = -1,
      a = te.scrollTop;
    function t() {
      if (!E.hasClass("compose-mode")) {
        if (((a = te.scrollTop), e == a)) return requestAnimationFrame(t), !1;
        (e = a), n(), requestAnimationFrame(t);
      }
    }
    function n() {
      var e = 0,
        ...
        t;
      0 < T("body.mobile").length ||
      (1 == m && "none" == T("#header-outer .span_9").css("display"))
        ? ((e = 0),
          (t = "fixed" == o.css("position") ? o.height() : 0) <
          (e += te.adminBarHeight) - a
            ? c.css("top", e - a + "px")
            : c.css("top", t))
        : 0 == m &&
          ((e = 0),
          c.is('[data-remove-fixed="1"]') || (e += te.adminBarHeight),
          c.css("top", e + "px"));
    }
    0 < T('#header-outer[data-mobile-fixed="1"]').length &&
      0 < o.length &&
      ((0 == T("#nectar_fullscreen_rows").length ||
        (0 < T("#nectar_fullscreen_rows").length && te.usingMobileBrowser)) &&
  ...
  function On() {
    var e = "",
      t,
      e =
        c.is("[data-logo-height]") && c.is("[data-padding]")
          ? 0 < c.find("#logo.no-image").length
            ? "left-header" == w && 1e3 < te.winW
              ? 0
              : parseInt(c.find("#logo.no-image").height()) +
                parseInt(2 * c.attr("data-padding"))
            : "left-header" == w && 1e3 < te.winW
            ? 0
            : parseInt(c.attr("data-logo-height")) +
              parseInt(2 * c.attr("data-padding"))
          : "left-header" == w && 1e3 < te.winW
          ? 0
          : c.outerHeight();
    ...
    te.winH -
      te.adminBarHeight -
      e -
      te.footerOuterHeight -
      1 -
      s.height() -
      T(".page-header-no-bg").height()
      ? ((t =
          0 <
          T('body:not(.material) #header-outer[data-header-resize="1"]').length
            ? 55
            : 0),
        T('body[data-footer-reveal="1"] .container-wrap').css({
          "margin-bottom": te.footerOuterHeight,
        }),
      ...
      te.winW < 1e3
        ? l.attr("data-midnight", "light")
        : l.removeAttr("data-midnight");
  }
  function Sn() {
    (0 < T('body[data-footer-reveal="1"]').length ||
      0 <
        T(
          'body.material[data-slide-out-widget-area-style="slide-out-from-right"]'
        ).length) &&
      (E.hasClass("mobile") || E.addClass("nectar-no-flex-height"),
      setTimeout(On, 60),
      On(),
      k.on("resize", On),
      0 <
        T('body[data-footer-reveal="1"][data-footer-reveal-shadow="large_2"]')
          .length &&
        T(".container-wrap").css({
          boxShadow: "0 70px 110px -30px " + l.css("backgroundColor"),
        }));
  }
  function Fn() {
    var n;
    0 < T('body[data-header-inherit-rc="true"]').length &&
      0 == T(".mobile").length &&
      0 < T('#header-outer[data-transparent-header="true"]').length &&
      ((n = u / 2 + g + te.adminBarHeight),
      0 == T('#header-outer[data-permanent-transparent="1"]').length &&
        (n = u - f + Math.ceil((2 * g) / 1.8) + te.adminBarHeight),
      T(".main-content > .row > .wpb_row").each(function () {
        var t = T(this),
          ...
          e = new Waypoint({
            ...
            handler: function (e) {
              "down" == e
                ? 0 < t.find(".row-bg.using-bg-color").length
                  ? ((a =
                      0 < t.find("> .col.span_12.light").length
                        ? "light-text"
                        : "dark-text"),
                    c
                      .css(
                        "background-color",
                        t.find(".row-bg").css("background-color")
                      )
                  ...
                  : (c
                      .css("background-color", c.attr("data-user-set-bg"))
                      .removeClass("light-text")
                      .removeClass("dark-text"),
                    c.attr(
                      "data-current-row-bg-color",
                ...
                : 0 <
                  t.prev("div.wpb_row").find(".row-bg.using-bg-color").length
                ? ((a =
                    0 <
                    t.prev("div.wpb_row").find("> .col.span_12.light").length
                      ? "light-text"
                      : "dark-text"),
                  c
                    .css(
  ...
  function $n() {
    var s = I.jQuery,
      ...
      e = je();
    function t(e) {
      (this.options = s.extend({}, a.defaults, t.defaults, e)),
        (this.element = this.options.element),
    ...
    k.on("smartresize", function () {
      var e;
      (r = je()),
        0 < o.length && "fixed" == o.css("position") && (r += o.height()),
        0 < d.length &&
          1e3 < k.width() &&
          0 < s('body[data-hhun="1"]').length &&
          (r += d.height()),
        0 < s(".page-submenu.stuck").length
          ? (s(".page-submenu.stuck")
              .addClass("no-trans")
              .css("top", r)
              .css("transform", "translateY(0)")
              .addClass("stuck"),
            setTimeout(function () {
              s(".page-submenu.stuck").removeClass("no-trans");
            }, 50),
            s(".page-submenu.stuck").parents(".wpb_row").css("z-index", 1e4),
            0 < s("#boxed").length &&
              ((e = 1e3 < k.width() ? 0.04 * s(".container-wrap").width() : 39),
              s(".page-submenu.stuck").css({
                "margin-left": "-" + e + "px",
                width: s(".container-wrap").width(),
              })))
          : (s(".page-submenu.stuck").css("top", "0").removeClass("stuck"),
            s(".page-submenu.stuck").parents(".wpb_row").css("z-index", "auto"),
            0 < s("#boxed").length &&
              s(".page-submenu.stuck").css({
                "margin-left": "0px",
                width: "100%",
      ...
      (t.prototype.createWaypoint = function () {
        ...
        (r = je()),
          ...
          (this.waypoint = new a(
            s.extend({}, this.options, {
              ...
              handler: s.proxy(function (e) {
                var t = -1 < this.options.direction.indexOf(e),
                  a = t ? this.$element.outerHeight(!0) : "",
                  n,
                  t;
                this.$wrapper.height(a),
                  t
                    ? (this.$element
                      ...
                      (n = this),
                      setTimeout(function () {
                        n.$element.removeClass("no-trans");
                      }, 50),
                      this.$element.parents(".wpb_row").css("z-index", 1e4),
                      0 < s("#boxed").length &&
                        ((t =
                          1e3 < k.width()
                            ? 0.04 * s(".container-wrap").width()
                            : 39),
                        this.$element.css({
                          "margin-left": "-" + t + "px",
                          width: s(".container-wrap").width(),
        ...
        setInterval(function () {
          var e;
          0 <
          s('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length
            ? ((e = c.outerHeight()),
              0 < h.length && (e -= te.secondaryHeaderHeight),
              (t.waypoint.options.offset = r + e))
            : (t.waypoint.options.offset = r),
            a.refreshAll();
        }, 100);
      }),
  ...
  function Wn() {
    ...
    0 < T('.page-submenu[data-sticky="true"]').length &&
      0 == T("#nectar_fullscreen_rows").length &&
      ($n(),
      1 < T(".page-submenu").parents(".span_12").find("> .wpb_column").length &&
        ((e = T(".page-submenu").clone()),
        (t = T(".page-submenu").parents(".wpb_row")),
        T(".page-submenu").remove(),
        t.before(e)),
      (a = new Waypoint.Sticky({
        element: T('.page-submenu[data-sticky="true"]')[0],
      }))),
      0 == T("#nectar_fullscreen_rows").length &&
        T(".page-submenu").parents(".wpb_row").css("z-index", 1e4),
      T(".page-submenu .mobile-menu-link").on("click", function () {
        return (
          T(this).parents(".page-submenu").find("ul").stop(!0).slideToggle(350),
          !1
        );
      }),
  ...
  function jn() {
    var e, t, a, a, t;
    T(".vc_row-o-full-height:first").length &&
      ((t = k.height()),
      T(".vc_row-o-full-height").each(function () {
        (a = T(this).offset().top) < t &&
        T(this).hasClass("top-level") &&
        !te.usingFrontEndEditor
          ? ((a = 100 - a / (t / 100)),
            T(this).css("min-height", a + "vh"),
            T(this)
              .find("> .col.span_12")
              .css("min-height", a + "vh"))
          : (T(this).css("min-height", t),
            T(this).find("> .col.span_12").css("min-height", t));
      }));
  }
  function Yn() {
    0 < T(".vc_row-o-full-height").length && (jn(), k.on("smartresize", jn));
  }
  function Bn() {
    var e,
      t = I.navigator.userAgent.indexOf("MSIE ");
  ...
  function qn() {
    T(".img-with-aniamtion-wrap img.img-with-animation").each(function () {
      ...
      0 == T(this).parents(".tabbed").length &&
        ...
        ((e = T(this).parents(".img-with-aniamtion-wrap")).css({ height: "" }),
        (t = T(this).height()),
        e.css({ height: t }));
    });
  }
  function Pn() {
    function e() {
      T('.blog-recent[data-style="title_only"]').each(function () {
        if (1 < T(this).find("> .col").length) return !1;
        ...
        (e.hasClass("vc_col-sm-3") ||
          ...
          (0 == T("body.mobile").length && 0 == T(this).next("div").length
            ? ((t = 0),
              ...
              T(this)
                ...
                .find(" > .wpb_column")
                .each(function () {
                  Math.floor(T(this).height()) > t &&
                    (t = Math.floor(T(this).height()));
                }),
    ...
    0 < T('.blog-recent[data-style="title_only"]').length &&
      (e(), k.on("smartresize", e));
  }
  function Ln() {
    T(".nectar-recent-posts-slider").each(function () {
      var e = 250,
        t = parseInt(T(this).attr("data-height")),
        a =
          0 < T('body[data-ext-responsive="true"]').length
            ? k.width() / 1400
            : k.width() / 1100,
      ...
      1e3 < te.winW && 0 == T("#boxed").length
        ...
        : (t = t / Rn(i)) * i.width() <= e
        ? n.css("height", e)
        : n.css("height", t * i.width());
    });
  }
  function Rn(e) {
    var t = 1100,
      e = T(e).attr("class").match(/\d+/);
    return (
      "2" == e
        ? (t = 170)
        : "3" == e
  ...
  function Nn() {
    T(".nectar-recent-posts-single_featured.multiple_featured").each(
      function () {
        var e =
            0 < T(this).find(".project-slides").length
              ? ".project-slide"
            ...
            T(this)
              ...
              .each(function () {
                ...
                for (var t = 0; t < e.length; t++)
                  T(this)[0].innerHTML += "<span>" + e[t] + "</span> ";
              }),
              T(this)
                .find(t + " > span")
  ...
  function Vn() {
    T('.nectar-split-heading[data-animation-type="line-reveal-by-space"]').each(
      function () {
        T(this)
          .find("> *")
          .each(function () {
          ...
          T(this).hasClass("animated-in")
            ? T(this)
                .find("> * > span")
                .wrapInner('<span class="inner animated" />')
            : T(this).find("> * > span").wrapInner('<span class="inner" />'),
          T(this).addClass("markup-generated");
      }
    ),
      T('.nectar-split-heading[data-animation-type="letter-fade-reveal"]').each(
        function () {
          T(this)
            .find("> *")
            .each(function () {
  ...
  function Dn() {
    ...
    function n() {
      T(".nectar-recent-posts-single_featured.multiple_featured").each(
        function (n) {
          0 < T(this).find("> .normal-container").length &&
          ...
          (M[n] = { autorotate: "" }),
            T(this)
              ...
              .each(function (e) {
                T(this).find(".recent-post-container").height() > a &&
                  (T(this).siblings().removeClass("tallest"),
                  T(this).addClass("tallest"),
                  (a = T(this).find(".recent-post-container").height()));
                var e =
                  0 == e &&
                  0 <
                    T(this).parents(
            ...
            T(this)
              ...
              .on("click", function (e) {
                ...
                T(this).hasClass("active") ||
                  ...
                  (t = T(this).index()),
                  (e = T(this).parent().find(".active").index()),
                  (a = T(this)),
                  clearTimeout(i),
                  ...
                  (i = setTimeout(function () {
                    a
                      ...
                      .find(".nectar-recent-post-slide:not(:eq(" + t + "))")
                      .css("opacity", "0")
                      .removeClass("active"),
                      a.parent().find(".trans-out").removeClass("trans-out");
                  }, 300)),
                  a
                    .parents(".multiple_featured")
                    .find(".nectar-recent-post-slide:not(:eq(" + t + "))")
                  ...
                  a
                    .parents(".multiple_featured")
                    .find(".nectar-recent-post-slide:eq(" + e + ")")
                    .css("z-index", "15"),
                  T(this)
                    .parents(".multiple_featured")
                    .find(".nectar-recent-post-slide")
            ...
            (t = T(this)),
            0 < T(this).attr("data-autorotate").length &&
              ...
              setTimeout(function () {
                ...
                (M[n].autorotate = setInterval(function () {
                  ti(t);
                }, e)),
                  t.find(".controls > li:first-child").addClass("active");
              }, 30);
        }
      ),
        Nn(),
    ...
    0 < T(".nectar-recent-posts-slider-inner").length &&
      ((e =
        0 < T(".nectar-recent-posts-slider_multiple_visible").length && "90%"),
      (e = T(".nectar-recent-posts-slider-inner").flickity({
        contain: !0,
        groupCells: e,
        draggable: !0,
        lazyLoad: !1,
      ...
      Ln(),
      k.on("resize", Ln),
      te.usingMobileBrowser || te.usingFrontEndEditor || k.on("resize", Zn)),
      n();
  }
  function Qn() {
    T(".nectar-recent-posts-slider").each(function () {
      var e = parseInt(T(this).find(".flickity-slider").position().left),
        t = T(this).find(".nectar-recent-post-slide"),
        a = t.length,
        n = t.width(),
        i = T(this).find(".nectar-recent-post-slide:last-child").index(),
        s = T(this).find(
      ...
      -3 <= e
        ? t.css("margin-left", parseInt(Math.ceil(n / 3.5)) + "px")
        : t.css("margin-left", "-" + parseInt(Math.ceil((n / 3.5) * i)) + "px"),
        Math.abs(e) >= (a - 1) * n
          ? s.css(
              "margin-left",
  ...
  function Zn() {
    T(".nectar-recent-posts-slider").each(function () {
      var t = T(this).find(".nectar-recent-post-slide").width();
      T(this)
        .find(".nectar-recent-post-slide")
        .each(function (e) {
          T(this)
            .find(".nectar-recent-post-bg")
            .css("margin-left", "-" + parseInt(Math.ceil(t / 3.5) * e) + "px");
        });
    });
  }
  function Un() {
    Dn(),
      ...
      te.usingMobileBrowser ||
        (0 < T(".nectar-recent-posts-slider").length &&
          !te.usingFrontEndEditor &&
          I.requestAnimationFrame(Qn)),
      te.usingMobileBrowser || te.usingFrontEndEditor || Zn();
  }
  function Gn() {
    ...
    var e = z,
      ...
      a = I,
      n = e.querySelectorAll(".parallaxImg"),
      i = n.length,
      s = "ontouchstart" in a || navigator.msMaxTouchPoints;
    if (!(i <= 0))
      for (var r = 0; r < i; r++) {
        var c = n[r],
        ...
        if (!(l <= 0)) {
          ...
          navigator.userAgent.indexOf("Edge/") < 1
            ? ((u = 1), T("html").addClass("cssreflections"))
          ...
          for (var b = 0; b < l; b++) {
            var v = e.createElement("div"),
              ...
              y = o[b].getAttribute("data-img");
            T(v).html(T(o[b]).html()),
              (v.className = "parallaxImg-rendered-layer"),
              v.setAttribute("data-layer", b),
              0 == b &&
                0 == T(c).parents(".wpb_gallery").length &&
                ((w.className = "bg-img"),
          ...
          d.appendChild(f),
            c.appendChild(d),
            T(c).wrap('<div class="parallaxImg-wrap" />'),
            (-1 != navigator.userAgent.indexOf("Safari") &&
              -1 == navigator.userAgent.indexOf("Chrome")) ||
              T(c).parent().append(g),
            (s && 0 < T("body.using-mobile-browser").length) ||
              (function (r, o, l, d) {
                T(c)
                  .parents(".style-5")
                  .on("mousemove", function (e) {
                    var t = T(this),
                      a = t.find(".parallaxImg-container"),
                      n = t.find(".parallaxImg-shadow"),
                      i = Date.now(),
                      s = 0 < T(r).parents(".wpb_gallery").length;
                    h + u < i &&
                      ((h = i),
                      I.requestAnimationFrame(function () {
                        _(e, !1, r, o, l, d, t, a, n, s);
                      }));
                  }),
                  T(c)
                    .parents(".style-5")
    ...
    function _(e, t, a, n, i, s, r, o, l, d) {
      var c, h, u, p, g, f, m, b, v, w, y, _, c, r, t, _, C, w, _, r, r;
      T(a.firstChild).hasClass("over")
        ? ((c = 0.03),
          (h = 0.063),
          (u = "1.03"),
          (g = !(p = "-10")),
          0 < T(a).parents(".col.wide").length
            ? ((c = 0.03), (h = 0.063), (g = !0))
            : 0 < T(a).parents(".col.regular").length ||
              0 < T(a).parents(".wpb_gallery").length
            ? (h = c = 0.045)
            : 0 < T(a).parents(".col.tall").length
            ? ((c = 0.05), (h = 0.015), (g = !0))
            : 0 < T(a).parents(".col.wide_tall").length
            ? ((h = c = 0.04), (g = !0))
          ...
          (f = te.scrollTop),
          (m = 0),
          (b = (t ? e.touches[0] : e).pageX),
          (v = (t ? e.touches[0] : e).pageY),
          (w = a.getBoundingClientRect()),
          (y = a.clientWidth || a.offsetWidth || a.scrollWidth),
          (_ = a.clientHeight || a.offsetHeight || a.scrollHeight),
          (r = 0.52 - (b - w.left) / y),
          (t = 0.52 - (v - w.top - f) / _),
          (_ = v - w.top - f - _ / 2),
          (w = c * (c = 320 / y) * (r - (b - w.left - y / 2))),
          (_ = h * c * (_ - t)),
          o.css(
            "transform",
            (r =
    ...
    function C(e, t) {
      (t.firstChild.className += " over"),
        (t.className += " over"),
        T(t).addClass("transition"),
        0 < T(t).parents(".wpb_gallery").length
          ? setTimeout(function () {
              T(t).removeClass("transition");
            }, 450)
          : setTimeout(function () {
              T(t).removeClass("transition");
            }, 200);
    ...
    function x(e, t) {
      var a = t.clientWidth || t.offsetWidth || t.scrollWidth,
        n = t.firstChild;
    ...
    function k(e, t, a, n) {
      for (
        var i = t.clientWidth || t.offsetWidth || t.scrollWidth,
          t = t.firstChild,
          s = 0;
        s < n;
        s++
        ...
        0 == s
          ? T(a[s]).css("transform", "translateZ(0px)")
          : T(a[s]).css(
              "transform",
              "translateZ(" + ((3 * i) / 27) * (1.1 * s) + "px) "
            );
      (n += 3), T(t).css("transform", "perspective(" + 3 * i + "px)");
    }
  }
  function Jn() {
    var e;
    0 != T('.nectar-fancy-box[data-style="hover_desc"]').length &&
      ((e = 0),
      T("body").on(
  ...
  function Kn(e, t) {
    (this.$el = e),
      ...
      k.on("resize", this.resizeEvent.bind(this)),
      this.mouseEvents(),
      this.rafLoop();
  }
  function ei() {
    ($ = []),
      ...
      T(".nectar-video-box").each(function (t) {
        var a;
        T(this).find(".play_button_mouse_follow") &&
          ((a = T(this)),
          T(this).imagesLoaded(function () {
            te.usingMobileBrowser ||
              ($[t] = new Kn(a, ".play_button_mouse_follow"));
            var e =
  ...
  function ti(e) {
    ...
    0 < T("body.vc_editor").length ||
      ((t =
        0 < e.find(".project-slides").length
          ? ".dot-nav > span"
          : ".controls > li"),
      (a = 0 < e.find(".project-slides").length ? "span" : " li"),
      (n = e.find(t).length),
      (e.find(t + ".active").index() + 1 == n
        ? e.find(t + ":first-child")
        : e.find(t + ".active").next(a)
      ).trigger("click"));
  }
  function ai(e, t) {
    var a;
    clearInterval(M[t].autorotate),
      0 < e.attr("data-autorotate").length &&
        ((a =
          parseInt(e.attr("data-autorotate")) < 100
            ? 4e3
            : parseInt(e.attr("data-autorotate"))),
        (M[t].autorotate = setInterval(function () {
          ti(e);
        }, a)));
  }
  function ni() {
    (j = []),
      "undefined" != typeof SalientRecentProjectsFullScreen &&
        T(".nectar_fullscreen_zoom_recent_projects").each(function (e) {
          j[e] = new SalientRecentProjectsFullScreen(T(this));
        });
  }
  function ii() {
    var e = T(".single-portfolio #sidebar").attr("data-follow-on-scroll"),
      t,
      a,
      a,
      t,
    ...
    0 != T("body.single-portfolio").length &&
      ...
      ((t = 50),
      0 < T('#header-outer[data-remove-fixed="0"]').length &&
        0 == T('body[data-hhun="1"]').length &&
        ((t += c.outerHeight()),
        0 <
          T('#header-outer[data-shrink-num][data-header-resize="1"]').length &&
          ((a =
            parseInt(c.attr("data-padding")) -
            parseInt(c.attr("data-padding")) / 1.8),
          (t -= f),
          (t -= a)),
        0 == T("body.mobile").length &&
          0 < T('#header-outer[data-condense="true"]').length &&
  ...
  function si() {
    0 < T(".infinite_scroll").length &&
      (T(".portfolio-items.infinite_scroll").infinitescroll(
        ...
        function (a) {
          var n = T(".portfolio-items.infinite_scroll:not(.carousel)"),
            e;
          T(a)
            .css("opacity", 0)
            .imagesLoaded(function () {
              var e, e;
              T(a).css("opacity", 1),
                n.isotope("appended", T(a)),
                T(a).find(".work-item").addClass("ajax-loaded"),
                T(a).addClass("ajax-loaded"),
                T(a).find(".work-meta, .nectar-love-wrap").css({ opacity: 1 }),
                (0 < T(".portfolio-filters-inline").length ||
                  0 < T(".portfolio-filters").length) &&
                  ((e = (
                    0 < T(".portfolio-filters-inline").length
                      ? T(".portfolio-filters-inline a.active")
                      : T(".portfolio-filters a.active")
                  ).attr("data-filter")),
                  T(".portfolio-filters-inline a.active").attr("data-filter"),
                  n.isotope({ filter: e }));
              for (var t = 0; t < H.length; t++) H[t].reLayout();
              if (
                (0 < T(a).find(".work-item.style-5").length && Gn(),
                "none" == T(a).find(".inner-wrap").attr("data-animation"))
              )
                T(".portfolio-items .col .inner-wrap").removeClass("animated");
              else {
                for (var t = 0; t < H.length; t++)
                  H[t].masonryZindex(), H[t].portfolioAccentColor();
                T(a).each(function () {
                  var e =
                      0 < T("#nectar_fullscreen_rows").length ? "200%" : "90%",
                    t = T(this),
                    a = new Waypoint({
                      element: t,
                      handler: function () {
              ...
              T(".portfolio-items").each(function () {
                ...
                setTimeout(function () {
                  for (var e = 0; e < H.length; e++)
                    H[e].masonryZindex(),
                      H[e].reLayout(),
                      H[e].isotopeCatSelection();
                  T(a).removeClass("ajax-loaded");
                }, 700),
                Mt();
            });
        }
      ...
      T(".post-area.infinite_scroll .posts-container").infinitescroll(
        ...
        function (t) {
          0 < T(t).find("[data-nectar-img-src]").length && aa(),
            (0 < T(".masonry.classic").length ||
              0 <
                T(".post-area:not(.masonry):not(.featured_img_left)").length ||
              0 < T(".post-area.standard-minimal").length) &&
              (ie(),
              T().mediaelementplayer &&
                T(t)
                  ...
                  .mediaelementplayer(),
              Ge(),
              0 < T(".carousel").length && (me(), xe()),
              hn(),
              T(".testimonial_slider").animate({ opacity: "1" }, 800),
              ha(),
              ua(),
              setTimeout(function () {
                wa(), ya(), k.trigger("resize");
              }, 500)),
            Mt(),
            k.trigger("resize");
          var a = T(".infinite_scroll .posts-container");
          a.parent().hasClass("masonry") && T(t).addClass("masonry-blog-item");
          var e = T(t);
          (e = 0 == e.find("img").length ? T("body") : e).imagesLoaded(
            function () {
              a.parent().hasClass("masonry") &&
                !a.parent().hasClass("auto_meta_overlaid_spaced") &&
                a.isotope("appended", T(t));
              for (var e = 0; e < L.length; e++) L[e].flickityBlogInit();
              if (
                (T(t).addClass("ajax-loaded"),
                ...
                "none" ==
                  T(t).parents(".posts-container").attr("data-animation"))
              )
                T(t).find(".inner-wrap").removeClass("animated");
              else {
                for (var e = 0; e < L.length; e++) L[e].blogMasonryZindex();
                T(t).each(function () {
                  var e = T(this),
                    t = new Waypoint({
                      element: e,
  ...
  function ri() {
    ((0 < T("#to-top").length && 1020 < k.width()) ||
      (0 < T("#to-top").length && 0 < T("#to-top.mobile-enabled").length)) &&
      (350 < te.scrollTop ? k.on("scroll", li) : k.on("scroll", oi));
  }
  function oi() {
    350 < te.scrollTop &&
      !i.is(".fullscreen.open") &&
      (T("#to-top")
        .stop()
        .transition({ bottom: "17px" }, 350, "easeInOutCubic"),
      k.off("scroll", oi),
      k.on("scroll", li));
  }
  function li() {
    var e;
    (te.scrollTop < 350 || i.is(".fullscreen.open")) &&
      ((e =
        0 < T("#slide-out-widget-area.fullscreen.open").length ? 1150 : 350),
      T("#to-top").stop().transition({ bottom: "-30px" }, e, "easeInOutQuint"),
      k.off("scroll", li),
      k.on("scroll", oi));
  }
  function di() {
    var e;
    0 == T(".nectar-social.fixed").length && ri(),
      0 < T('body[data-button-style*="rounded"]').length &&
        ((e = T("#to-top .fa-angle-up").clone()).addClass("top-icon"),
        T("#to-top").prepend(e)),
  ...
  function ci() {
    ...
    (0 < T(".page-template-template-no-header-footer").length ||
      0 < T(".page-template-template-no-header").length) &&
      (e = 0),
      T('header#top .sf-menu li a[href="#"]').on("click", function (e) {
        e.preventDefault();
      }),
      0 == T("#nectar_fullscreen_rows").length || 0 == K.$usingFullScreenRows
        ? T("a.nectar-next-section").each(function () {
            var e, t, t;
            0 < T(this).parents(".wpb_row:not(.inner_row)").length &&
              ((e = T(this).parents(".wpb_row:not(.inner_row)")),
              (t = T(this).parents(".wpb_row:not(.inner_row)").index()),
              0 <
                e.parent().find("> .wpb_row[id]:eq(" + (t + 1) + ")").length &&
                ((t = e
                  .parent()
                  .find("> .wpb_row:eq(" + (t + 1) + ")")
                  .attr("id")),
      ...
      0 < T("#slide-out-widget-area .off-canvas-menu-container").length &&
        T("#slide-out-widget-area .off-canvas-menu-container")
          ...
          .each(function () {
            ...
            "#" != e &&
              -1 != e.indexOf("#") &&
              "#" !== e.substr(e.indexOf("#")) &&
              0 < T("div" + e.substr(e.indexOf("#"))).length &&
    ...
    var t =
      0 == T('.page-submenu[data-sticky="true"]').length
        ? "#header-outer nav"
        : ".page-submenu";
    E.scrollspy({ target: t, offset: e + te.adminBarHeight + 40 });
  }
  function hi() {
    var e = I.location.hash,
      t =
        (e = e && 0 < e.length ? e.replace(/<|>/g, "") : e) && 0 < e.length
          ? e.substring(1, e.length)
          : 0,
      s = 2 * parseInt(c.attr("data-padding")),
      a = 0,
      r,
      o,
      t;
    t && (a = (a = t.split("/")).length),
      t && 1 < a && ((t = t.replace(/\//g, "")), (e = e.replace(/\//g, ""))),
      ((e && 0 < T(".main-content").find(e).length) ||
        (e &&
          0 <
            T(".main-content").find('[data-fullscreen-anchor-id="' + t + '"]')
              .length)) &&
        ((r =
          0 < T(".main-content").find(e).length
            ? T(".main-content").find(e)
            : T(".main-content").find(
        ...
        (0 < T(".page-template-template-no-header-footer").length ||
          0 < T(".page-template-template-no-header").length) &&
          (o = 0),
        (t = 0) < T(".nectar-box-roll").length &&
          0 < T(".container-wrap.bottomBoxOut").length &&
          (J.boxRoll(null, -1), (t = 2050)),
        setTimeout(function () {
          var e, t, a, n, i, e;
          0 == T('body[data-permanent-transparent="1"]').length
            ? E.hasClass("mobile")
              ? (e =
                  0 < T('#header-outer[data-mobile-fixed="1"]').length
                    ? r.offset().top + 2 - o + te.adminBarHeight
                    : r.offset().top - te.adminBarHeight + 1)
              : ((t =
                  0 < T('#header-outer[data-header-resize="0"]').length
                    ? 0
                    : parseInt(f) + 2 * s),
                0 < T('#header-outer[data-remove-fixed="1"]').length && (o = 0),
                (e = r.offset().top - parseInt(o) + t + 3 - te.adminBarHeight),
                0 == T("body.mobile").length &&
                  0 < T('#header-outer[data-condense="true"]').length &&
                  ((a = T(
                    '#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9'
                  ...
                  (i =
                    ...
                    (parseInt(a.height()) +
                      parseInt(T("#header-outer #logo").css("margin-top")))),
                  (e = r.offset().top - parseInt(o) + i - te.adminBarHeight)))
            : (e = r.offset().top - te.adminBarHeight + 1),
            0 < T('body[data-hhun="1"]').length &&
              0 == T('#header-outer[data-remove-fixed="1"]').length &&
              0 == T("#header-outer.detached").length &&
              (e += o);
          var a =
            ...
            i =
              ...
              !E.hasClass("mobile")
                ? h.height()
                : 0;
          qe(e - a + i, 700, "easeInOutQuint");
        }, t));
  }
  function ui() {
    0 < T('body[data-animated-anchors="true"]').length &&
      (0 == T(".nectar-box-roll").length &&
        0 == T("#nectar_fullscreen_rows").length &&
        (void 0 !== Ne.tab
          ? setTimeout(function () {
  ...
  function pi() {
    ...
    (0 < T('body[data-animated-anchors="true"]').length ||
      0 <
        T('.single-product [data-gallery-style="left_thumb_sticky"]').length) &&
      ((d = g - g / 1.8),
      setTimeout(ci, 200),
      E.on(
        "click",
        ...
        function (e) {
          var s = T(this).prop("hash");
          T(this).hasClass("nectar-next-section") ||
            "1" != y ||
            E.addClass("animated-scrolling"),
            clearTimeout(n),
          ...
          (0 < T(".page-template-template-no-header-footer").length ||
            ...
            ((s &&
              ...
              "" != s &&
              -1 !==
                T(this).attr("href").indexOf(I.location.href.split("#")[0])) ||
              (T(this).is('[href^="#"]') &&
                "" != s &&
                0 < E.find(s).length &&
                "#top" != s)) &&
              (T(this).hasClass("skip-hash") ||
                (history.pushState
                  ...
                  : (location.hash = s)),
              0 < T(this).parents("ul").length &&
                T(this)
                  .parents("ul")
                  .find("li")
                  .removeClass("current-menu-item"),
              0 < T(this).parents("#slide-out-widget-area").length &&
                (0 <
                T(
              ...
              0 < T(this).parents("#mobile-menu").length &&
                (T(".slide-out-widget-area-toggle.mobile-icon a")
                  .addClass("non-human-allowed")
                  .trigger("click"),
                setTimeout(function () {
              ...
              (o =
                0 < T(this).parents("#mobile-menu").length
                  ? T(this).parents("#mobile-menu").height()
                  : null),
              (a = 1),
              (l = T(this)),
              0 < T(".nectar-box-roll").length &&
                0 < T(".container-wrap.bottomBoxOut").length &&
                (J.boxRoll(null, -1), (a = 2050)),
              setTimeout(function () {
                var e, t, a, n, i, e;
                0 == T('body[data-permanent-transparent="1"]').length
                  ? E.hasClass("mobile")
                    ? (e =
                        0 < T('#header-outer[data-mobile-fixed="1"]').length
                          ? T(s).offset().top + 2 - r + te.adminBarHeight
                          : T(s).offset().top - o - te.adminBarHeight + 1)
                    : ((t =
                        0 < T('#header-outer[data-header-resize="0"]').length
                          ? 0
                          : parseInt(f) + 2 * d),
                      ...
                      0 == T("body.mobile").length &&
                        ...
                        (e =
                          ...
                          i -
                          te.adminBarHeight)))
                  : (e = T(s).offset().top - te.adminBarHeight + 1),
                  0 < T('body[data-hhun="1"]').length &&
                    0 == T('#header-outer[data-remove-fixed="1"]').length &&
                    ((0 == T("#header-outer.detached").length ||
                      0 <
                        l.parents('.page-submenu[data-sticky="true"]')
                          .length) &&
                      (e += r),
                    0 < l.parents('.page-submenu[data-sticky="true"]').length &&
  ...
  function gi() {
    var e = T("#search-results"),
      t = e.is('[data-layout="masonry-no-sidebar"]') ? 4 : 3;
    e.imagesLoaded(function () {
      e.isotope({
        itemSelector: ".result",
        layoutMode: "packery",
        packery: { columnWidth: T("#search-results").width() / t },
      }),
        e.find("article").css("opacity", "1");
    }),
      k.on("resize", function () {
        e.isotope({
          layoutMode: "packery",
  ...
  function fi() {
    0 < T("body.search-results").length &&
      0 < T("#search-results article").length &&
      0 == T('#search-results[data-layout="list-no-sidebar"]').length &&
      gi();
  }
  function mi() {
    var a;
    (0 < T(".portfolio-items .col .style-3-alt").length ||
      0 < T(".portfolio-items .col .style-3").length ||
      0 < T(".portfolio-items .col .style-2").length ||
      0 < T(".portfolio-items .col .style-5").length) &&
      ((a = ""),
      T(".portfolio-items .col").each(function () {
        var e = T(this).attr("data-title-color"),
          t = T(this).attr("data-subtitle-color");
        0 < e.length &&
          ((a +=
  ...
  function vi() {
    (H = []),
      T(".portfolio-items:not(.carousel)").each(function (e) {
        T(this).attr("instance", e),
          T(this)
            .parent()
            .parent()
          ...
          "undefined" != typeof SalientPortfolio &&
            (H[e] = new SalientPortfolio(T(this), Wt));
      });
  }
  function wi() {
    690 < te.winW &&
      T('.posts-container[data-load-animation="perspective"]').css(
        "perspective-origin",
        "50% " + (te.scrollTop + te.winH) + "px"
      ),
      requestAnimationFrame(wi);
  }
  function yi() {
    0 < T('.posts-container[data-load-animation="perspective"]').length &&
      requestAnimationFrame(wi);
  }
  function _i(e) {
      ...
      T(".posts-container").each(function (e) {
        ...
        !T(this).parent().hasClass("auto_meta_overlaid_spaced")
          ? "undefined" != typeof NectarMasonryBlog &&
            (L[e] = new NectarMasonryBlog(T(this), zt, _i))
          : _i(T(this));
      });
  }
  function xi() {
    !T().theiaStickySidebar ||
      ...
      T(
        ...
        0 < T('#header-outer[data-remove-fixed="0"]').length &&
          ...
          ((e += c.outerHeight()),
          0 <
            T('#header-outer[data-shrink-num][data-header-resize="1"]')
              .length &&
            ((t =
              parseInt(c.attr("data-padding")) -
              parseInt(c.attr("data-padding")) / 1.8),
          ...
          0 == T("body.mobile").length &&
            ...
            (e +=
              ...
              (parseInt(t.position().top) -
                parseInt(T("#header-outer #logo").css("margin-top"))) -
              parseInt(te.secondaryHeaderHeight)))),
          0 < o.length && (e += o.outerHeight()),
          0 < T(this).parents(".wpb_widgetised_column").length
            ? 0 < T("body.vc_editor").length ||
              T(this)
                .parents(".wpb_column")
                .theiaStickySidebar({
  ...
  function ki() {
    ...
    E.on(
      ...
      function () {
        if (0 < T(this).parents(".nectar-box-roll").length) return !1;
        var e = T(this).parents("#page-header-bg"),
          t = e.height(),
          a =
            0 == e.parents(".first-section").length ||
            0 < T('body[data-transparent-header="false"]').length
              ? e.offset().top
              : 0,
          n = 0 < d.length && 1e3 < k.width() ? d.height() : 0,
          i =
            0 < T('body[data-header-format="left-header"]').length
              ? 0
          ...
          i;
        return (
          0 < T("body.material").length && 0 < h.length && (s = h.height()),
          0 == T('body[data-permanent-transparent="1"]').length
            ? E.hasClass("mobile")
              ? ((r =
                  0 < T('#header-outer[data-mobile-fixed="1"]').length
                    ? parseInt(t) - i + parseInt(e.offset().top) + 2
                    : parseInt(t) + parseInt(e.offset().top) + 2),
                T("body,html")
                  .stop()
                  .animate({ scrollTop: r - 2 * n }, 1e3, "easeInOutCubic"))
              : 0 < T('body[data-hhun="1"]').length &&
                0 == T('#header-outer[data-remove-fixed="1"]').length
              ? T("body,html")
                  .stop()
                  .animate(
                    { scrollTop: parseInt(t) + a + 2 - 2 * n },
                    1e3,
                    "easeInOutCubic"
                  )
              : ((o =
                ...
                T("body,html")
                  .stop()
                  .animate(
                    { scrollTop: parseInt(t - i) + o + 3 + a + s },
                    1e3,
                    "easeInOutCubic"
                  ))
            : T("body,html")
                ...
                .animate(
                  {
                    scrollTop:
                      parseInt(t) + parseInt(e.offset().top) + 2 - 2 * n,
                  },
                  1e3,
                  "easeInOutCubic"
                ),
  ...
  function Ti() {
    ...
    for (var e = 0; e < B.length; e++)
      "displace-filter-fade" == B[e].animationType &&
        0 < T(B[e].canvasContainer).parents(".fp-section.active").length &&
        (0 == T(B[e].canvasContainer).find(".image-added-to-stage").length &&
          B[e].imgContainer.addChild(B[e].bg),
        T(B[e].canvasContainer)
          .find(".nectar-liquid-bg")
          .addClass("image-added-to-stage"),
        B[e].animateProps(B[e]));
  }
  function Ii() {
    var e;
    0 < T("#nectar_fullscreen_rows").length &&
      T().fullpage &&
      ((Z = I.vc_iframe ? ".vc_element.vc_vc_row.active " : ".wpb_row.active "),
      (e =
        0 < T("#nectar_fullscreen_rows[data-mobile-disable]").length
          ? T("#nectar_fullscreen_rows").attr("data-mobile-disable")
          : "off"),
      "on" != (e = !te.usingMobileBrowser ? "off" : e) ? (U = !0) : (Z = ""),
      (K = new NectarFullScreenRows(hn, P, Ti, te, Kt, R, A)));
  }
  function zi() {
    var e, t;
    te.usingMobileBrowser && E.addClass("using-mobile-browser"),
      0 < I.navigator.userAgent.indexOf("Edge/") && E.addClass("msie"),
      ...
      0 < T(".single .blog_next_prev_buttons").length &&
      ...
      T(".wpb_column.neg-marg").parents(".wpb_row").css("z-index", "110");
  }
  function Ei() {
      ...
      (0 <
        ...
        te.usingMobileBrowser
          ? (I.addEventListener("orientationchange", function () {
            ...
            k.on("resize", function () {
              ((k.width() != e && k.height != t) || 1 === a) &&
                (Ei(), (e = te.winW), (t = te.winH), (a = 0));
            }))
          : k.on("resize", Ei)));
  }
  function Ai() {
    T(
      ...
      var e = 690 < te.winW ? 7 : 200;
      (T(this).hasClass("skip-select2-search") ||
        0 < T(this).parents(".skip-select2-search").length) &&
        (e = 1e3),
        0 == T(this).parents("#buddypress").length &&
          (0 == T(this).parents(".woocommerce-ordering").length
            ? T(this).select2({ minimumResultsForSearch: e, width: "100%" })
            : T(this).select2({
  ...
  function Mi() {
    0 < T('body[data-fancy-form-rcs="1"]').length &&
      (T("select:not(.comment-form-rating #rating)").each(function () {
        var e;
        0 < T(this).parents(".wpcf7-form-control-wrap").length
          ? 1 ==
            (e =
              0 <
              T(this)
          ...
          : ((e =
              0 < T(this).prev(".select2-container").length
  ...
  function Oi() {
    ((-1 != navigator.userAgent.indexOf("Safari") &&
      -1 == navigator.userAgent.indexOf("Chrome")) ||
      navigator.userAgent.match(/(iPod|iPhone|iPad)/)) &&
      (I.onpageshow = function (e) {
        e.persisted &&
          (T(
            ".nectar-video-wrap, .nectar-slider-wrap .swiper-slide .video-wrap"
          ).each(function () {
            0 < T(this).find("video").length && T(this).find("video")[0].play();
          }),
          0 < T("body.material-ocm-open").length
            ? (T("body > .slide_out_area_close")
                .addClass("non-human-allowed")
            ...
            ? ja()
            : (0 < T("#slide-out-widget-area.fullscreen.open").length ||
                0 < T("#slide-out-widget-area.fullscreen-alt.open").length ||
                0 <
                  T("#slide-out-widget-area.slide-out-from-right.open")
                    .length) &&
  ...
  function Si() {
    T(".wpb_row").removeClass("only-ns"),
      ...
      T(
        ...
        0 < T(this).find("> .vc_element-container > div").length &&
          (T(this)
  ...
  function Fi() {
    T('.vc_element > .wpb_column[class*="padding-"][class*="-percent"]').each(
      function () {
        var e = 4,
          t = this.className.match(/padding-\d+/),
          t;
        (e = t ? ((e = t[0].match(/\d+/)) ? e[0] / 100 : 0) : e) &&
          ((t = T(this).parents(".span_12").width()),
          T(this).is('[data-padding-pos="all"]')
            ? T(this).css("padding", t * e)
            : T(this).is('[data-padding-pos="top"]')
            ? T(this).css("padding-top", t * e)
            : T(this).is('[data-padding-pos="bottom"]')
            ? T(this).css("padding-bottom", t * e)
            : T(this).is('[data-padding-pos="left"]')
            ? T(this).css("padding-left", t * e)
            : T(this).is('[data-padding-pos="right"]')
            ? T(this).css("padding-right", t * e)
            : T(this).is('[data-padding-pos="top-bottom"]')
            ? T(this).css({ "padding-top": t * e, "padding-bottom": t * e })
            : T(this).is('[data-padding-pos="top-right"]')
            ? T(this).css({ "padding-top": t * e, "padding-right": t * e })
            : T(this).is('[data-padding-pos="bottom-right"]')
            ? T(this).css({ "padding-right": t * e, "padding-bottom": t * e })
            : T(this).is('[data-padding-pos="bottom-left"]')
            ? T(this).css({ "padding-left": t * e, "padding-bottom": t * e })
            : T(this).is('[data-padding-pos="left-right"]') &&
              T(this).css({ "padding-left": t * e, "padding-right": t * e }));
      }
    ),
  ...
  function $i() {
    setTimeout(function () {
      0 < T("body.compose-mode").length &&
        T(".container-wrap").addClass("visible-editor-controls"),
        te.usingFrontEndEditor &&
          (Si(), E.is('[data-flex-cols="true"]') || (Fi(), k.smartresize(Fi)));
    }, 200),
      k.on("vc_reload", function () {
        if (
          (Si(),
          bt(),
          ut(),
          ...
          for (var e = 0; e < O.length; e++)
            O[e].reloadCells(),
              O[e].off("scroll.flickity"),
              O[e].off("dragStart.flickity"),
              O[e].off("dragEnd.flickity");
        if (
          (oe(),
          setTimeout(function () {
            if ((le(), 0 < O.length))
              for (var e = 0; e < O.length; e++)
                O[e].reloadCells(), O[e].resize();
          }, 100),
          0 < Y.length)
        )
          for (var e = 0; e < Y.length; e++)
            Y[e].flickity("reloadCells"),
              Y[e].off("scroll.flickity"),
              Y[e].off("dragStart.flickity"),
              Y[e].off("dragEnd.flickity");
        setTimeout(function () {
          if ((0 < T(".nectar-woo-flickity").length && _e(), 0 < Y.length))
            for (var e = 0; e < Y.length; e++)
              Y[e].flickity("reloadCells"), Y[e].flickity("resize");
        }, 100),
          ha();
        for (var e = 0, t; e < q.length; e++)
          ("multiple_visible" != q[e].type &&
            "multiple_visible_minimal" != q[e].type) ||
            (q[e].flickityEl.flickity("reloadCells"),
            q[e].flickityEl.off("select.flickity"),
            ha(),
            q[e].flickityEl.resize()),
            q[e].testimonialSliderHeight();
        if (
          (ua(),
          ca(),
          ...
          xa(),
          Yn(),
          k.off("scroll.parallaxSections").off("resize.parallaxSections"),
          Ht(),
          Ci(),
          vi(),
          0 < H.length)
        )
          for (var e = 0; e < H.length; e++) H[e].portfolioAccentColor();
        Gn(),
          ni(),
          setTimeout(function () {
            if (
              ...
              for (var e = 0; e < j.length; e++) j[e].sliderCalcs();
          }, 300),
          k.unbind(".infscr"),
          si(),
          jt(),
          ...
          0 < T("#nectar_fullscreen_rows").length
            ? (0 == T("#nectar_fullscreen_rows > .vc_element").length &&
              ...
              T("#nectar_fullscreen_rows > div.vc_element").each(function (e) {
                t[e] = { el: T(this), offset: T(this).offset().top };
              }),
          ...
          0 < T(".vc_nectar_gmap").length &&
            setTimeout(function () {
              "object" == typeof google && "object" == typeof google.maps
                ? I.mapAPI_Loaded()
                : 0 < I.nectarLove.mapApiKey.length &&
                  T.getScript(
                    "https://maps.google.com/maps/api/js?sensor=false&key=" +
                      I.nectarLove.mapApiKey +
                      "&callback=mapAPI_Loaded"
                  );
            }, 100),
          xi(),
          void 0 !== I.Waypoint && (Waypoint.destroyAll(), hn());
      });
  }
  function Wi() {
    var e = !1,
      t;
    function a() {
      0 < T('#ajax-loading-screen[data-effect*="horizontal_swipe"]').length
        ? (r.removeClass("loaded"),
          r.addClass("in-from-right"),
          setTimeout(function () {
            r.addClass("loaded");
          }, 30))
        : (0 <
          T('#ajax-loading-screen[data-effect="center_mask_reveal"]').length
            ? r.css("opacity", "0").css("display", "block")
            : r.show()
          ).transition({ opacity: "1" }, 450);
    }
    0 < T('body[data-ajax-transitions="true"]').length &&
      0 < T('#ajax-loading-screen[data-disable-mobile="1"]').length &&
      te.winW < 1e3 &&
      (e = !0),
      0 < T('body[data-ajax-transitions="true"]').length &&
      0 < T('#ajax-loading-screen[data-method="standard"]').length &&
      0 == e
        ? (T("html").addClass("page-trans-loaded"),
          0 < T('#ajax-loading-screen[data-effect="standard"]').length
            ? (0 == T(".nectar-particles").length &&
                (r.transition({ opacity: 0 }, 500, function () {
          ...
          navigator.userAgent.match(/(iPod|iPhone|iPad)/)
            ? ((I.onunload = function () {
                r.stop().transition({ opacity: 0 }, 800, function () {
                  T(this).css({ display: "none" });
                }),
                  T("#ajax-loading-screen .loading-icon").transition(
                    { opacity: 0 },
          ...
          0 ==
            T('#ajax-loading-screen[data-disable-fade-on-click="1"]').length &&
            0 ==
              T(
            ...
            I.addEventListener("beforeunload", function () {
              t || (r.addClass("set-to-fade"), a()), (t = !1);
            })))
        : (1 == e &&
            r
  ...
  (T.fn.dlmenu = function (t) {
    var a;
    return (
      "string" == typeof t
        ? ((a = Array.prototype.slice.call(arguments, 1)),
          this.each(function () {
            var e = T.data(this, "menu");
            e
              ? T.isFunction(e[t]) && "_" !== t.charAt(0)
                ? e[t].apply(e, a)
                : Ka("no such method '" + t + "' for menu instance")
              : Ka(
        ...
        : this.each(function () {
            var e = T.data(this, "menu");
            e ? e._init() : (e = T.data(this, "menu", new T.DLMenu(t, this)));
          }),
      this
    );
  }),
    ...
    (Kn.prototype.mouseEvents = function () {
      var t = this;
      t.$el.on("mouseenter", function (e) {
        (t.activeFollow = !0),
          ...
          (t.elY = e.offsetY),
          (t.lastScroll = 0),
          clearTimeout(t.percentageTimeout),
          (t.percentageTimeout = setTimeout(function () {
            t.percentage = 0.2;
          }, 700));
      }),
        ...
        t.$el.on("mousemove", function (e) {
          (t.elX = e.offsetX), (t.elY = e.offsetY), (t.lastScroll = 0);
        }),
        T(I).on("scroll", function () {
          1 == t.activeFollow &&
            0 == t.lastScroll &&
            (t.lastScroll = te.scrollTop);
        });
    }),
    (Kn.prototype.rafLoop = function () {
      1 == this.activeFollow
        ? ((this.scrollAdjust =
            0 < this.lastScroll ? te.scrollTop - this.lastScroll : 0),
          (this.lastY = $e(
            this.lastY,
            this.elY + this.scrollAdjust,
            this.percentage
          )),
          (this.lastX = $e(this.lastX, this.elX, this.percentage)))
        : ((this.lastY = $e(this.lastY, this.initialY, 0.13)),
          (this.lastX = $e(this.lastX, this.initialX, 0.13))),
        this.$iconEl.css({
          transform:
            "translateX(" + this.lastX + "px) translateY(" + this.lastY + "px)",
        }),
    ...
    jQuery(z).ready(function (e) {
      te.init(),
        ...
        $i(),
        Wi(),
        k.off("smartresize.srInit"),
        k.on("smartresize.srInit", ae),
        k.off("resize.srInit"),
        k.on("resize.srInit", ne),
        k.on("load", function () {
          0 == e(I).scrollTop() && An(),
...
!(function (a) {
  ...
  (function (a, b) {
        ...
        window.setTimeout(function () {
          ...
          e &&
            ...
            (c.setSelectionRange
              ...
              : c.createTextRange &&
                ((b = c.createTextRange()), b.collapse(!1), b.select()));
        }, 0);
    }
    function o(b) {
      b = a(b)[0];
    ...
    function B(a, c, d, e) {
      ...
      for (;;) {
        for (
          h = -1, i = 0, j = e.tokenSeparators.length;
          i < j && ((k = e.tokenSeparators[i]), (h = a.indexOf(k)), !(h >= 0));
          i++
        );
        if (h < 0) break;
        if (
          ...
          f.length > 0 &&
            ((f = e.createSearchChoice.call(this, f, c)),
        ...
        (E = D(Object, {
          ...
          init: function (c) {
            ...
            (this.opts = c = this.prepareOpts(c)),
              ...
              (this.containerId =
                "s2id_" + (c.element.attr("id") || "autogen" + H())),
              ...
              this.container.addClass(
                z(c.containerCssClass, this.opts.element)
              ),
                ...
                d.mousewheel(function (a, b, c, e) {
                  ...
                  e > 0 && f - e <= 0
                    ...
                    : e < 0 &&
                      ...
                      (d.scrollTop(d.get(0).scrollHeight - d.height()), p(a));
                }),
              j(e),
          ...
          optionToData: function (a) {
            return a.is("option")
              ? {
                  ...
                  locked:
                    g(a.attr("locked"), "locked") || g(a.data("locked"), !0),
                }
              : a.is("optgroup")
              ? {
                  text: a.attr("label"),
          ...
          prepareOpts: function (c) {
            ...
            if (
              ...
              a.isFunction(l.noMatches) && (c.formatNoMatches = l.noMatches),
                ...
                a.isFunction(l.inputTooShort) &&
                  (c.formatInputTooShort = l.inputTooShort),
                a.isFunction(l.inputTooLong) &&
                  (c.formatInputTooLong = l.inputTooLong),
                a.isFunction(l.loadingMore) &&
                  (c.formatLoading = l.loadingMore),
                a.isFunction(l.maximumSelected) &&
                  (c.formatSelectionTooBig = l.maximumSelected);
            }
            if (
              ((c = a.extend(
                {},
              ...
              (e
                ? ((c.query = this.bind(function (a) {
                    ...
                    (f = function (b, c) {
                      var d;
                      b.is("option")
                        ? a.matcher(h, b.text(), b) && c.push(j.optionToData(b))
                        : b.is("optgroup") &&
                          ((d = j.optionToData(b)),
                    ...
                    : "tags" in c &&
                      ...
                      c.initSelection === b &&
                        (c.initSelection = function (b, d) {
                          var e = [];
                          a(h(b.val(), c.separator, c.transformVal)).each(
                            function () {
              ...
              (this._sync = this.bind(function () {
                ...
                c === b && (c = !1),
                  ...
                  this.container &&
                    ...
                    this.container.addClass(
                      z(this.opts.containerCssClass, this.opts.element)
                    )),
                  this.dropdown &&
                    (s(
                      this.dropdown,
                    ...
                    this.dropdown.addClass(
                      z(this.opts.dropdownCssClass, this.opts.element)
                    ));
              })),
              d.length &&
                d[0].attachEvent &&
          ...
          positionDropdown: function () {
            ...
            y
              ...
              this.opts.dropdownAutoWidth
                ? ((f = a(".select2-results", g)[0]),
                  g.addClass("select2-drop-auto-width"),
                  g.css("width", ""),
                  (v =
                    g.outerWidth(!1) +
                    (f.scrollHeight === f.clientHeight ? 0 : K.width)),
                  v > k ? (k = v) : (v = k),
                  (l = g.outerHeight(!1)))
                : this.container.removeClass("select2-drop-auto-width"),
              "static" !== this.body.css("position") &&
                ((b = this.body.offset()), (r -= b.top), (s -= b.left)),
            ...
            this.container
              ...
              0 === b.length &&
                ...
                b.on("mousedown touchstart click", function (d) {
                  ...
                  f.length > 0 &&
                    ((e = f.data("select2")),
                    e.opts.selectOnBlur && e.selectHighlighted({ noFocus: !0 }),
                    e.close(),
                    d.preventDefault(),
                    d.stopPropagation());
                })),
          ...
          ensureHighlightVisible: function () {
            ...
            if (((c = this.highlight()), !(c < 0))) {
              ...
              (b = this.findHighlightableChoices().find(
                ...
                (e = i + d.outerHeight(!0)),
                c === b.length - 1 &&
                  ((h = j.find("li.select2-more-results")),
          ...
          highlight: function (b) {
            var c,
              d,
              f = this.findHighlightableChoices();
            return 0 === arguments.length
              ? e(f.filter(".select2-highlighted")[0], f.get())
              : (b >= f.length && (b = f.length - 1),
                b < 0 && (b = 0),
                ...
                this.search.attr(
                  ...
                  c.find(".select2-result-label").attr("id")
                ),
                    ...
                    e.opened() &&
                      ...
                      a.more === !0
                        ? (c
                            ...
                            .html(
                              e.opts.escapeMarkup(
                                z(e.opts.formatLoadMore, e.opts.element, d + 1)
                              )
                            ),
                          window.setTimeout(function () {
                            e.loadMoreIfNeeded();
          ...
          updateResults: function (c) {
            function d() {
              j.removeClass("select2-active"),
                ...
                k.find(
                  ...
                  ? m.liveRegion.text(k.text())
                  : m.liveRegion.text(
                      m.opts.formatMatches(
                        k.find(
            ...
            if (
              (c === !0 || !o || !g(n, o)) &&
              (a.data(this.container, "select2-last-term", n),
              ...
              if (
                ...
                a.isArray(f) &&
                  f.length >= p &&
                  y(l.formatSelectionTooBig, "formatSelectionTooBig"))
              )
                return void e(
              ...
              if (j.val().length < l.minimumInputLength)
                return (
                  e(
                    y(l.formatInputTooShort, "formatInputTooShort")
              ...
              if (l.maximumInputLength && j.val().length > l.maximumInputLength)
                return void e(
                  y(l.formatInputTooLong, "formatInputTooLong")
                    ? "<li class='select2-no-results'>" +
                        z(
                ...
                l.query({
                  ...
                  callback: this.bind(function (f) {
                    ...
                    if (i == this.queryCount) {
                      ...
                      if (
                        f.hasError !== b &&
                        y(l.formatAjaxError, "formatAjaxError")
                      )
                        return void e(
                      ...
                      if (
                        ...
                        this.opts.createSearchChoice &&
                          ...
                          h !== b &&
                            ...
                            null !== m.id(h) &&
                            0 ===
                              a(f.results).filter(function () {
                                return g(m.id(this), m.id(h));
                              }).length &&
                            this.opts.createSearchChoicePosition(f.results, h)),
                        0 === f.results.length &&
                          y(l.formatNoMatches, "formatNoMatches"))
                      )
                        return (
                          e(
                            "<li class='select2-no-results'>" +
                      ...
                      k.empty(),
                        ...
                        f.more === !0 &&
                          y(l.formatLoadMore, "formatLoadMore") &&
                          (k.append(
                            "<li class='select2-more-results'>" +
                              l.escapeMarkup(
                                z(l.formatLoadMore, l.element, this.resultsPage)
                              ) +
                              "</li>"
                          ),
                          window.setTimeout(function () {
        ...
        (F = D(E, {
                ...
                this.bind(function (a) {
                  if (this.isInterfaceEnabled() && 229 != a.keyCode) {
                    ...
                    switch (a.which) {
                      ...
                      case M.DOWN:
                        return (
                          this.moveHighlight(a.which === M.UP ? -1 : 1),
                          void p(a)
                        );
                      case M.ENTER:
                ...
                this.bind(function (a) {
                  if (
                    ...
                    if (
                      a.which == M.DOWN ||
                      a.which == M.UP ||
                      (a.which == M.ENTER && this.opts.openOnEnter)
                    ) {
                      if (a.altKey || a.ctrlKey || a.shiftKey || a.metaKey)
                        return;
                      return this.open(), void p(a);
                    }
                    return a.which == M.DELETE || a.which == M.BACKSPACE
                      ? (this.opts.allowClear && this.clear(), void p(a))
                      : void 0;
                  }
                })
              ),
          ...
          postprocessResults: function (a, b, c) {
            ...
            if (
              (this.findHighlightableChoices().each2(function (a, b) {
                if (g(e.id(b.data("select2-data")), e.opts.element.val()))
                  return (d = a), !1;
              }),
              c !== !1 &&
          ...
          updateSelection: function (a) {
            ...
            this.selection.data("select2-data", a),
              e.empty(),
              null !== a &&
                (c = this.opts.formatSelection(a, e, this.opts.escapeMarkup)),
              c !== b && e.append(c),
              ...
              this.search.on(
                ...
                this.bind(function (a) {
                  if (this.isInterfaceEnabled()) {
                    ...
                    if (
                      ((a.which === M.BACKSPACE && 1 == this.keydowns) ||
                        a.which == M.LEFT) &&
                      0 == f.offset &&
                      !f.length
                    )
                    ...
                    if (
                      ...
                      this.open(),
                        (a.which !== M.PAGE_UP && a.which !== M.PAGE_DOWN) ||
                          p(a),
                        a.which === M.ENTER && p(a);
                    }
                  }
          ...
          postprocessResults: function (a, b, c) {
            ...
            f.each2(function (a, b) {
              ...
              this.highlight() == -1 &&
                ...
                h.highlight(0),
              !this.opts.createSearchChoice &&
                !f.filter(".select2-result:not(.select2-selected)").length >
                  0 &&
                (!a ||
                  (a &&
                    !a.more &&
              ...
              if (0 === i.length || "object" == typeof i[0])
                ...
                if (
                  ...
                  "container" === f
                    ...
                    : "dropdown" === f
                    ? (g = d.dropdown)
                    : (m[f] && (f = m[f]), (g = d[f].apply(d, i.slice(1)))),
